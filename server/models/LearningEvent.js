...
const LearningEventSchema = new mongoose.Schema({
  ...
  eventType: { type: String, enum: ["enrolled", "course_started", "lesson_started", "lesson_resumed", "lesson_completed", "course_completed", "exercise_passed", "quiz_passed"], required: true, index: true },
