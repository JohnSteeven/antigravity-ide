...
const LifeProfileSchema = new mongoose.Schema({
  ...
  notifications: {
    ...
    morningBriefTime: { type: String, default: "07:30" },
    eveningSummaryTime: { type: String, default: "20:30" },
    habitReminders: { type: Boolean, default: true },
    goalReminders: { type: Boolean, default: true },
    billReminders: { type: Boolean, default: true },
    medicationReminders: { type: Boolean, default: true },
    weeklyReviewReminder: { type: Boolean, default: false },
  },
  aiInsightsEnabled: { type: Boolean, default: false },
  aiReview: {
    includeJournal: { type: Boolean, default: false },
    includeHealth: { type: Boolean, default: false },
    includeFinance: { type: Boolean, default: false },
  },
  vacationMode: {
