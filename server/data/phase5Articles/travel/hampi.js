...
const articleConfig = {
  ...
  "structuredBlocks": [
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Tungabhadra Topography, Granite Boulders & Seasonal Timing",
      "id": "block-1",
      "order": 1
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "Spread across more than forty-one square kilometers of rugged Deccan plateau along the rushing waters of the Tungabhadra River in central Karnataka, Hampi presents one of the most surreal and evocative archaeological landscapes on earth. The terrain is dominated by vast jumbles of weathered, honey-gold and rust-colored granite boulders—some as colossal as multi-story buildings—perched precipitously atop one another in unnatural balance. Geologically, these granites are among the oldest exposed rock formations on the planet, dating back to the Archean era more than 2.5 billion years ago, eroded over eons by wind, sun, and torrential monsoon deluges into strange, undulating forms.",
      "id": "block-3",
      "order": 3
    },
    {
      "type": "paragraph",
      "text": "Into this ancient geological canvas, the emperors of the Vijayanagara dynasty (1336–1565 CE)—Harihara, Bukka, and the legendary Krishnadevaraya—carved a monumental imperial metropolis that contemporary European, Persian, and Portuguese travelers documented as one of the richest, most populous cities in the medieval world, rivaling contemporary Rome and Ming Beijing in grandeur, commercial wealth, and architectural sophistication.",
      "id": "block-4",
      "order": 4
    },
    {
      "type": "paragraph",
      "text": "The river geography of the Tungabhadra is central to Hampi's strategic and spiritual existence. Swirling through deep rocky gorges, ancient granite rapids, and peaceful sandbanks, the river divides the monumental imperial ruins of the southern bank (in modern Vijayanagara district) from the ancient mythical kingdom of Kishkindha on the northern bank around Anegundi, immortalized in the Ramayana as the monkey realm of Sugriva, Vali, and Hanuman.",
      "id": "block-5",
      "order": 5
    },
    {
      "type": "paragraph",
      "text": "Climatic timing for exploring Hampi is governed by the arid heat of the semi-arid northern Karnataka plains. The winter months between November and February offer comfortable traveling conditions, with daytime temperatures averaging 28°C to 31°C, cool nighttime lows of 15°C to 18°C, and dry, clear skies that illuminate the golden granite monuments at dawn and dusk. This is the premier season for walking across the vast archaeological park, climbing Matanga Hill, and exploring the temple complexes.",
      "id": "block-6",
      "order": 6
    },
    {
      "type": "list",
      "items": [
        "Mandatory Transit Validation: Ensure local transit cards, rail passes, or boarding credentials for Hampi are secured and validated prior to boarding.",
    ...
    {
      "type": "paragraph",
      "text": "From March through June, the Deccan summer brings scorching temperatures frequently exceeding 40°C to 42°C. The bare granite boulders absorb solar radiation and radiate intense thermal energy, making midday walking physically punishing. The monsoon months from July to September bring sporadic, refreshing rainfall that turns the dry rocky landscape into a vibrant mosaic of emerald green moss and flooded paddy fields, while the Tungabhadra River swells into a roaring, turbulent torrent.",
      "id": "block-8",
      "order": 8
    },
    {
      "type": "paragraph",
      "text": "Venturing through Hampi requires unhurried, multi-day exploration. Moving beyond the standard tourist circuit of the Vitthala Temple reveals a living landscape where 1,300-year-old temple rituals continue unbroken at the Virupaksha Temple, where ancient stone aqueducts still water banana plantations, and where the silence of medieval royal palaces invites profound contemplation of the rise and fall of great civilizations.",
      "id": "block-9",
      "order": 9
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Transit Arteries, South Western Railway Hubs & Gateway Access",
      "id": "block-12",
      "order": 12
    },
    {
      "type": "paragraph",
      "text": "Reaching Hampi involves connecting through key regional transit hubs on the Deccan plateau. The closest operational commercial air gateway is the Jindal Vijaynagar Airport (VDY) at Vidyanagar (Toranagallu), located approximately thirty-eight kilometers southeast of Hampi. Serviced by regional carriers like Alliance Air, the airport operates daily direct flights connecting Bengaluru and Hyderabad. Pre-arranged taxis from Vidyanagar reach Hampi or Hosapete in approximately fifty minutes.",
      "id": "block-13",
      "order": 13
    },
    {
      "type": "paragraph",
      "text": "Alternative commercial airport gateways include Hubballi Airport (HBX), situated one hundred and forty-five kilometers west (a three-hour drive via NH-67), which offers extensive domestic flight connectivity to Mumbai, Delhi, Bengaluru, Chennai, and Kochi; and Kempegowda International Airport Bengaluru (BLR), located three hundred and forty kilometers south, reachable in five-and-a-half to six hours via the four-lane NH-48 and NH-50 highways.",
      "id": "block-14",
      "order": 14
    },
    {
      "type": "paragraph",
      "text": "For rail travelers, Hosapete Junction (station code: HPT), located just thirteen kilometers west of Hampi, serves as the primary designated broad-gauge railhead. Hosapete is serviced by several dedicated daily express and superfast trains, most notably the legendary Hampi Express (16591/16592), which provides a convenient, comfortable overnight journey departing Bengaluru City at 21:50 PM and arriving in Hosapete at 07:10 AM the following morning.",
      "id": "block-15",
      "order": 15
    },
    {
    ...
    },
    {
      ...
      "tableRows": [
        [
          "Hampi Express Overnight Train (16591)",
          "Daily overnight service ex-Bengaluru",
          "SBC -> HPT",
          "9h 20m (420 km)",
          "₹1,180 (3AC) / ₹1,750 (2AC)"
        ],
        [
          "Jindal Airport (VDY) to Hampi Taxi",
          "On-demand pre-booked private cab",
          "VDY -> Hampi Bazaar",
          "50m (38 km)",
          "₹1,400 - ₹1,800"
        ],
        [
          "Hubballi Airport to Hampi Private Sedan",
          "24/7 on-demand private transfer",
          "HBX -> Hampi (via NH-67)",
          "3h 00m (145 km)",
          "₹3,400 - ₹4,400"
        ],
        [
          ...
          "Nightly departure 22:30 ex-Bengaluru",
          "Bengaluru -> Hosapete Bus Stand",
          "6h 45m (340 km)",
          "₹750 - ₹950"
        ],
        [
          "Hosapete Junction Auto-Rickshaw to Hampi",
          "Available 24/7 outside station gate",
          "HPT -> Hampi Bazaar",
          "25m (13 km)",
          "₹250 - ₹350"
        ]
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Neighborhood Topography & Distinct Archaeological Zones",
      "id": "block-20",
      "order": 20
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Permits, ASI Ticketing & Monument Protection Regulations",
      "id": "block-29",
      "order": 29
    },
    {
    ...
    },
    {
      ...
      "tableRows": [
        [
          "Day 1: 11:00 - 18:30",
          "Sacred Centre",
          "Virupaksha Temple; Hemakuta Hill; Matanga sunset",
          "Foot / auto-rickshaw",
          "Crispy Benne Dosa & hot South Indian filter coffee"
        ],
        [
          "Day 2: 06:30 - 15:30",
          "Vitthala & Riverside",
          "Stone Chariot; Musical Pillars; Achyutaraya; Coracle",
          "Foot & Coracle boat",
          "Authentic South Indian thali served on fresh banana leaf"
        ],
        [
          "Day 3: 08:30 - 16:30",
          "Royal Centre",
          "Lotus Mahal; Elephant Stables; Mahanavami Dibba",
          "Bicycle / hired taxi",
          "Traditional North Karnataka Jolada Rotti meal, Kamalapura"
        ],
        [
          "Day 4: 07:00 - 17:00",
          "Anegundi & Kishkindha",
          "Anjanadri 575 steps; Pampa Sarovar; Sanapur Lake",
          "Rented scooter / auto",
          "Wood-fired shakshuka & fresh pomegranate juice, Sanapur"
        ],
        [
          "Day 5: 09:00 - 15:00",
          "Kamalapura & Krishna",
          "ASI Museum; Krishna Temple; Underground Shiva",
          "Auto-rickshaw / car",
          "Hot Dharwad peda & cold mango lassi, Hampi Bazaar"
        ]
      ],
      "id": "block-43",
      "order": 43
    ...
    {
      "type": "paragraph",
      "text": "Budget planning for Hampi reflects a broad spectrum of hospitality, from rustic guesthouses on the northern bank to luxury palace hotels around Kamalapura. A solo budget traveler staying in cozy guesthouses in Hampi Bazaar or Sanapur, renting a bicycle or scooter, and dining at local South Indian vegetarian messes can explore comfortably for ₹2,000 to ₹3,000 per day.",
      "id": "block-47",
      "order": 47
    },
    {
      "type": "paragraph",
      "text": "Mid-range travelers staying in air-conditioned heritage cottages or boutique hotels in Kamalapura or Hosapete, hiring private auto-rickshaws for day trips, and dining at established garden restaurants should project ₹5,500 to ₹10,000 per day for a couple.",
      "id": "block-48",
      "order": 48
    },
    {
      "type": "paragraph",
      "text": "Luxury travelers seeking world-renowned palace hospitality—such as Evolve Back Kamalapura Palace (modeled on the royal stone architecture of Vijayanagara, complete with private plunge pools and stone-arched hallways) or Heritage Resort Hampi—will find suite tariffs ranging from ₹25,000 to ₹55,000 per night during the peak winter season (November to February). Chauffeur-driven private sedans cost ₹2,800 to ₹3,800 per full day.",
      "id": "block-49",
      "order": 49
    },
    {
      "type": "paragraph",
      "text": "Activity costs are very reasonable: the unified ASI ticket covering the Vitthala Temple and Zenana Enclosure is ₹40 for Indian citizens and ₹600 for foreign nationals; battery buggy transfers at Vitthala are ₹20 per seat; circular coracle boat rides on the Tungabhadra cost ₹300 to ₹500 for thirty minutes; and licensed English-speaking ASI tour guides charge standardized rates between ₹1,500 and ₹2,500 for a comprehensive full-day tour.",
      "id": "block-50",
      "order": 50
    },
    {
      ...
      "tableRows": [
        [
          "Budget (Solo)",
          "₹900 - ₹1,500 (Guesthouse room / hostel)",
          "₹450 - ₹700 (Thali canteens, cafe meals)",
          "₹200 - ₹400 (Rented bicycle / shared auto)",
          "₹250 - ₹450 (ASI ticket, coracle share)",
          "₹1,800 - ₹3,050 per day"
        ],
        [
          "Mid-Range (Couple)",
          "₹4,000 - ₹7,500 (AC heritage room / resort)",
          "₹1,500 - ₹2,800 (Garden dining, multi-cuisine)",
          "₹800 - ₹1,500 (Dedicated auto-rickshaw hire)",
          "₹1,000 - ₹2,000 (ASI ticket, official guide)",
          "₹7,300 - ₹13,800 per day"
        ],
        [
          "Luxury (Couple)",
          "₹25,000 - ₹52,000 (Vijayanagara palace suite)",
          "₹4,500 - ₹8,500 (Fine dining royal feasts)",
          "₹3,000 - ₹4,500 (Private chauffeured sedan)",
          "₹2,500 - ₹5,000 (Private expert historian guide)",
          "₹35,000 - ₹70,000 per day"
        ]
      ],
      "id": "block-51",
      "order": 51
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Arid Deccan Heat Dynamics, Summer Hazards & Sun Precautions",
      "id": "block-53",
      "order": 53
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "The semi-arid climate of the Deccan plateau presents genuine physical challenges for travelers unaccustomed to intense dry heat. Between March and June, daily temperatures routinely climb above 40°C to 42°C, accompanied by intense ultraviolet radiation and low relative humidity (under 25%).",
      "id": "block-56",
      "order": 56
    },
    {
      "type": "paragraph",
      "text": "The millions of exposed granite boulders across Hampi act as colossal thermal storage units. By noon, the rock surfaces reach temperatures exceeding 50°C, radiating intense secondary heat from the ground upward. Walking among stone ruins during the hours between 11:30 AM and 15:30 PM can cause rapid dehydration, severe sunburn, and life-threatening heatstroke.",
      "id": "block-57",
      "order": 57
    },
    {
      "type": "paragraph",
      "text": "Travelers visiting Hampi in the warm months must structure their daily activities into two discrete operational windows: an early morning exploration shift from 06:30 to 10:30 AM, followed by a mandatory midday retreat indoors or in shaded museums, resuming outdoor walking after 16:00 PM until sunset. Carrying at least two to three liters of water enriched with oral rehydration salts (ORS) or electrolyte powder is mandatory.",
      "id": "block-58",
      "order": 58
    },
    {
      "type": "paragraph",
      "text": "Even during the pleasant winter months (November to February), midday sun can be deceivingly strong. Always wear a wide-brimmed sun hat, high-SPF sunscreen, and polarized sunglasses to protect eyes against the dazzling glare reflected off light-colored granite surfaces.",
      "id": "block-59",
      "order": 59
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Gastronomic Topography: North Karnataka Jolada Rotti & Traveler Bistros",
      "id": "block-61",
      "order": 61
    },
    {
      "type": "paragraph",
      "text": "The culinary landscape of Hampi reflects two distinct cultural realities: the ancient, wholesome agrarian cuisine of North Karnataka and the eclectic, international traveler cafe culture that developed along the riverbanks to serve global backpackers.",
      "id": "block-62",
      "order": 62
    },
    {
    ...
    },
    {
      ...
      "tableRows": [
        [
          "North Karnataka Jolada Rotti Meal",
          "Traditional Deccan Agrarian",
          "Sorghum jowar rotti, yennegai brinjal, peanut powder",
          "Earthy, robust, nutty, rustic, wholesome warmth",
          "Local family mess halls in Kamalapura & Hosapete"
        ],
        [
          "Davanagere Benne Dosa",
          "Central Karnataka Tiffin",
          "Fermented rice crepe, churned country butter, aloo",
          "Golden crispy exterior, soft buttery interior",
          "Breakfast stalls near Hampi Bazaar entrance"
        ],
        [
          "Shenga Chutney Pudi & Curd",
          "Deccan Spice Condiment",
          "Roasted peanuts, garlic, red chilies, cumin, rock salt",
          "Intensely savory, nutty, pungent, crunchy depth",
          "Served with every traditional North Karnataka meal"
        ],
        [
          "Wood-Fired Margherita Pizza",
          "Anegundi Traveler Bistro",
          "Fermented dough, San Marzano tomato, local cheese",
          "Crisp blistered crust, melted cheese, fresh basil",
          "Garden cafes in Sanapur village"
        ],
        [
          "Authentic Dharwad Peda",
          "Karnataka Milk Confection",
          "Slow-caramelized milk khoya, cane sugar, cardamom",
          "Dense, grainy, deeply caramelized sweetness",
          "Heritage sweet confectioners in Hosapete"
        ]
      ],
      "id": "block-67",
      "order": 67
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Cultural Protocols, Temple Reverence & Sacred Site Etiquette",
      "id": "block-69",
      "order": 69
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "On-Ground Logistics: Bicycles, Auto-Rickshaws & Coracle River Crossing",
      "id": "block-83",
      "order": 83
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Deccan Hydration, Sun Safety & Archaeological Health Precautions",
      "id": "block-92",
      "order": 92
    },
    {
      "type": "paragraph",
      "text": "Exploring Hampi's arid, boulder-strewn landscape exposes visitors to intense dry heat, strong ultraviolet radiation, and extensive physical walking across uneven stone surfaces that require thoughtful health management.",
      "id": "block-93",
      "order": 93
    },
    {
      "type": "paragraph",
      "text": "Hydration is the single most critical health factor in Hampi. In the dry Deccan climate, sweat evaporates almost instantaneously, leaving travelers unaware of the volume of water they are losing. Drink at least three to four liters of purified, filtered water daily. Supplement drinking water with fresh tender coconut water (available at stalls outside the Virupaksha Temple and Vitthala buggy stand for ₹50 to ₹60) or fresh sugarcane juice infused with ginger and lime, which replenishes essential electrolytes.",
      "id": "block-94",
      "order": 94
    },
    {
      "type": "paragraph",
      "text": "Never drink untreated tap water from public taps or monument ponds. Drink exclusively filtered reverse-osmosis (RO) water provided in carafes at reputable hotels or carry a reusable insulated stainless-steel bottle with an integrated micro-filtration purifier.",
      "id": "block-95",
      "order": 95
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "When swimming or wading near the Tungabhadra River, exercise extreme caution. River currents around the boulders are deceptively powerful and unpredictable, with deep underwater granite crevices and whirlpools that have caused fatal drownings. Swim exclusively in designated calm, monitored areas at Sanapur Lake, and never enter the river while under the influence of alcohol.",
      "id": "block-97",
      "order": 97
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Digital Connectivity, UPI Transactions & Rural Cellular Coverage",
      "id": "block-99",
      "order": 99
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "Telecommunications infrastructure around Hampi has modernized substantially in recent years. Major telecom operators—Reliance Jio and Bharti Airtel—provide reliable 4G LTE and expanding 5G coverage throughout Hosapete town, Kamalapura, Hampi Bazaar, and the immediate monument centers.",
      "id": "block-101",
      "order": 101
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "For remote knowledge workers and digital nomads planning extended workations, several boutique resorts and guest lodges in Kamalapura, Sanapur, and Anegundi offer dedicated fiber-optic broadband connectivity (BSNL Bharat Fibre and private operators) delivering dependable 50 Mbps to 100 Mbps speeds.",
      "id": "block-103",
      "order": 103
    },
    {
      "type": "paragraph",
      "text": "When booking extended stays, confirm that your accommodation possesses both high-speed fiber internet and inverter battery or generator backup, as power fluctuations can occasionally occur in rural Karnataka during evening hours.",
      "id": "block-104",
      "order": 104
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Photography Protocols, Drone Regulations & Monument Discretion",
      "id": "block-112",
      "order": 112
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "Commercial photography and filming involving tripods, external lighting umbrellas, and professional cinematic equipment inside ASI-ticketed complexes (Vitthala Temple and Zenana Enclosure) requires obtaining an ASI photography permit online and paying prescribed statutory fees. Handheld still cameras and personal smartphone photography are permitted without surcharge.",
      "id": "block-116",
      "order": 116
    },
    {
      "type": "paragraph",
      "text": "When photographing active religious rituals inside the Virupaksha Temple courtyard or along sacred river bathing ghats, maintain respectful discretion. Always ask courteous permission before taking close-up portraits of pilgrims, temple priests, or sadhus seated on stone mantapas, and never use flash photography inside dim temple sanctums.",
      "id": "block-117",
      "order": 117
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Packing Blueprint: Sun Armor, Stone Footwear & Trail Equipment",
      "id": "block-119",
      "order": 119
    },
    {
      "type": "paragraph",
      "text": "Packing for an expedition to Hampi requires preparing for intense daytime sun, dry heat, extensive walking over rough granite terrain, and modest dress codes at sacred shrines. The following matrix outlines essential field gear.",
      "id": "block-120",
      "order": 120
    },
    {
      "type": "paragraph",
      "text": "Footwear is the single most critical investment for Hampi. You will walk thousands of steps over uneven rock surfaces, ancient stone flagstones, and sandy riverbanks. Bring broken-in, breathable trail walking shoes or hiking sneakers with thick, shock-absorbing soles and good rubber traction. Avoid smooth-soled leather shoes that slip on polished granite surfaces. Pair these with comfortable slip-on sandals for temple visits where shoes must be removed frequently.",
      "id": "block-121",
      "order": 121
    },
    {
      "type": "paragraph",
      "text": "Clothing should prioritize lightweight, breathable natural fabrics: 100% pure organic cotton, linen, or technical moisture-wicking materials in light, heat-reflective shades (white, khaki, beige). Pack modest clothing that covers shoulders and knees for temple entry: loose linen trousers, cotton kurtas, or knee-length shirts. Women travelers should carry a lightweight cotton scarf or dupatta to cover shoulders inside orthodox shrines.",
      "id": "block-122",
      "order": 122
    },
    {
    ...
    },
    {
      ...
      "tableRows": [
        [
          "Footwear",
          "Lugged trail sneakers + slip-on temple sandals",
          "Walking rough granite paths; easy shoe removal",
          "Essential year-round"
        ],
        [
          "Sun Protection",
          "Wide-brimmed sun hat + polarized sunglasses",
          "Shielding against intense Deccan solar radiation",
          "Crucial year-round"
        ],
        [
          "Hydration & Fuel",
          "Insulated stainless steel flask (1.5L) + ORS packets",
          "Maintaining hydration & vital electrolyte balance",
          "Essential: Especially March - June"
        ],
        [
          "Sacred Attire",
          "Long linen trousers / maxi skirt + cotton scarf",
          "Complying with orthodox dress codes at active temples",
          "Year-round requirement"
        ],
        [
          "Power & Pack",
          "10,000mAh power bank + 20L lightweight daypack",
          "Recharging phones & carrying water on day hikes",
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Emergency Infrastructure, Hospitals & Regional Medical Access",
      "id": "block-126",
      "order": 126
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "While Hampi is a peaceful and secure travel destination, knowing where to access medical care, police support, and emergency services is essential for peace of mind.",
      "id": "block-128",
      "order": 128
    },
    {
      "type": "paragraph",
      "text": "The primary public emergency healthcare facility closest to the ruins is the Community Health Centre in Kamalapura, equipped to handle minor injuries, dehydration, and basic medical treatment. For comprehensive emergency medical care, the Government Taluk Hospital on Station Road in Hosapete (thirteen kilometers away) provides 24-hour casualty services, surgical facilities, and ambulance transport.",
      "id": "block-129",
      "order": 129
    },
    {
      "type": "paragraph",
      "text": "In the private medical sector, the Jindal Sanjeevani Multi-Specialty Hospital, located inside the Jindal Steel Works township at Toranagallu (thirty-five kilometers east on NH-67), is one of the premier modern hospitals in the region, equipped with modern intensive care units, advanced cardiology, diagnostic radiology, and multi-lingual medical specialists.",
      "id": "block-130",
      "order": 130
    },
    {
      "type": "paragraph",
      "text": "For severe medical trauma requiring advanced tertiary interventions, patients are stabilized in Hosapete and transferred via ambulance to tertiary multi-specialty hospitals in Hubballi (such as KIMS Hubballi or Tatwadarsha Hospital), reachable in approximately two-and-a-half to three hours.",
      "id": "block-131",
      "order": 131
    },
    {
      "type": "paragraph",
      "text": "The unified national emergency helpline 112 connects to police, fire, and ambulance dispatch across the district. A dedicated Tourist Police assistance booth operates in Hampi Bazaar near the Virupaksha Temple, providing assistance with lost property, travel information, and tourist dispute resolution.",
      "id": "block-132",
      "order": 132
    },
    {
      ...
      "tableRows": [
        ...
        [
          "Apex Regional Multi-Specialty",
          "Jindal Sanjeevani Multi-Specialty Hospital",
          "Toranagallu, Ballari Road",
          "+91 8395 250 123"
        ],
        [
          "Hosapete Public Hospital",
          "Government Taluk Hospital Hosapete",
          "Station Road, Hosapete",
          "+91 8394 228 102"
        ],
        [
          "Hampi Tourist Police Booth",
          "Tourist Police Assistance Counter",
          "Hampi Bazaar, Near Virupaksha",
          "+91 8394 241 244"
        ],
        [
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Synthesis: The Eternal Stone Poetry of Vijayanagara",
      "id": "block-141",
      "order": 141
    },
    {
      "type": "paragraph",
      "text": "To stand among the ruined stone colonnades of Hampi as twilight falls over the Tungabhadra River is to experience one of the most poignant and profound encounters with human history on earth. Here, the sheer scale of medieval human ambition—palaces of gold, thousand-pillared stone temples, monumental chariot shrines, and bustling international markets—coexists in majestic silence with the ancient, unyielding granite boulders that preceded human arrival and will outlast all human empires.",
      "id": "block-142",
      "order": 142
    },
    {
      "type": "paragraph",
      "text": "The true soul of Hampi is found not merely in historical chronicles or guidebooks, but in the enduring spirit of the landscape: in the continuous, unbroken chanting that has echoed through the Virupaksha sanctum for thirteen centuries, in the gentle smile of a coracle boatman navigating the swirling river rapids, and in the timeless whisper of the wind sweeping across the ruined terraces of the Mahanavami Dibba under a canopy of stars.",
      "id": "block-143",
      "order": 143
    },
    {
      "type": "paragraph",
      "text": "Hampi teaches us both the majesty and the transience of human creation. It reminds us that while empires rise, flourish, and crumble into stone debris, the human spirit's yearning for beauty, sacred communion, and artistic perfection remains eternal.",
      "id": "block-144",
      "order": 144
    },
    {
      "type": "paragraph",
      "text": "As you board your evening train from Hosapete, watching the silhouetted boulder peaks of Vijayanagara fade into the violet twilight, you carry with you an indelible gift: a memory of golden stone glowing in the sun, the tranquil murmur of the sacred river, and the eternal, quiet poetry of Hampi's living soul.",
      "id": "block-145",
      "order": 145
    }
  ],
  ...
  "travelVerification": {
    ...
    "officialSources": [
      {
        "title": "A Forgotten Empire: Vijayanagar (Robert Sewell)",
        "url": "https://www.gutenberg.org/"
      },
      {
        "title": "Archaeological Survey of India: Hampi World Heritage Site Monograph",
  ...
  "references": [
    ...
    {
      "title": "Vijayanagara: Architectural Inventory of the Sacred and Royal Centres (George Michell)",
