...
const articleConfig = {
  ...
  "structuredBlocks": [
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Geography of the Central Apennines, Tyrrhenian Coast & Campanian Volcanism",
      "id": "block-1",
      "order": 1
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "Climatically, central and southern Italy experience an archetypal Mediterranean climate with warm, dry, luminous summers and mild, rainy winters. The Amalfi Coast enjoys a sheltered maritime microclimate, protected from biting northern tramontana winds by the towering Lattari Mountains, allowing bougainvillea, jasmine, and citrus orchards to flourish year-round.",
      "id": "block-6",
      "order": 6
    },
    {
      "type": "list",
      "items": [
        "Mandatory Transit Validation: Ensure local transit cards, rail passes, or boarding credentials for Italy are secured and validated prior to boarding.",
    ...
    },
    {
      ...
      "tableRows": [
        [
          "New Delhi (DEL) to Rome (FCO)",
          "ITA Airways, Air India",
          "8h 15m (Airbus A350 Nonstop)",
          "FCO (Rome Fiumicino T3)",
          "₹52,000 - ₹76,000"
        ],
        [
          "Mumbai (BOM) to Rome (FCO)",
          "Emirates, Lufthansa, Swiss",
          "10h 30m to 11h 45m (Wide-body)",
          "Dubai (DXB) / Zurich (ZRH)",
          "₹54,000 - ₹78,000"
        ],
        [
          "Bengaluru (BLR) to Rome (FCO)",
          "Qatar Airways, Air France",
          "10h 45m to 12h 00m (A350 / B787)",
          "Doha (DOH) / Paris (CDG)",
          "₹50,000 - ₹74,000"
        ],
        [
          "Hyderabad (HYD) to Rome (FCO)",
          "Etihad, Emirates",
          "11h 00m to 12h 30m (Boeing 777)",
          "Abu Dhabi (AUH) / Dubai (DXB)",
          "₹48,000 - ₹72,000"
        ],
        [
          "FCO Airport to Roma Termini",
          "Leonardo Express Non-Stop Train",
          "32m (Dedicated Airport Rail)",
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "High-Speed Rail Mobility, Regional Transit & Coastal Ferries",
      "id": "block-26",
      "order": 26
    },
    {
    ...
    },
    {
      ...
      "tableHeaders": [
        ...
        "Estimated Tariff (EUR / INR)"
      ],
      "tableRows": [
        [
          "Rome Termini to Naples Central",
          "Frecciarossa / Italo High-Speed",
          "1h 10m (300 km/h Bullet Train)",
          "Trenitalia / Italo Portal / App",
          "19 - 45 EUR (₹1,710 - ₹4,050)"
        ],
        [
          "Naples to Pompeii Scavi",
          "Circumvesuviana / Campania Express",
          "30m to 35m (Commuter Rail)",
          "Station Ticket Counter / Kiosk",
          "3.60 - 8.00 EUR (₹325 - ₹720)"
        ],
        [
          "Naples to Sorrento",
          "Circumvesuviana / Campania Express",
          "50m to 65m (Coastal Rail)",
          "Station Ticket Counter / Kiosk",
          "4.20 - 10.00 EUR (₹380 - ₹900)"
        ],
        [
          "Sorrento to Positano (Maritime)",
          "Hydrofoil Catamaran (NLG / Positano Jet)",
          "30m (Scenic Maritime Crossing)",
          "Harbor Pier / Ferryhopper App",
          "16 - 22 EUR (₹1,440 - ₹1,980)"
        ],
        [
          "Positano to Amalfi (Maritime)",
          "Public Passenger Ferry (Travelmar)",
          "20m (Coastal Sea Route)",
          "Travelmar Ticket Kiosk / App",
          "10 - 14 EUR (₹900 - ₹1,260)"
        ]
      ],
      "id": "block-33",
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Currency, Cashless Protocols, City Taxes & Dining Surcharges",
      "id": "block-35",
      "order": 35
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Rome: Monumental Antiquity of the Roman Caesars",
      "id": "block-43",
      "order": 43
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "The Roman Waterways & Thermal Heritage: Aqueducts, Fountains & Public Baths",
      "id": "block-49",
      "order": 49
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "Water was the lifeblood and supreme engineering triumph of imperial Rome. While other ancient civilizations were constrained by local river margins, Roman hydraulic engineers constructed eleven monumental aqueduct systems spanning hundreds of kilometers across valleys on soaring stone arches, delivering over one million cubic meters of fresh mountain spring water daily to the capital.",
      "id": "block-52",
      "order": 52
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "Beyond cleansing, the thermae functioned as comprehensive community centers featuring Greek and Latin libraries, open-air wrestling palaestras, gardens, and art galleries containing legendary sculptures such as the Farnese Bull and Farnese Hercules.",
      "id": "block-54",
      "order": 54
    },
    {
      "type": "paragraph",
      "text": "This hydraulic legacy continues uninterrupted in modern Rome through the Aqua Virgo aqueduct, originally commissioned by Marcus Agrippa in 19 BCE, which still supplies water to the Trevi Fountain, Piazza Navona's Fountain of the Four Rivers, and the Barcaccia fountain at the foot of the Spanish Steps.",
      "id": "block-55",
      "order": 55
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "The Baroque Rivalry: Bernini vs. Borromini Across the Roman Skyline",
      "id": "block-64",
      "order": 64
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Hadrian's Imperial Sanctuary: Tivoli & Classical Hydraulic Masteries",
      "id": "block-71",
      "order": 71
    },
    {
      "type": "paragraph",
      "text": "Just thirty kilometers east of Rome in the olive-draped foothills of the Sabine Hills lies Tivoli, where Emperor Hadrian constructed the ultimate architectural country retreat between 118 and 138 CE: Villa Adriana (Hadrian's Villa).",
      "id": "block-72",
      "order": 72
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Pompeii & Herculaneum: Daily Roman Life Frozen in Vesuvius Ash",
      "id": "block-77",
      "order": 77
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Naples: Spaccanapoli, The Veiled Christ & The Sacred Birthplace of Pizza",
      "id": "block-86",
      "order": 86
    },
    {
      "type": "paragraph",
      "text": "Positioned along its sweeping blue bay in the shadow of Vesuvius, Naples (Napoli) is Italy's most raw, passionate, unvarnished, and sensory metropolis. Founded as Neapolis by ancient Greek colonists in the eighth century BCE, Naples possesses an untamed vitality characterized by buzzing scooters, laundry lines fluttering between narrow stone tenements, and profound artistic devotion.",
      "id": "block-87",
      "order": 87
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "The Holy Trinity of Neapolitan Pizza: Naples is the undisputed birthplace of pizza, an art form protected by UNESCO Intangible Cultural Heritage status and rigorously codified by the Associazione Verace Pizza Napoletana (AVPN). In 1889, pizzaiolo Raffaele Esposito created the Pizza Margherita for Queen Margherita of Savoy, mirroring the colors of the Italian tricolor flag: red San Marzano tomatoes, white mozzarella di bufala campana, and fresh green basil.",
      "id": "block-90",
      "order": 90
    },
    {
      "type": "paragraph",
      "text": "An authentic Neapolitan pizza must be made with highly refined Type 00 wheat flour, leavened slowly for twenty-four to forty-eight hours, hand-stretched without a rolling pin, and baked in a wood-fired domed oven at 485 degrees Celsius for just sixty to ninety seconds. The resulting crust is soft, pillowy, blistered with charred leopard spots, and fragrant with volcanic sweetness. Legendary historic pizzerias like L'Antica Pizzeria da Michele, Sorbillo, and Starita serve these masterpieces for just 5 to 9 EUR (₹450 - ₹810 INR).",
      "id": "block-91",
      "order": 91
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "The Lemon Terraces of the Costiera: Agrarian Heritage of the Sfusato Amalfitano",
      "id": "block-99",
      "order": 99
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "Clinging to nearly vertical limestone ravines between Ravello, Amalfi, and Minori are thousands of stepped agricultural stone terraces known locally as 'macere.' For nearly a millennium since Arab traders introduced citrus cultivars to the Amalfi Republic in the eleventh century, local farming families have engaged in 'heroic agriculture'—building drystone retaining walls by hand and cultivating the legendary Sfusato Amalfitano lemon.",
      "id": "block-101",
      "order": 101
    },
    {
      "type": "paragraph",
      "text": "The architectural hallmark of an Amalfi lemon grove is the 'pergola': towering scaffolds constructed from dense, rot-resistant chestnut wood poles harvested from the high forests of the Lattari Mountains. Lemon branches are tied and trained horizontally along these overhead chestnut trellises, suspended beneath dark woven straw mats (pagliarelle) or mesh netting that protects the delicate blossoms from winter hail and scorching summer midday sun.",
      "id": "block-102",
      "order": 102
    },
    {
      "type": "paragraph",
      "text": "Walking along the ancient Path of the Lemons (Sentiero dei Limoni) connecting the villages of Maiori and Minori, visitors enter a shaded green canopy perfumed with the intoxicating scent of citrus blossoms (zagara). Because modern machinery cannot navigate the steep, narrow stone staircases connecting these mountain terraces, every single lemon—often weighing up to three hundred grams each—is harvested by hand and carried down the mountain in heavy wooden crates (sportoni) balanced upon the shoulders of local farmers, or transported by sure-footed pack mules.",
      "id": "block-103",
      "order": 103
    },
    {
      "type": "paragraph",
      "text": "Beyond its role in fresh gastronomy, this lemon is the sacred essence of Limoncello, the quintessential digestive liqueur of Campania. Local producers peel the bright yellow zest paper-thin, taking care not to scrape the bitter white pith, and macerate the fragrant peels in pure grain alcohol for weeks before blending the oil-infused spirit with boiled sugar syrup. Sipping a frosty glass of artisanal limoncello on a cliffside terrace while the Mediterranean breeze rustles through the pergolas is one of Italy's purest sensory memories.",
      "id": "block-104",
      "order": 104
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "The Path of the Gods & Capri: Maritime Treks & Island Sanctuaries",
      "id": "block-106",
      "order": 106
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "For nature lovers and hikers, the Amalfi Coast offers one of the most magnificent coastal trekking routes in Europe: the Sentiero degli Dei (Path of the Gods). Suspended six hundred meters above the sea along ancient mule tracks carved into sheer limestone cliffs, this eight-kilometer trail connects the mountain hamlet of Bomerano (in Agerola) to Nocelle, perched high above Positano.",
      "id": "block-108",
      "order": 108
    },
    {
      "type": "paragraph",
      "text": "Hiking along fragrant mountain ridges lined with wild rosemary, thyme, and holm oaks, trekkers enjoy uninterrupted panoramic views stretching from the craggy headlands of the Sorrentine Peninsula to the distant limestone peaks of Capri. The hike requires approximately three to four hours of moderate walking; sturdy trail running shoes with rugged tread are essential to negotiate uneven rock paths and exposed cliff ledges.",
      "id": "block-109",
      "order": 109
    },
    {
      "type": "paragraph",
      "text": "The Island of Capri: Just off the western tip of the Sorrentine Peninsula lies Capri, a legendary limestone island sanctuary beloved since Roman emperors Augustus and Tiberius built pleasure villas here. Boarding a fast hydrofoil from Sorrento (20 minutes) or Positano (30 minutes) brings visitors to Marina Grande.",
      "id": "block-110",
      "order": 110
    },
    {
      "type": "paragraph",
      "text": "A scenic open-air vintage taxi or funicular whisks travelers up to Capri town's bustling Piazzetta for boutique browsing, while a winding minibus ascent leads to tranquil Anacapri. In Anacapri, travelers can ride the single-seat open-air chairlift to the summit of Mount Solaro (589m) for a 360-degree panorama of the Bay of Naples, Vesuvius, and the famous Faraglioni—three monumental limestone sea stacks rising majestically from the cobalt ocean waters.",
      "id": "block-111",
      "order": 111
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Italian Gastronomy & Dietary Navigation for Indian Travelers",
      "id": "block-113",
      "order": 113
    },
    {
    ...
    },
    {
      ...
      "tableRows": [
        [
          ...
          "₹3,200 - ₹5,500 (35-60 EUR)",
          "₹9,500 - ₹18,000 (105-200 EUR)",
          "₹36,000 - ₹85,000 (400-940 EUR)",
          "Budget: Hostel/Guesthouse; Mid: 3-star Hotel/B&B; Luxury: Cliffside 5-star Hotel"
        ],
        [
          "Daily Meals & Gastronomy",
          "₹1,800 - ₹3,000 (20-33 EUR)",
          "₹4,200 - ₹7,500 (46-83 EUR)",
          "₹12,000 - ₹26,000 (133-288 EUR)",
          "Budget: Pizza al taglio/Panini; Mid: Trattoria/Pasta; Luxury: Michelin dining"
        ],
        [
          "Local & Intercity Transit",
          "₹900 - ₹1,600 (10-18 EUR)",
          "₹2,400 - ₹4,500 (26-50 EUR)",
          "₹6,500 - ₹14,000 (72-155 EUR)",
          "Includes amortized Frecciarossa high-speed rail, metro, and coastal ferries"
        ],
        [
          "Sightseeing & Entry Fees",
          "₹800 - ₹1,500 (9-17 EUR)",
          "₹2,200 - ₹4,200 (24-46 EUR)",
          "₹5,500 - ₹12,000 (61-133 EUR)",
          "Colosseum & Vatican tickets booked in advance; skip-the-line tours add cost"
        ],
        [
          "Connectivity & Incidentals",
          "₹300 - ₹550 (3.3-6 EUR)",
          "₹600 - ₹1,100 (6.6-12 EUR)",
          "₹1,500 - ₹3,000 (16-33 EUR)",
          "Local TIM/Iliad eSIM, city tourist taxes (4-10 EUR), and luggage storage"
        ],
        [
          "Total Daily Expenditure",
          "₹7,000 - ₹12,150 (78-135 EUR)",
          "₹18,900 - ₹35,300 (210-392 EUR)",
          "₹61,500 - ₹140,000 (683-1,555 EUR)",
          "Excludes international round-trip flights from India (₹52,000+)"
        ]
      ],
      "id": "block-125",
      "order": 125
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "The 10-Day Rome, Naples, Pompeii & Amalfi Coast Itinerary",
      "id": "block-127",
      "order": 127
    },
    {
      "type": "paragraph",
      "text": "This meticulously structured ten-day itinerary connects the imperial majesty and Renaissance art of Rome with the raw energy of Naples, the poignant ruins of Pompeii, and the breathtaking coastal cliffs of Sorrento, Positano, and Amalfi.",
      "id": "block-128",
      "order": 128
    },
    {
      ...
      "tableRows": [
        [
          "Day 1: Imperial Rome Arrival",
          "FCO Airport arrival via Leonardo Express",
          "Check-in central Rome, stroll Piazza Navona",
          "Pantheon sunset view & dinner at Campo de' Fiori",
          "Leonardo Express & Rome Metro Line A"
        ],
        [
          "Day 2: Colosseum & Imperial Forums",
          "Colosseum guided tour & arena floor access",
          "Roman Forum & Palatine Hill imperial ruins",
          "Trevi Fountain coin toss & Spanish Steps stroll",
          "Rome Metro Line B & Walking"
        ],
        [
          "Day 3: Vatican & Trastevere",
          "Vatican Museums & Sistine Chapel masterworks",
          "St. Peter's Basilica interior & dome climb",
          "Trastevere cobblestone lanes & trattoria feast",
          "Rome Metro Line A & Walking"
        ],
        [
          "Day 4: Borghese & High-Speed to Naples",
          "Galleria Borghese Bernini sculptures & gardens",
          "Frecciarossa bullet train Rome to Naples (1h 10m)",
          "Check-in Naples & authentic Pizza Margherita",
          "Frecciarossa High-Speed Rail"
        ],
        [
          "Day 5: Spaccanapoli & Neapolitan Art",
          "Spaccanapoli walking tour & Cappella Sansevero",
          "National Archaeological Museum Pompeii mosaics",
          "Waterfront promenade Castel dell'Ovo sunset",
          "Naples Metro Line 1 & Walking"
        ],
        [
          "Day 6: Pompeii Ruins to Sorrento",
          "Circumvesuviana train to Pompeii Scavi ruins",
          "Four-hour guided tour of Roman villas & baths",
          "Train to Sorrento, clifftop sunset over bay",
          "Circumvesuviana Commuter Rail"
        ],
        [
          "Day 7: Ferry to Vertical Positano",
          "Morning hydrofoil ferry Sorrento to Positano",
          "Spiaggia Grande beach & pastel cliff stroll",
          "Boutique linen shopping & seafood terrace dinner",
          "Maritime Hydrofoil & Walking"
        ],
        [
          "Day 8: Maritime Amalfi & Clifftop Ravello",
          "Passenger ferry Positano to Amalfi harbor",
          "Amalfi Cathedral of St. Andrew & paper mill",
          "Open-top bus to Ravello & Villa Cimbrone terrace",
          "Public Ferry & Regional Bus"
        ],
        [
          "Day 9: Path of the Gods or Capri",
          "Trek Path of the Gods or hydrofoil to Capri",
          "Capri Mount Solaro chairlift & Faraglioni view",
          "Return to Sorrento for Limoncello tasting",
          "Trail Hiking / Maritime Hydrofoil"
        ],
        [
          "Day 10: Return to Rome & India",
          "Morning train Sorrento to Naples, Frecciarossa to Rome",
          "Roma Termini luggage claim & souvenir shopping",
          "Leonardo Express to FCO Airport for India departure",
          "High-Speed Rail & Airport Train"
        ]
      ],
      "id": "block-129",
      "order": 129
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Social Decorum, Church Dress Codes & Urban Safety Awareness",
      "id": "block-131",
      "order": 131
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Sustainable Coastal Travel, Environmental Protection & Overtourism Protocols",
      "id": "block-138",
      "order": 138
    },
    {
      "type": "paragraph",
      "text": "The fragile ecology and dramatic topography of the Amalfi Coast face intense pressure from global overtourism during peak summer months (June through August). Practicing responsible travel ensures the preservation of this UNESCO World Heritage cultural landscape.",
      "id": "block-139",
      "order": 139
    },
    {
      "type": "paragraph",
      "text": "Embrace Maritime Mobility: The winding Amalfi Coast road (SS163) suffers chronic gridlock and bumper-to-bumper tourist coach congestion. By traveling between coastal towns via public ferries and hydrofoils, visitors reduce carbon emissions, alleviate road strain, and enjoy peerless coastal views.",
      "id": "block-140",
      "order": 140
    },
    {
      "type": "paragraph",
      "text": "Support Terraced Lemon Agriculture: The steep agricultural terraces of the Amalfi Coast require labor-intensive manual maintenance to prevent fatal landslides and soil erosion. Support local lemon farmers by purchasing authentic certified Limone Costa d'Amalfi IGP products, taking guided lemon orchard walks, and patronizing family-run agriturismi.",
      "id": "block-141",
      "order": 141
    },
    {
      "type": "paragraph",
      "text": "Shoulder Season Exploration: The optimal window to experience Rome and the Amalfi Coast is during the shoulder seasons: mid-April to late May, or late September to late October. During these months, daytime temperatures are pleasantly mild (20 to 25 degrees Celsius), sea waters remain warm enough for swimming, historical monuments are unburdened by peak crowds, and accommodation rates are substantially more reasonable.",
      "id": "block-142",
      "order": 142
    },
    {
      "type": "paragraph",
      "text": "By approaching Italy with patience, curiosity, and respect for its living communities, travelers will discover an unforgettable civilizational journey that enchants the heart forever.",
      "id": "block-143",
      "order": 143
    }
  ],
  ...
  "travelVerification": {
    ...
    "officialSources": [
      {
        "title": "Italian National Tourist Board (ENIT Official Portal)",
        "url": "https://www.italia.it/"
      },
      {
        "title": "Ministry of Foreign Affairs of Italy (Visa for Italy Portal)",
        "url": "https://vistoperitalia.esteri.it/"
      },
      {
        "title": "Trenitalia Official High-Speed Rail Portal",
  ...
  "references": [
    ...
    {
      "title": "The Italian World: History, Art and the Genius of a People (John Julius Norwich)",
      "url": "https://thamesandhudson.com/"
    },
    {
      "title": "Archaeological Park of Pompeii: Official Scientific Documentation",
      "url": "http://pompeiisites.org/"
    },
    {
      "title": "Trenitalia: High-Speed Frecciarossa Operations Manual",
      "url": "https://www.trenitalia.com/"
    }
  ]
};
