...
const articleConfig = {
  ...
  "structuredBlocks": [
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "The Cult of Heroic Intensity: Why We Worship the Midnight Sprint",
      "id": "block-1",
      "order": 1
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "To build enduring value in the world, you must emancipate yourself from the cult of intensity. Stop seeking the intoxicating high of the emergency sprint. Fall in love with the quiet, dignified rhythm of daily fidelity, and let the relentless mathematics of compounding work their quiet miracle.",
      "id": "block-8",
      "order": 8
    },
    {
    ...
    },
    {
      "type": "table",
      "tableHeaders": [
        "Erratic Intensity Model (Fragile)",
        "Disciplined Consistency Architecture (Durable)"
      ],
      "tableRows": [
        [
          "Works 80 hours during crises; collapses into weeks of unproductive exhaustion.",
          "Works 30-35 high-focus hours every week with zero burnout or collapse."
        ],
        [
          "Relies on adrenaline, emergency deadlines, and external panic for motivation.",
          "Relies on automated morning rituals, calendar boundaries, and quiet habit."
        ],
        [
          "Sacrifices sleep, nutrition, and relationships to meet arbitrary deadlines.",
          "Treats sleep architecture and physical health as foundational capital."
        ],
        [
          "Creates erratic, fluctuating work quality requiring extensive post-hoc fixes.",
          "Produces predictable, high-baseline deliverables that compound smoothly."
        ]
      ],
      "id": "block-17",
      "order": 17
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "The Mathematics of Compounding: Small Increments vs. Episodic Surges",
      "id": "block-19",
      "order": 19
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "Small daily increments, repeated without interruption across hundreds of days, possess a quiet, unstoppable force. They wear down the hardest granite of resistance just as steady ocean drops carve through ancient volcanic cliffs.",
      "id": "block-25",
      "order": 25
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Designing the Minimum Viable Baseline: The Floor That Never Breaks",
      "id": "block-27",
      "order": 27
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Environmental Architecture: Eliminating Friction and Decision Fatigue",
      "id": "block-49",
      "order": 49
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "Notice the critical balance in that communication: the boundary is absolute, but it is paired with a clear promise of full presence during non-work hours. People do not resent boundaries; what they resent is ambiguity, chronic distraction, and half-presence. If you are constantly checking your phone during family dinners, your family will naturally feel disrespected and will interrupt your work sessions with equal disregard.",
      "id": "block-67",
      "order": 67
    },
    {
      "type": "paragraph",
      "text": "In corporate environments, managing social pressure requires training your colleagues on your responsiveness cadence. When you join a new team, establish your working style early: 'I batch my communication reviews at eleven-thirty and four in the afternoon. If you send me a message during the morning, I will not see it immediately because I am focused on engineering deliverables. If an absolute production outage occurs, page me on the emergency line.'",
      "id": "block-68",
      "order": 68
    },
    {
      "type": "paragraph",
      "text": "When people see that you consistently deliver extraordinary, bug-free work on schedule, they gladly adapt to your rhythm. Your predictability becomes an institutional anchor that calms the chaotic waters around you.",
      "id": "block-69",
      "order": 69
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "Tracking and Measurement: The Visual Accountability of the Chain",
      "id": "block-71",
      "order": 71
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "The Emotional Neutrality of the Professional: Transcending Moods",
      "id": "block-79",
      "order": 79
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "The Compounding of Trust: Why Consistency Is the Currency of Leadership",
      "id": "block-95",
      "order": 95
    },
    {
      "type": "paragraph",
      "text": "In human social hierarchies, trust is not built through charismatic speeches, theatrical promises, or periodic grand gestures. Trust is a slow, biological deposit made into the emotional accounts of others through dozens of small, predictable interactions over extended periods of time.",
      "id": "block-96",
      "order": 96
    },
    {
      "type": "paragraph",
      "text": "When a leader is erratic—brilliant and charming on Monday, explosive and paranoid on Wednesday, absent on Friday—their subordinates exist in a state of chronic hypervigilance. Employees spend half their cognitive energy monitoring the leader's moods, trying to decipher which version of the boss will walk through the door. Innovation stalls, bad news is concealed, and psychological safety evaporates.",
      "id": "block-97",
      "order": 97
    },
    {
      "type": "paragraph",
      "text": "The leader whose hallmark is unbending consistency, by contrast, acts as an emotional stabilizer for the entire enterprise. Subordinates know exactly what to expect: meetings start on time; decisions are evaluated against explicit, stable principles; accountability is applied fairly; and feedback is delivered calmly without emotional theatrics. In this predictable, stable environment, team members can drop their defensive armor and pour their full energy into the mission.",
      "id": "block-98",
      "order": 98
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "Be the immovable rock in your organization. Let your colleagues and clients know that when your name is on the commitment, the delivery will arrive with the quiet, unquestioned certainty of the morning sun.",
      "id": "block-100",
      "order": 100
    },
    {
    ...
    },
    {
      "type": "heading",
      "headingLevel": 2,
      "text": "The Economics of Compounding Output: The Inevitable Triumph of Time",
      "id": "block-123",
      "order": 123
    },
    {
      "type": "paragraph",
      "text": "In the commercial marketplace, the ultimate winner is rarely the loudest, the flashiest, or the most heavily capitalized. The ultimate winner is almost invariably the entity that can survive the longest and compound the most reliably over extended time horizons.",
      "id": "block-124",
      "order": 124
    },
    {
      "type": "paragraph",
      "text": "This economic reality is driven by the power law distribution of compounding returns. In the early stages of any venture, investment, or career, the returns are small, almost negligible. You invest years of effort for minimal incremental gain. But as the compounding curve turns upward, the returns begin to accelerate exponentially. By year ten or fifteen, a single year's compounding produces more absolute gain than the entire first decade combined.",
      "id": "block-125",
      "order": 125
    },
    {
      "type": "paragraph",
      "text": "The tragedy of modern markets is that ninety-five percent of participants drop out before reaching the exponential elbow of the curve. They burn through their capital in reckless bursts of hyper-growth, exhaust their teams with constant strategic pivots, or surrender to boredom and chase the next glittering fad. They reset their compounding clock every three years, forever trapped in the slow, linear foundation tier.",
      "id": "block-126",
      "order": 126
    },
    {
    ...
    {
      "type": "paragraph",
      "text": "Do not be in a hurry. Time is the greatest ally you have, if only you possess the patience and discipline to partner with it. Stay at your post, honor your daily practice, and let the relentless, compounding river of time carry you to triumphs that erratic intensity could never even imagine.",
      "id": "block-128",
      "order": 128
    },
    {
      "type": "paragraph",
      "text": "Consider how this compounding principle operates in institutional preservation. Enduring foundations, universities, and multi-generational family trusts do not seek fifty percent annual speculative returns; they seek steady, inflation-beating six percent real growth combined with total capital preservation. Across a century, that unhurried consistency turns modest endowments into world-altering fortunes that outlive dozens of speculative booms and busts.",
      "id": "block-129",
      "order": 129
    },
    {
  ...
  "references": [
    ...
    {
      "title": "Willpower: Rediscovering the Greatest Human Strength (Roy F. Baumeister & John Tierney)",
      "url": "https://www.penguinrandomhouse.com/books/305809/willpower-by-roy-f-baumeister-and-john-tierney/"
    },
    {
      "title": "Great by Choice: Uncertainty, Chaos, and Luck--Why Some Thrive Despite Them All (Jim Collins & Morten T. Hansen)",
      "url": "https://www.jimcollins.com/books/great-by-choice.html"
    },
    {
      "title": "The Power of Full Engagement (Jim Loehr & Tony Schwartz)",
      "url": "https://www.simonandschuster.com/books/The-Power-of-Full-Engagement/Jim-Loehr/9780743226752"
    }
  ]
};
