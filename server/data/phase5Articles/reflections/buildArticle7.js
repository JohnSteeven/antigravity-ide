...
function buildArticle7() {
  const sections = [
    {
      heading: "The Ghost Ship That Didn't Sail: The Psychology of Unlived Lives",
      paragraphs: [
        "In every human consciousness there exists a private, silent harbor where the ghost ships of our unlived lives remain anchored. We sit in our actual kitchens, looking across the breakfast table at our actual partners, commuting to our actual offices, or walking through our actual neighborhoods; and alongside that lived reality floats a luminous, phantom shadow: the person we might have become had we turned left instead of right at age twenty-two, had we accepted that faraway job offer, had we married that summer lover, or had we remained in the town where we were born.",
        "The twentieth-century psychoanalyst Adam Phillips noted that our unlived lives are often far more vivid, romantic, and emotionally demanding than the lives we actually lead. The unlived life never suffers from mundane logistical friction. In that alternate reality, the roof never leaks, the salary is always ample, the romantic passion never cools into domestic routine, and the body never ages or encounters chronic fatigue. It exists as an idealized, immaculate counterpoint to the inevitable messiness of real existence.",
        "This psychological phenomenon is not a sign of mental pathology; it is an inescapable consequence of human imagination and temporal consciousness. Unlike other creatures who live entirely in the immediate sensory present, human beings possess the cognitive architecture to simulate alternate pasts and project multiple hypothetical futures. We are chronic counterfactual storytellers, constantly measuring the grain of our present hours against what might have been.",
        "Yet when these phantom possibilities are indulged without awareness, they begin to leach color and vitality out of our actual reality. The individual becomes a spectator in their own biography, perpetually distracted by the siren call of a vanished path. They treat their present commitments—their career, their marriage, their geographic community—as provisional holding patterns, waiting for a true life that was supposedly stolen from them by a single mistaken decision.",
        "Coming to terms with the lives we did not choose is therefore one of the central developmental tasks of adult emotional maturity. It requires confronting the tragic, non-negotiable finitude of mortal existence: that to choose one path is necessarily to murder a thousand other equally valid possibilities. We cannot explore every continent, master every discipline, or love every captivating stranger. Maturity begins when we stop resenting the law of limitation.",
      ],
      callout: {
        type: "info",
    ...
    {
      heading: "The Myth of the Optimal Choice: Decisions Under Inevitable Uncertainty",
      paragraphs: [
        "At the heart of chronic regret lies a false philosophical premise: the belief that life is an optimization problem to which there exists a single, provably correct solution. We approach major existential choices—career, marriage, children, geographic location—as if we were solving a complex mathematical equation, searching for the formula that will maximize happiness and minimize suffering.",
        "In reality, existential decisions are made under conditions of radical, irreducible uncertainty. When you choose to marry a specific person, accept a job in another city, or have a child, you cannot run a controlled simulation of the alternatives. You cannot step into a parallel universe, live ten years under Condition A, rewind the clock, live ten years under Condition B, and then select the higher-scoring timeline.",
        "The Danish philosopher Søren Kierkegaard famously captured this tragic dimension of existence when he wrote that life can only be understood backward, but it must be lived forward. Every major step into the future is a leap into the dark, taken with incomplete data and unmapped emotional terrain.",
        "Because there is no objective 'optimal' path, regret cannot be eliminated through more meticulous analysis or agonizing rumination. Every path through mortal life involves an unrepeatable mixture of unique joys, unforeseen sorrows, boring compromises, and quiet triumphs. The unchosen path was not the 'correct' path; it was simply a different container of human experience.",
        "Liberating oneself from the myth of the optimal life allows an individual to replace the agonized question 'Did I make the right choice?' with the far more fruitful and pragmatic question 'How can I inhabit this chosen life with depth, courage, and wholehearted integrity?'",
      ],
    },
    {
      heading: "Comparing Reality with Fantasy: The Asymmetry of the Known and Unknown",
      paragraphs: [
        "The fundamental structural flaw in all regretful rumination is that it compares two things of entirely different ontological categories: concrete, lived reality versus abstract, unconstrained fantasy. This asymmetry guarantees that reality will always lose the contest.",
        "Your lived reality is tangible, gritty, and complete. It includes the smell of yesterday's garbage, the dull ache in your lower back, the repetitive conversations with colleagues, the monthly utility bills, and the inevitable moments of irritation with your partner. You know its flaws intimately because you live inside them every single day.",
        "The unchosen life, by contrast, possesses no physical flaws because it has never existed in three-dimensional space. When you imagine the alternate life where you moved to Paris to study architecture, you imagine sipping espresso in a sunny courtyard or sketching cathedrals in the spring rain. You do not imagine the damp, mouse-infested fifth-floor walk-up, the French bureaucratic immigration nightmares, the bitter winter draft through old window sashes, or the crushing loneliness of living in a foreign language.",
        "By comparing the entirety of your real life—its bad days, its boring hours, its compromises—with only the peak cinematic highlights of an imagined alternative, you construct an engine of perpetual misery. You are measuring a real human being against a hologram.",
        "Whenever the phantom life begins to seduce your imagination, honesty demands that you populate the fantasy with real-world gravity. Add the administrative friction, the physical ailments, the financial worries, and the interpersonal conflicts that accompany human bodies everywhere on earth. When you drag the phantom into the daylight of reality, its magical glow begins to fade.",
      ],
    },
    {
      heading: "Career Crossroads: The Vanished Alternate Professions",
      paragraphs: [
        "Of all the areas where unchosen lives haunt the modern adult, career divergence is among the most persistent. In our twenties, we stand before an immense banquet of vocational possibilities: medicine, law, academia, artistic craft, entrepreneurship, teaching, or public service. Yet the demands of specialized training and economic survival force us to narrow our focus to a single trade.",
        "Years later, having climbed a particular professional ladder, the corporate manager looks out of their glass window and wonders about the musician they abandoned. The physician, exhausted by clinical paperwork and insurance approvals, dreams of the landscape architecture firm they almost started. The teacher wonders what might have happened had they pursued high finance.",
        ...
        "Furthermore, our alternate professional longings often represent aspects of our psyche that have been neglected rather than actual vocational callings. The corporate executive who longs for the artist's life may not actually want to navigate the poverty and insecurity of the art market; they simply need to introduce tactile creativity, playfulness, and aesthetic appreciation into their evenings and weekends.",
        "Instead of mourning the abandoned career as a lost destiny, one can treat it as a compass indicating unexpressed values. You do not need to quit your job to honor the musician within you; you can buy a piano, take lessons, and fill your home with music. The alternate self can be invited to sit at your domestic table without burning down the house.",
      ],
      table: {
        headers: ["Unchosen Domain", "Romantic Fantasy Illusion", "Lived Reality Truth", "Constructive Modern Integration"],
        rows: [
          ["Creative Vocation", "Endless pure inspiration and critical acclaim", "Severe financial instability, rejection, and isolation", "Devoting unmonitored weekend hours to serious artistic hobby"],
          ["Expatriate Life", "Perpetual adventure in sunlit foreign plazas", "Bureaucratic alienation, language barriers, and loss of roots", "Engaging in deep cultural study, foreign reading, and intentional travel"],
          ["Corporate Power", "Effortless status, private jets, and total influence", "80-hour workweeks, chronic burnout, and high domestic friction", "Exercising strategic leadership in local community organizations"],
          ["Rural Simplicity", "Idyllic pastoral peace and organic gardens", "Physical exhaustion, isolation, and lack of cultural infrastructure", "Cultivating houseplants, weekend hiking, and simplifying domestic clutter"],
        ],
      },
    },
    {
      heading: "The Romantic Fork: The Loves We Didn't Pursue and the Marriages We Didn't Form",
      paragraphs: [
        "In the quiet hours of an ordinary marriage or long-term partnership, almost everyone occasionally reflects upon past lovers and the relationships that dissolved at the threshold of commitment. We remember the intensity of an early romance, the electric chemistry of a person we met during a summer abroad, or the college sweetheart who wanted a life we were not yet ready to provide.",
        "It is easy to romanticize these departed figures precisely because the relationship ended before the grinding friction of real domesticity could set in. They remain forever thirty years old, sparkling with wit, unburdened by mortgage negotiations, sick children, or aging in-laws. We preserve them in amber as symbols of lost youth and unconstrained passion.",
        "What we are usually longing for in these moments is not actually the specific historical person, but the version of ourselves that existed in their presence: young, unencumbered, full of open potential, and intensely desired. We project our longing for lost vitality onto an absent human screen.",
    ...
    {
      heading: "Geographic Divergence: The Cities and Landscapes We Never Inhabited",
      paragraphs: [
        "Human identity is deeply shaped by geography: the slant of light in winter, the humidity of summer, the dialect of street markets, the architecture of neighborhoods, and the proximity to ocean or mountains. When an individual contemplates the cities where they lived briefly or the foreign countries where they almost relocated, they are contemplating an alternate version of their character.",
        "The person who stayed in their midwestern hometown wonders if they would have been sharper, bolder, and more worldly had they moved to New York or London. The urban professional living in a concrete high-rise wonders if their nervous system would have been calmer, gentler, and more grounded had they bought a farmhouse in Vermont or a cottage in Cornwall.",
        "While geographic environment certainly influences sensory lifestyle, it possesses remarkably little power to alter the core emotional architecture of human consciousness. As the Roman philosopher Horace famously remarked two millennia ago: 'They change their sky, not their soul, who run across the sea.' Whatever internal restlessness, insecurity, or existential dread you carry inside you will unpack itself in the new apartment in Paris just as reliably as it did in Chicago.",
        "When we believe that an alternate geography would have magically resolved our internal conflicts, we fall victim to what psychologists call the geographic cure. We imagine that external scenery can substitute for the internal labor of peace.",
        "True peace is cultivated not by perpetually longing for distant horizons, but by putting down roots in the soil where you currently stand. When you learn to love the quirks of your actual neighborhood—the peculiar tree at the corner, the friendly grocery clerk, the way the light hits your porch at sunset—your present geography becomes holy ground.",
      ],
    },
    {
      heading: "The Grief of Foreclosure: Mourning the Many Selves We Could Not Be",
      paragraphs: [
        "Beneath the specific regrets about careers, romances, and cities lies a deeper, more universal sorrow: the grief of foreclosure. To mature from adolescence into middle age is to witness the steady, irreversible closing of doors. In youth, our identity feels like an infinite expanse of uncarved marble; by fifty, the statue has been largely chiseled, and the discarded chips cannot be glued back on.",
        "This narrowing of potential is a genuine bereavement that requires mourning. We must grieve for the athlete we did not become, the polyglot we never mastered, the wild adventurer we traded for domestic stability, and the quiet scholar we sacrificed for corporate achievement. Denying this grief or pretending that 'one can have it all' only deepens the underlying ache.",
        "Allowing yourself to feel the sadness of foreclosure without falling into despair is a delicate emotional art. It means standing before the cemetery of your unlived lives, bowing with reverence to those departed possibilities, and saying: 'You were beautiful, and I honor you; but I must return to the one life that was entrusted to my care.'",
        "This act of mourning is not an admission of defeat; it is the essential clearing of psychological ground. As long as you cling to the fantasy that all doors remain open, you cannot fully enter any single room. You remain standing in the cold, windy hallway of indecision.",
        "When you finally permit the alternate selves to rest in peace, an immense burden lifts from your shoulders. You are liberated from the exhausting obligation to be everything, know everything, and experience everything. You are free to simply be who you actually are.",
      ],
    },
    {
      heading: "The Chemistry of Acceptance: Integrating Irreversible Decisions",
      paragraphs: [
        "How does an individual cross the threshold from bitter regret to serene acceptance? In psychological terms, acceptance is not passive resignation or sour grapes. It is the active, dignified integration of reality as it is, stripped of futile demands that the past should have been different.",
        "The first step in this alchemy is recognizing the principle of necessity. The decisions you made in the past were the inevitable consequence of who you were at that time, interacting with the pressures and knowledge then present. If you could have chosen differently, you would have. To demand that your past self should have possessed your future wisdom is an irrational contradiction in terms.",
        ...
        "The German philosopher Friedrich Nietzsche proposed the ultimate test of psychological integration in his concept of 'Amor Fati'—the love of one's fate. He challenged the individual to cultivate a mindset wherein they would not wish anything to be different, neither in the past nor in the future, throughout all eternity. To love fate is to embrace every thread of the tapestry, both the bright gold and the somber black.",
        "When you practice Amor Fati, regret dissolves because you understand that your present consciousness—with all its depth, wisdom, and capacity for compassion—is the direct child of every choice you ever made. To repudiate your past choices is to repudiate the very self that now stands in the light of day.",
      ],
      callout: {
        type: "info",
    ...
    {
      heading: "From Regret to Agency: Reclaiming Choice in the Present Hour",
      paragraphs: [
        "The most tragic consequence of dwelling on unlived lives is that it robs the individual of the only agency they truly possess: the power of choice in the present hour. While you cannot alter the decision made twenty years ago, you are making hundreds of decisions today that will determine the texture of your life twenty years from now.",
        "Every morning when you wake up, you stand at a new fork in the path. You decide how you will treat your partner, whether you will pick up your smartphone or a book, what food you will put into your body, how deeply you will apply yourself to your craft, and whether you will offer kindness or cynicism to the world.",
        "If you spend your present hours daydreaming about the alternate life you missed, you are actively manufacturing the very regrets that will haunt you in your old age. The seventy-year-old version of yourself will look back at this exact day and say: 'Why did they waste their precious fiftieth year mourning the twenties, instead of savoring the vibrant life they still had?'",
        "Reclaiming agency requires snapping the gaze forward. Ask yourself: What possibilities are available to me right now that I am neglecting? What new skill can I begin learning today? What relationship can I repair? What adventure, scaled to my actual resources, can I embark upon this weekend?",
        "Life is not over until the final breath leaves the lungs. It is never too late to become a person of depth, generosity, curiosity, and courage. The unchosen lives of the past may be gone, but the unwritten chapters of your future are waiting for your pen.",
      ],
    },
    {
      heading: "Radical Self-Compassion: Forgiving the Person You Were When You Decided",
      paragraphs: [
        "At the root of persistent regret is an unforgiving, punitive relationship with oneself. We hold our past selves to an impossible standard of prescience, expecting our younger, terrified, inexperienced incarnation to have navigated complex crossroads with the poise of an enlightened sage.",
        "Consider holding in your mind’s eye the person you were when you made that fateful decision ten, twenty, or thirty years ago. Look at their face: notice the fear in their eyes, the pressure they were carrying, the hunger for love or safety that drove them, the bad advice they received from well-meaning elders, and the sheer lack of experience that blinded them to future pitfalls.",
        "Would you treat a terrified child or a confused young friend with the same venomous cruelty that you inflict upon your past self? Would you tell them they are foolish, cowardly, and ruined because they made a mistake under pressure? Of course not. You would offer them comfort, wrap them in understanding, and tell them that life is long and forgiving.",
        "Radical self-compassion requires extending that same tender forgiveness backward through time to your own history. You must forgive yourself for not knowing what you had not yet learned. You must forgive yourself for choosing safety over adventure when you were frail, or choosing adventure over safety when you were reckless.",
        "When you forgive your younger self, the psychic civil war that has drained your vitality for decades finally ends. You lay down the weapons of accusation and take your younger self gently by the hand, welcoming them home into the warmth of your present acceptance.",
      ],
    },
    {
      heading: "The Seduction of Nostalgia: When the Past Becomes a Golden Counterfeit",
      paragraphs: [
        ...
        "When we indulge in nostalgia about unchosen paths, we engage in selective neurological editing. We remember the warmth of a college campus in spring, the laughter shared with an old companion, or the exhilarating freedom of having no fixed responsibilities. We conveniently expunge from the record the chronic acne, the agonizing exam stress, the financial panic of empty bank accounts, and the humiliating social awkwardness that defined sixty percent of those days.",
        "This golden counterfeit makes the present appear dreary, gray, and compromised by comparison. The adult evaluates their current domestic life against a past that never actually existed in the pristine form memory has concocted. They pine for an illusion, yearning to return to a garden that was always overgrown with weeds.",
        "Overcoming the seduction of nostalgia requires demanding total historical honesty from our recollections. When an old era begins to glow with romantic perfection, force yourself to recall the arguments, the sleepless nights of doubt, the bad jobs, and the bitter loneliness that also inhabited that time. By restoring the shadows to the painting, the past loses its tyrannical power over the present.",
        "Nostalgia should be treated like a vintage liqueur: pleasant to sip in tiny quantities on rare occasions, but fatal to drink as a substitute for the clean, clear water of present living. The only time that can ever be inhabited is the unfolding now.",
      ],
    },
    {
      heading: "Parental Expectations and Inherited Scripts: The Burden of Borrowed Dreams",
      paragraphs: [
        "A substantial portion of the choices that later spawn bitter regret were never truly our own; they were the borrowed ambitions and unfulfilled desires of our parents, teachers, and cultural mentors. From early childhood, we absorb invisible emotional directives: to achieve the financial security our parents lacked, to attain the social status that eluded them, or to fulfill the artistic dreams they abandoned.",
        "When an adult child chooses a profession or a lifestyle primarily to secure parental approval, they are living a borrowed biography. For years, the adrenaline of validation sustains them: the proud smiles at graduation, the boastful updates shared with extended family, the feeling of being the reliable pillar of the clan.",
        "Yet in mid-life, the borrowed script almost invariably collapses. The parental figures age and fade; external approval loses its narcotic power; and the individual wakes up inside a career or a domestic arrangement that bears no relationship to their authentic values. The question arises with terrifying urgency: 'Whose life have I been living?'",
        "Disentangling oneself from inherited scripts requires profound courage. It involves acknowledging that your parents’ anxieties about security and status were legitimate reactions to their own historical context, but that their fears do not constitute a binding legal contract for your existence.",
        "You can honor your ancestors without sacrificing your soul upon their altars. Reclaiming your life may disappoint external expectations, but living an authentic, honest life of modest means is infinitely more dignified than maintaining a hollow monument to someone else’s vanity.",
      ],
    },
    {
      heading: "The Resilience of the Soul: How Hardship Carves Capacity for Meaning",
      paragraphs: [
        "When we lament the paths we did not choose, we almost always assume that the alternate route would have spared us suffering. We imagine that had we made the 'right' choice, our lives would have been an unbroken sequence of sunny triumphs, effortless health, and joyful camaraderie.",
        "This assumption flies in the face of all human experience. Suffering is not an accidental glitch in human existence; it is an intrinsic structural feature of the mortal condition. Had you avoided the heartbreak of your chosen path, you would have encountered different, equally searing heartbreaks along the alternate road: chronic disease, business failure, betrayal, or bereavement.",
        "Furthermore, human character and depth of soul are carved almost exclusively by the tools of adversity. The ease and comfort we yearn for rarely produce wisdom, humility, or profound compassion. An individual whose life was an uninterrupted cruise of effortless success is almost universally shallow, self-absorbed, and fragile.",
        "The hardships, mistakes, and painful compromises of your actual life are the very fires that tempered your strength. Because you failed, you know how to be humble; because you were lonely, you know how to comfort a weeping friend; because you struggled to pay bills, you understand the dignity of working people.",
        "To wish away the difficulties of your past is to wish away the moral core of who you are today. The scars you carry are not badges of shame; they are proof that you entered the arena of real life and survived its fiercest storms.",
      ],
    },
    {
      heading: "The Sunk Cost Delusion: Knowing When to Persevere and When to Pivot",
      paragraphs: [
        "Closely tied to the grief of unchosen lives is the cognitive trap of the sunk cost fallacy. Individuals often remain trapped in miserable careers, deadened relationships, or unfulfilling living situations simply because they have already invested fifteen years, thousands of dollars, or immense emotional capital into that specific path. They tell themselves: 'If I leave now, all those years will have been wasted.'",
        "This rationale is a profound economic and psychological error. The resources, time, and emotional energy you invested in the past are gone forever; they cannot be recovered whether you stay or leave. The only rational question facing an adult at any juncture is: 'Given where I stand today, what is the wisest, most life-affirming investment of my remaining finite days?'",
        "Reconciling with the unlived life does not mean adopting fatalistic paralysis. While some decisions are genuinely irreversible—such as biological age or the death of a loved one—many life paths can be pivoted with courage and practical planning. An accountant at forty-two can retrain as a psychotherapist; a suburbanite at fifty-five can move into a walkable city neighborhood.",
        "The art of living requires distinguishing between healthy perseverance and stubborn martyrdom. Perseverance means enduring temporary difficulty in service of a deeply cherished long-term value. Martyrdom means enduring chronic, soul-destroying misery merely to avoid admitting that an earlier choice did not pan out.",
        "When you liberate yourself from sunk costs, the future opens up once again. You realize that you do not owe allegiance to the ghost of your past investments. You owe allegiance only to the living truth of who you are called to become today.",
      ],
    },
    {
      heading: "The Daily Practice of Presence: Grounding Attention in the Tactile Here and Now",
      paragraphs: [
        ...
        "Notice what is happening in this exact room right now. Feel the pressure of your feet against the floor; notice the temperature of the air entering your nostrils; listen to the subtle hum of the heating vent or the rain tapping on the glass. In the immediate somatic present, there is no lack, no mistake, and no tragedy. There is only life unfolding.",
        "Establishing tactile daily grounding practices anchors consciousness in reality. Kneading bread dough, chopping garlic on a wooden board, tending a garden, polishing shoes, or playing a musical instrument forces the mind to coordinate with physical resistance. Reality demands total presence; you cannot daydream about alternate careers while working with sharp kitchen knives.",
        "Similarly, cultivating active gratitude for the specific micro-luxuries of your actual day dispels the fog of regret. A hot shower on a cold morning, the aroma of freshly ground coffee, the purring of a cat curled in your lap, the sound of your child laughing in the hallway—these are not trivial consolations. They are the supreme, unrepeatable joys of existence.",
        "By repeatedly returning attention to the tactile textures of the present, you train your mind to fall in love with what is. The unlived lives lose their seductive power because the lived life is so richly, deliciously real.",
      ],
    },
    {
      heading: "The Architecture of a Reconciled Life: Wisdom Across the Decades",
      paragraphs: [
        "In psychological research on human lifespan development, the final stage formulated by Erik Erikson is defined by the tension between Ego Integrity and Despair. In late adulthood, every individual conducts an unsparing audit of their life. Those who succumb to despair look back at their trajectory with bitter regret, feeling that time is now too short to try another path and that their existence was a catalog of tragic errors.",
        "Those who attain Ego Integrity, by contrast, achieve a luminous, quiet reconciliation. They look back at their messy, winding, imperfect journey—with all its detours, abandoned dreams, and clumsy compromises—and say: 'This was my life. It was not the only life that could have been, but it was mine, and I take full, loving responsibility for every chapter of it.'",
        "This integrity is not born overnight in the eighth decade; it is constructed day by day through the conscious practice of acceptance throughout adulthood. Every time you refuse to indulge in bitter counterfactual fantasies, every time you choose to pour love into your actual surroundings, you lay another stone in the foundation of your future peace.",
        "The reconciled individual possesses an aura of unshakeable serenity. They do not envy the flashy success of the young; they do not panic over missed opportunities; they do not bore their friends with endless complaints about what might have been. They sit in the autumn sun of their days, peaceful and complete.",
        "They have discovered the ultimate truth of mortality: that life is not measured by the number of possibilities you left unexplored, but by the depth of love, presence, and courage with which you inhabited the one path you walked.",
      ],
    },
    {
      heading: "Embracing the Chosen Life: The Dignity of Finitude and Commitment",
      paragraphs: [
        "In the final analysis, the glory of human life is found not in the infinite breadth of uncommitted potential, but in the deep, narrow groove of committed actuality. A life spent hovering above all options, refusing to commit fully to any career, place, or partner for fear of missing out, is not freedom; it is the ultimate form of spiritual cowardice.",
        "Real depth is achieved only through limitation. The river acquires its immense power and beauty precisely because its banks constrain it, forcing the water into a deep, rushing channel. Without banks, the river becomes a shallow, stagnant marsh, spreading everywhere and going nowhere.",
        "When you throw your whole heart into your actual, chosen life—when you say 'This is my work, this is my home, this is my partner, this is my community, and here I will stand'—you enter a sanctuary of peace that no phantom life could ever offer.",
        "You begin to see the beauty in the worn floorboards of your kitchen, the familiar laughter of your partner, the accumulated memories of your town, and the hard-won craftsmanship of your trade. You realize that this messy, imperfect, concrete life is not a consolation prize; it is your one wild and precious existence.",
        "Consider how craftsmanship matures only through faithful repetition. The master carpenter does not become great by constantly questioning whether they should have become a glassblower; they achieve mastery by surrendering to the grain of the wood before them year after year. In the same manner, the art of living reaches its highest expression when we stop auditioning alternate biographies and dive completely into the grain of the days we have been given.",
        "In this surrender to actuality, the noise of comparison falls silent. You no longer care whether someone else's timeline looks more glamorous on a screen or whether an alternate version of you achieved greater wealth in another city. You are occupied with the sacred task of loving what is right in front of you.",
        "So let the ghost ships sail away into the mist. Let the phantom selves dissolve into the evening air. Turn your face to the sunlight streaming through your actual window, take a deep breath of real air, and embrace the life that is yours with gratitude, wonder, and unreserved love.",
      ],
      list: [
  ...
  const config = {
    ...
    excerpt:
      "A compassionate philosophical inquiry into the psychology of counterfactual regret, exploring how we mourn alternate paths, reconcile with irreversible decisions, and discover peace in the singular reality of our actual lives.",
    coverImage:
      "https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=1600&q=85",
    coverImageAlt:
      "A solitary hiker standing at a high mountain summit overlooking a sea of clouds at sunrise",
    coverImageCaption:
      "Reconciling with the unlived life requires accepting the dignified finitude of mortal commitment.",
    tags: [
      "Reflections",
      "Regret",
      "Decision Making",
  ...
  writeArticleModule("reflections", "the-lives-we-did-not-choose.js", config);
}
