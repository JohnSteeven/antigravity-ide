...
function buildArticle2() {
  const sections = [
    {
      ...
      quote: {
        text: "To care for those who once cared for us is one of the highest moral duties of human existence, yet it is also one of the most psychologically complex territories an adult will ever traverse.",
        attribution: "MyJourney Editorial Family & Aging Studies",
      },
    },
    {
      heading: "The Preservation of Dignity: Navigating the Delicate Balance of Autonomy",
      paragraphs: [
        "Autonomy is the core currency of human dignity. From the moment a toddler insists on tying their own shoes, human identity is bound up with the capacity to exert self-determination over one's body, environment, and choices. When physical or cognitive decline threatens this capacity in late life, elderly adults fight tenaciously to preserve whatever fragments of independence remain. What adult children often interpret as irrational stubbornness is usually a desperate defensive campaign against erasure.",
        "Consider the iconic crisis of the car keys. In modern suburban and rural societies, the automobile is not merely a mode of transport; it is the physical embodiment of freedom. Surrendering the car keys signifies the loss of spontaneous movement, the end of private errands, and the permanent transition into dependence upon others for the simplest life necessities: groceries, medical visits, religious services, and social gatherings. When an adult child attempts to confiscate the keys through unilateral decree, the parent experiences it as an existential assault.",
    ...
    {
      heading: "The Practical Ledger: Medicine, Mobility, and Daily Logistics",
      paragraphs: [
        "Behind the emotional drama of parental aging lies a staggering mountain of daily administrative and physical labor. In modern healthcare systems, the coordination of geriatric care is an extraordinarily fragmented enterprise. An eighty-two-year-old individual may see a cardiologist, an endocrinologist, a nephrologist, an ophthalmologist, and a primary care physician—each practicing in separate healthcare networks with non-communicating electronic medical records.",
        "The risk of polypharmacy—the simultaneous use of multiple medications with potential adverse interactions—is acute. A specialist prescribes a drug to treat a symptom that is actually a side effect of another medication prescribed by a different doctor six months earlier. Adult children must step into the role of clinical project managers: creating unified medication schedules, cross-referencing contraindications, managing refills, and accompanying parents into examination rooms to ensure accurate information flow.",
    ...
    {
      heading: "Modifying the Environment: Physical Renovations for Safe Aging",
      paragraphs: [
  ...
  const config = {
    ...
    category: "Life",
    excerpt:
      "A comprehensive exploration of generational role reversal, examining how adult children can manage medical advocacy, financial coordination, sibling dynamics, and emotional ambivalence while fiercely protecting parental dignity.",
    coverImage:
      "https://images.unsplash.com/photo-1576765608535-5f04d1e3f289?auto=format&fit=crop&w=1600&q=85",
    coverImageAlt:
      "Warm hands of two generations resting together on a wooden table in quiet afternoon light",
    coverImageCaption:
      "The delicate transition of caring for an aging parent requires balancing necessary protection with fierce defense of their autonomy.",
    tags: [
      "Aging Parents",
      "Caregiving",
      "Family Dynamics",
  ...
  writeArticleModule("life", "when-parents-begin-to-need-their-children.js", config);
}
