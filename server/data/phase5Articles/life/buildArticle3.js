...
function buildArticle3() {
  const sections = [
    ...
    {
      heading: "Navigating Divergent Economic and Status Trajectories",
      paragraphs: [
    ...
    {
      heading: "The Healing Power of the Witness: Friends Who Remember Who You Once Were",
      paragraphs: [
        "In our modern, mobile world, we change identities with remarkable frequency. We switch careers, move across continents, change marital statuses, and adopt new lifestyle aesthetics. To our current coworkers and neighbors, we are known only in our current, polished incarnation. They know us as the senior director, the suburban homeowner, the respectable community member. They have no knowledge of the person we were before.",
        "A longtime friend is an irreplaceable human archive. They remember you when you had bad acne, when you were terrified of speaking in public, when you were weeping over your first broken heart in a dorm hallway, when you had zero professional credibility and big, impossible dreams. They hold the earlier chapters of your story in their own memory.",
        "This shared historical memory provides a profound psychological anchor against the disorientations of adulthood. When corporate success threatens to make you arrogant, a longtime friend deflates your pretenses with a single raised eyebrow and a reference to your disastrous freshman poetry phase. When failure or divorce threatens to convince you that you are fundamentally broken, that same friend reminds you of your enduring resilience: 'I watched you survive that awful year in Chicago; I know who you are, and you will survive this, too.'",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Overcoming this barrier requires complete transparency and intentional inclusion. When a cross-gender friend is integrated into the couple's shared life—welcomed warmly into the domestic circle rather than kept in a secretive, segregated corner—the threat evaporates. The partner sees firsthand that the bond is grounded in genuine sibling-like affection, intellectual kinship, and mutual history rather than romantic intrigue.",
        "Moreover, cross-gender friendships offer irreplaceable emotional perspective. Men frequently discover that women friends provide a level of emotional attunement, conversational depth, and empathetic validation rarely modeled in traditional male peer groups. Women frequently find in male friends a direct, grounding pragmatism and refreshing relief from competitive female social scripts. When protected with clear boundaries and mutual respect, these friendships enrich adult emotional life immensely.",
      ],
    },
    {
      heading: "The Digital Illusion: Why Group Chats Are Not a Substitute for Closeness",
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "It reminds us that true richness is measured not by the balance in our accounts or the applause of crowds, but by the steady voices that greet us across the years without judgment.",
        "To have even one such friend across the span of an adult life is not merely good fortune; it is one of the most profound accomplishments of the human heart.",
      ],
    },
  ];
  ...
  const config = {
    ...
    category: "Life",
    excerpt:
      "A deep sociological and interpersonal analysis of how adult friendships weather geographic distance, marriage, parenthood, economic divergence, and shifting identities to become enduring anchors of life.",
    coverImage:
      "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=1600&q=85",
    coverImageAlt:
      "Two longtime adult friends laughing together during late afternoon conversation at an outdoor cafe",
    coverImageCaption:
      "The friendships that endure through adulthood shift from spontaneous proximity to intentional moral discipline.",
    tags: [
      "Friendship",
      "Adulthood",
      "Relationships",
  ...
  writeArticleModule("life", "the-friendships-that-survive-adulthood.js", config);
}
