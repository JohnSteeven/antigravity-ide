...
preloadExistingArticles(["life", "reflections", "lessons", "experiences", "travel"], "singapore");

console.log("Authoring Travel International 2/15: Singapore...");

const singaporeSections = [
  {
    heading: "Geography of the Malacca Strait: The Lion City Island & Equatorial Biome",
    callout: {
      type: "note",
  ...
  {
    heading: "Indian Aviation Gateways, Direct Flight Corridors & Changi Airport Architecture",
    paragraphs: [
      "The air bridge connecting Indian metropolitan centers to Singapore Changi Airport (IATA: SIN) represents one of the most frequent and heavily traveled air corridors in Asia. Nonstop commercial flights depart daily from over a dozen Indian cities, including Mumbai (BOM), New Delhi (DEL), Bengaluru (BLR), Chennai (MAA), Hyderabad (HYD), Kolkata (CCU), Tiruchirappalli (TRZ), and Kochi (COK). From southern Indian hubs like Chennai and Tiruchirappalli, flying time across the Bay of Bengal is approximately four hours; from Mumbai and New Delhi, wide-body services average approximately five hours and thirty minutes.",
      "Singapore Airlines, the nation's flagship carrier, operates premium wide-body flights (Airbus A350-900 and Airbus A380-800) offering world-class in-flight hospitality and full-service baggage allowances. Simultaneously, low-cost options—including Scoot (Singapore Airlines' budget subsidiary), IndiGo, and Air India Express—provide accessible point-to-point connections, particularly from tier-two cities in Tamil Nadu and Kerala with deep diaspora connections to Singapore.",
      "Singapore Changi Airport consistently ranks as the world's best international aviation hub, renowned for passenger efficiency, automated biometric immigration gates, and unmatched transit amenities. Spread across four sprawling passenger terminals, Changi is seamlessly integrated with Jewel Changi Airport—a multi-dimensional lifestyle hub designed by architect Moshe Safdie. At the heart of Jewel stands the HSBC Rain Vortex, a magnificent 40-meter-tall indoor waterfall cascading from a glass-domed ceiling into a subterranean funnel, enveloped by the lush Shiseido Forest Valley featuring two thousand tropical trees and palms.",
      "Terminal 2 and Terminal 3 feature direct subterranean concourses linking to the Changi Airport MRT Station (CG2), from which travelers can board the East-West Line directly into downtown Singapore. Terminals are linked airside via the automated Changi Skytrain and landside via pedestrian linkways and shuttle buses. For travelers with afternoon or evening departures, Changi offers the Jewel Early Check-in Lounge, allowing passengers on participating airlines (including Singapore Airlines and Air India) to drop heavy checked luggage up to twelve hours prior to departure, freeing them to explore the city or Jewel unencumbered."
    ],
    table: {
      headers: ["Flight Route & Origin Hub", "Primary Airlines Operating", "Flight Duration", "Arrival Terminal Code", "Round-Trip Economy Fare (INR)"],
      rows: [
        ["Chennai (MAA) to Singapore (SIN)", "Singapore Airlines, IndiGo, Scoot", "3h 55m (Nonstop)", "SIN (Terminals 1, 2, 3)", "₹18,500 - ₹27,000"],
        ["Tiruchirappalli (TRZ) to Singapore (SIN)", "Air India Express, Scoot, IndiGo", "4h 10m (Nonstop)", "SIN (Terminals 1, 2)", "₹17,000 - ₹24,500"],
        ["Mumbai (BOM) to Singapore (SIN)", "Singapore Airlines, Air India, IndiGo", "5h 20m (Nonstop)", "SIN (Terminals 2, 3)", "₹22,000 - ₹34,000"],
        ["New Delhi (DEL) to Singapore (SIN)", "Singapore Airlines, Air India, IndiGo", "5h 35m (Nonstop)", "SIN (Terminals 2, 3)", "₹23,500 - ₹35,500"],
        ["Bengaluru (BLR) to Singapore (SIN)", "Singapore Airlines, IndiGo, Scoot", "4h 25m (Nonstop)", "SIN (Terminals 1, 3)", "₹20,000 - ₹29,500"]
      ]
    }
  },
  {
    heading: "Singapore Visa Architecture for Indian Passport Holders & Transit Protocols",
    callout: {
      type: "important",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "To obtain your refund, present your physical passport at the point of sale and request an eTRS transaction record. Before departing Singapore from Changi Airport or Seletar Airport, visit the self-help eTRS kiosks located in the departure check-in hall (prior to clearing immigration if items are in checked baggage) or in the transit departure lounge (if items are in carry-on luggage). Scan your passport and follow on-screen prompts; refunds are disbursed directly to your credit card within ten business days or in cash at airport transit counters."
    ],
    table: {
      headers: ["Expenditure Category", "Budget Traveler (INR / Day)", "Mid-Tier Family (INR / Day)", "Luxury Traveler (INR / Day)", "Key Operational Notes"],
      rows: [
        ["Hotel Accommodation", "₹4,500 - ₹7,500 (Geylang/Little India)", "₹12,000 - ₹22,000 (Novena/Bugis/Civic)", "₹38,000 - ₹85,000+ (Marina Bay/Orchard)", "Pod hostels vs 4-star boutique vs 5-star iconic heritage"],
        ["Daily Food & Dining", "₹1,200 - ₹2,000 (Hawker centres)", "₹3,500 - ₹6,500 (Air-conditioned cafes)", "₹12,000 - ₹35,000 (Celebrity chef bistros)", "Hawker chicken rice/prata vs casual dining vs Michelin stars"],
        ["Public Transit Mobility", "₹450 - ₹750 (SimplyGo MRT/Bus)", "₹1,500 - ₹2,800 (MRT + Grab cabs)", "₹5,500 - ₹14,000 (Private chauffeured sedans)", "Unlimited rail network vs on-demand Grab/Gojek rides"],
        ["Attractions & Sightseeing", "₹1,800 - ₹3,000 (Botanic Gardens/Parks)", "₹4,500 - ₹8,500 (Gardens by the Bay/Zoo)", "₹15,000 - ₹32,000 (Universal VIP/Yacht)", "Free public parks vs standard paid entry vs VIP charters"],
        ["Total Daily Estimated Budget", "₹7,950 - ₹13,250 per person", "₹21,500 - ₹39,800 per person", "₹70,500 - ₹166,000 per person", "Excludes international flights from India and retail shopping"]
      ]
    }
  },
  {
    heading: "Urban Mobility Architecture: The Mass Rapid Transit (MRT) Network & Double-Decker Buses",
    callout: {
      type: "tip",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "For a spectacular nocturnal dining experience, visit Lau Pa Sat (Telok Ayer Market) in the heart of the financial district. Housed within an exquisite Victorian cast-iron pavilion shipped from Glasgow in 1894, the surrounding Boon Tat Street is closed to vehicular traffic every evening at 19:00, transforming into 'Satay Street'. Smoke rises from dozens of open charcoal grills where hawkers fan skewers of marinated chicken, mutton, and beef satay served with rich spiced peanut gravy and compressed rice cakes (ketupat).",
      "Other premier culinary institutions include Tekka Centre in Little India (famous for fragrant Dum Biryani and mutton soup), Old Airport Road Food Centre (legendary for Hokkien prawn mee and soya beancurd), and Amoy Street Food Centre (where innovative second-generation hawkers fuse traditional recipes with contemporary culinary techniques)."
    ],
    table: {
      headers: ["Hawker Centre & Neighborhood", "Signature Stalls & Specialties", "Average Stall Price (SGD / INR)", "Dietary Compatibility", "MRT Transit Station"],
      rows: [
        ["Maxwell Food Centre (Chinatown)", "Tian Tian Chicken Rice, Zhen Zhen Porridge", "4.00 - 6.50 SGD (₹250 - ₹410)", "Non-Vegetarian", "Maxwell (TEL - Brown Line)"],
        ["Tekka Centre (Little India)", "Allauddin's Biryani, Prata, Dosai", "4.50 - 8.00 SGD (₹280 - ₹500)", "Indian Vegetarian & Halal", "Little India (NE/DT Lines)"],
        ["Lau Pa Sat / Satay Street (CBD)", "Charcoal-grilled Satay skewers (Stalls 7 & 8)", "10.00 - 18.00 SGD (₹625 - ₹1,125)", "Halal & Non-Vegetarian", "Telok Ayer / Raffles Place"],
        ["Chinatown Complex (Smith St)", "Liao Fan Soya Sauce Chicken, Lian He Claypot", "3.50 - 7.00 SGD (₹220 - ₹440)", "Non-Vegetarian & Pork", "Chinatown (NE/DT Lines)"],
        ["Old Airport Road Food Centre", "Nam Sing Hokkien Mee, Lao Ban Beancurd", "3.50 - 6.00 SGD (₹220 - ₹375)", "Seafood & Veg options", "Dakota (Circle Line)"]
      ]
    }
  },
  {
    heading: "Sentosa Island, Coastal Recreation & Southern Ridges Green Corridors",
    paragraphs: [
  ...
  {
    heading: "Indian Dietary Navigation & Culinary Diversity Across the Lion City",
    paragraphs: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Day 5: Deep Rainforest & Wildlife Encounters. Morning excursion to the UNESCO World Heritage Singapore Botanic Gardens, strolling the National Orchid Garden and heritage rainforest. In the afternoon, travel north to Mandai Wildlife Reserve to explore the Singapore Zoo or River Wonders (featuring giant pandas Kai Kai and Jia Jia). In the evening, experience the world's first nocturnal wildlife park—the Night Safari—riding the open tram through simulated global habitats to observe Malayan tapirs, fishing cats, and Asian elephants under moonlit illumination.",
      "Day 6: Biophilic Southern Ridges, Last Shopping & Farewell. Walk the elevated forest canopy along the Southern Ridges or explore the Sungei Buloh mangrove wetlands. Enjoy afternoon retail therapy along Orchard Road or Jewel Changi. Complete your eTRS GST tax refund at Changi Airport departure kiosks, and board your evening flight back to India."
    ],
    table: {
      headers: ["Day & Primary Theme", "Morning Phase (09:00 - 12:30)", "Afternoon Phase (13:30 - 17:30)", "Evening Phase (18:30 - 22:00)", "Transit Logistics"],
      rows: [
        ["Day 1: Marina Bay Icons", "Changi Airport arrival & Jewel Rain Vortex", "Hotel check-in & ArtScience Museum", "Helix Bridge & Lau Pa Sat Satay Street", "MRT East-West & Downtown Lines via SimplyGo"],
        ["Day 2: Heritage & Civic", "National Gallery & Singapore River walk", "Kampong Gelam & Sultan Mosque textiles", "Little India temples & 24h Mustafa Centre", "MRT North-East Line & Downtown Line"],
        ["Day 3: Biophilic Architecture", "Gardens by the Bay (Cloud Forest Dome)", "Flower Dome & OCBC Skyway canopy", "Sentosa Beach sunset & Henderson Waves", "MRT Circle & Thomson-East Coast Lines"],
        ["Day 4: Chinatown & Hawker", "Buddha Tooth Relic Temple & shophouses", "Maxwell Food Centre lunch & Joo Chiat", "Singapore River Bumboat cruise to Marina", "Downtown Line & East Coast Bus 10/14"],
        ["Day 5: Wildlife & Nature", "Singapore Botanic Gardens & Orchid Garden", "Mandai River Wonders (Giant Pandas)", "World-famous Night Safari tram expedition", "MRT North-South Line & Mandai Shuttle Bus"],
        ["Day 6: Farewell Singapore", "Canopy walk along Southern Ridges", "Orchard Road shopping & Orchard Central", "Changi eTRS GST refund & return flight", "MRT East-West Line direct to SIN Terminal 2/3"]
      ]
    }
  },
  {
    heading: "Peranakan Heritage: Joo Chiat Shophouses, Beaded Slippers & Nonya Gastronomy",
    callout: {
      type: "note",
  ...
  },
  {
    ...
    paragraphs: [
      "Singapore is universally renowned for its extraordinary public cleanliness, personal safety, and social order. This environment is maintained through a combination of civic education, social cohesion, and rigorous, uncompromising enforcement of municipal laws.",
      "Travelers must be aware of specific civic regulations: littering on public streets carries fines starting at three hundred SGD for first offenders, progressing to Community Work Orders (where offenders must clean public spaces wearing luminous vests); chewing gum importation and commercial sale is illegal across Singapore; jaywalking across arterial roadways where pedestrian crossings are available within fifty meters incurs instant police fines.",
      ...
      "Singapore enforces strict anti-vaping and electronic cigarette laws. The purchase, possession, use, and importation of electronic vaporizers, e-cigarettes, and e-liquids are completely illegal under the Tobacco (Control of Advertisements and Sale) Act. Fines reach up to two thousand SGD, with confiscation and potential deportation for tourists carrying vape devices in luggage.",
      "Finally, public places of worship—such as Hindu temples, Buddhist monasteries, and Islamic mosques—require respectful decorum: remove footwear outside, dress modestly with shoulders and legs covered, avoid loud telephone conversations, and seek verbal permission before photographing devotees in prayer."
    ]
  },
  {
    heading: "The Singapore Green Plan 2030 & Sustainable Urban Living",
    paragraphs: [
      "Under the Singapore Green Plan 2030, the city-state has embarked on an ambitious whole-of-nation movement to advance sustainable development, achieve net-zero carbon emissions by 2050, and insulate the island against rising sea levels caused by global climate disruption.",
...
const singaporeBlocks = assembleStructuredBlocks(singaporeSections, singaporeInlineImages);
...
const singaporeConfig = {
  ...
  structuredBlocks: singaporeBlocks,
  tags: ["singapore", "gardens-by-the-bay", "marina-bay", "hawker-culture", "international-travel", "southeast-asia", "changi-airport", "little-india"],
  travelVerification: {
    ...
    officialSources: [
      { title: "Singapore Tourism Board (VisitSingapore)", url: "https://www.visitsingapore.com/" },
      { title: "Land Transport Authority (LTA) Singapore Official Portal", url: "https://www.lta.gov.sg/" },
      { title: "Immigration & Checkpoints Authority (ICA) Singapore", url: "https://www.ica.gov.sg/" }
    ],
  ...
  references: [
    { title: "From Third World to First: The Singapore Story (Lee Kuan Yew)", url: "https://www.harpercollins.com/" },
    { title: "Singapore: A Biography (Mark Ravinder Frost & Yu-Mei Balasingamchow)", url: "https://www.editionsdidierbillet.com/" },
    { title: "Land Transport Authority Singapore: Official Master Plan & Fare Matrix", url: "https://www.lta.gov.sg/" },
    { title: "National Environment Agency: Hawker Centres and Public Health Standards", url: "https://www.nea.gov.sg/" }
  ]
};

const singaporeBuilt = writeCanonicalArticleModule("travel", "singapore.js", singaporeConfig);
console.log(`[Singapore] Word count: ${singaporeBuilt.wordCount}`);
