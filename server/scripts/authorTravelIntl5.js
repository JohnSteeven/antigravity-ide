...
preloadExistingArticles(["life", "reflections", "lessons", "experiences", "travel"], "malaysia-west-coast-and-peninsula");

console.log("Authoring Travel International 5/15: Malaysia: West Coast and Peninsula...");

const malaysiaSections = [
  {
    heading: "Geography of the Malacca Strait: The Malay Peninsula & Titiwangsa Ridge",
    callout: {
      type: "note",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "The premier transit link into the capital is the non-stop KLIA Ekspres train. Departing every fifteen to twenty minutes from the subterranean train platforms inside both Terminal 1 and Terminal 2, the sleek train whisks passengers directly to KL Sentral transport hub in the heart of downtown Kuala Lumpur in precisely twenty-eight minutes (thirty-three minutes from Terminal 2). One-way adult tickets cost fifty-five MYR (approximately ₹1,050 INR), featuring free high-speed Wi-Fi, air-conditioned luggage compartments, and digital departure display screens. Alternatively, airport express buses (Aerobus and SkyBus) depart round-the-clock from both terminals to KL Sentral, taking sixty minutes for fifteen MYR (approximately ₹285 INR)."
    ],
    table: {
      headers: ["Flight Route & Origin Hub", "Primary Airlines Operating", "Flight Duration & Type", "Arrival Terminal Code", "Round-Trip Economy Fare (INR)"],
      rows: [
        ["Chennai (MAA) to Kuala Lumpur (KUL)", "Malaysia Airlines, AirAsia, IndiGo", "3h 45m (Nonstop Flight)", "KUL (Terminal 1 / 2)", "₹16,500 - ₹24,000"],
        ["Tiruchirappalli (TRZ) to Kuala Lumpur", "AirAsia, Batik Air Malaysia", "4h 00m (Nonstop Flight)", "KUL (Terminal 2)", "₹15,000 - ₹21,500"],
        ["Mumbai (BOM) to Kuala Lumpur (KUL)", "Malaysia Airlines, Batik Air, Air India", "5h 05m (Nonstop Flight)", "KUL (Terminal 1 / 2)", "₹19,500 - ₹29,000"],
        ["New Delhi (DEL) to Kuala Lumpur (KUL)", "Malaysia Airlines, AirAsia, Air India", "5h 25m (Nonstop Flight)", "KUL (Terminal 1 / 2)", "₹21,000 - ₹31,500"],
        ["Kochi (COK) to Kuala Lumpur (KUL)", "AirAsia, Malaysia Airlines", "4h 10m (Nonstop Flight)", "KUL (Terminal 1 / 2)", "₹17,000 - ₹25,000"]
      ]
    }
  },
  {
    heading: "Malaysian Visa Framework for Indian Citizens: Visa-Free Entry & MDAC Protocols",
    callout: {
      type: "important",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Langkawi also offers pristine white-sand swimming beaches along Tanjung Rhu—where ancient limestone sea stacks emerge dramatically from turquoise shallows—and Pantai Cenang, the bustling center of beachfront water sports, boutique resorts, and seafood dining."
    ]
  },
  {
    heading: "Culinary Ecosystem & Indian Dietary Navigation Across the Peninsula",
    paragraphs: [
      ...
      "For authentic South Indian cuisine, visit Brickfields (Kuala Lumpur's vibrant Little India) or the historic Little India of George Town along Penang Street. Here, traditional restaurants such as Vishal Food & Catering, Sri Nirwana Maju, and Saravanaa Bhavan serve legendary Banana Leaf Rice meals: a fresh emerald banana leaf spread before you, topped with mounds of fragrant steamed rice, three vegetable curries, crispy papadams, rasam, and rich sambar, traditionally eaten by hand.",
      "Navigating dietary restrictions is straightforward. Muslim travelers will find that virtually all Malay and Mamak restaurants are strictly Halal-certified by JAKIM (Department of Islamic Development Malaysia). For Hindu, Buddhist, and Jain vegetarians, Indian restaurants in Little India and Chinese vegetarian restaurants (displaying the character '素' - Su) provide extensive menus free of meat and seafood, with Jain options readily prepared upon request without root vegetables.",
      "Adventurous eaters should not leave without tasting Nasi Lemak, universally revered as Malaysia's national dish: fragrant basmati or long-grain rice cooked in rich coconut milk and aromatic pandan leaves, served with fiery sambal chili paste, roasted peanuts, crispy fried anchovies (ikan bilis), cucumber slices, and a hard-boiled or fried egg, wrapped traditionally in a folded fresh banana leaf pyramid."
    ],
    table: {
      headers: ["Dish / Culinary Experience", "Cultural Tradition & Flavor Profile", "Ideal Region / Street", "Dietary Profile", "Typical Price (MYR / INR)"],
      rows: [
        ["Roti Canai & Teh Tarik", "Mamak: Flaky flatbread with dhal gravy & pulled sweet tea", "Mamak stalls across KL & Penang", "Vegetarian (Dhal gravy)", "4.00 - 8.00 MYR (₹75 - ₹150)"],
        ["Banana Leaf Rice Thali", "South Indian: Steamed rice, 3 vegetable curries, rasam, papadam", "Brickfields (KL) / Little India (Penang)", "Pure Vegetarian / Vegan", "10.00 - 18.00 MYR (₹190 - ₹340)"],
        ["Nasi Lemak Traditional", "Malay: Coconut pandan rice, spicy sambal, peanuts, egg", "Village Roadshow / Street stalls nationwide", "Veg or Non-Veg options", "4.00 - 12.00 MYR (₹75 - ₹230)"],
        ["Penang Char Kway Teow", "Chinese: Flat rice noodles wok-fried with chili, prawns, cockles", "Lorong Selamat / Siam Road (Penang)", "Non-Vegetarian / Seafood", "8.00 - 15.00 MYR (₹150 - ₹285)"],
        ["Ipoh White Coffee & Kaya Toast", "Kopitiam: Margarine-roasted coffee with coconut jam toast", "Old Town Ipoh (Sin Yoon Loong)", "Vegetarian", "5.00 - 9.00 MYR (₹95 - ₹170)"]
      ]
    }
  },
  {
    ...
    paragraphs: [
      "Because Peninsular Malaysia lies between one and seven degrees north of the Equator, it experiences a perennial tropical maritime climate characterized by warm temperatures and regular precipitation. However, understanding regional monsoon variations is key to planning an optimal overland itinerary.",
      "The West Coast of the peninsula—encompassing Kuala Lumpur, Malacca, Ipoh, Penang, and Langkawi—is sheltered from the severe open-ocean monsoons by the massive landmass of Sumatra to the southwest and the central Titiwangsa mountain range to the northeast. Consequently, the West Coast can be visited comfortably year-round without the severe seasonal shutdowns experienced on the east coast of Malaysia.",
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ["Day 1: Modern Kuala Lumpur", "KUL Airport arrival via KLIA Ekspres", "Petronas Twin Towers Skybridge & KLCC Park", "Bukit Bintang shopping & Mamak dinner", "KLIA Ekspres & LRT Kelana Jaya Line"],
        ["Day 2: Sacred Caves & Civic", "Batu Caves 272 rainbow steps & Murugan", "Merdeka Square & Sultan Abdul Samad", "Brickfields Little India banana leaf dinner", "KTM Komuter & MRT Kajang Line"],
        ["Day 3: UNESCO Malacca", "Express drive to Malacca & Dutch Square", "A Famosa, St. Paul's Hill & Jonker Street", "Melaka River heritage cruise & return to KL", "Private AC Car / Express Bus (E2 Expressway)"],
        ["Day 4: Ipoh Karst Heritage", "KTM ETS high-speed train to Ipoh", "Perak Tong limestone cave temple murals", "Ipoh Old Town heritage walk & white coffee", "KTM ETS Train & Grab Car"],
        ["Day 5: Cameron Highlands", "Scenic mountain drive to Cameron Highlands", "BOH Sungei Palas Tea Estate & factory tour", "Mossy Forest boardwalk & cozy fireside tea", "Private Mountain Transfer"],
        ["Day 6: Penang Island Core", "Cross Penang Bridge & George Town arrival", "UNESCO street art trail (Armenian Street)", "Chew Jetty stilt village & street hawkers", "Private Car & On-Foot Walking"],
        ["Day 7: Penang Hill & Temples", "Street of Harmony & Pinang Peranakan Mansion", "Penang Hill Funicular & The Habitat canopy", "Summit sunset dinner overlooking island", "Funicular Rail & Grab Car"],
        ["Day 8: Departure to India", "Chowrasta Market artisanal souvenirs", "Penang Airport (PEN) domestic flight to KUL", "Connect to international return flight to India", "Airport Transfer & Flight"]
      ]
    }
  },
  {
    heading: "Cultural Decorum, Religious Etiquette & Malaysian Civic Harmony",
    callout: {
      type: "important",
...
const malaysiaBlocks = assembleStructuredBlocks(malaysiaSections, malaysiaInlineImages);
...
const malaysiaConfig = {
  ...
  structuredBlocks: malaysiaBlocks,
  tags: ["malaysia", "kuala-lumpur", "penang", "george-town", "malacca", "international-travel", "southeast-asia", "batu-caves", "cameron-highlands"],
  travelVerification: {
    ...
    officialSources: [
      { title: "Tourism Malaysia (Official Portal)", url: "https://www.malaysia.travel/" },
      { title: "Immigration Department of Malaysia (MDAC Portal)", url: "https://imigresen-online.imi.gov.my/" },
      { title: "Keretapi Tanah Melayu Berhad (KTMB Official Rail)", url: "https://www.ktmb.com.my/" }
    ],
  ...
  references: [
    { title: "A History of Malaysia (Barbara Watson Andaya & Leonard Y. Andaya)", url: "https://www.palgrave.com/" },
    { title: "The Golden Chersonese and the Way Thither (Isabella L. Bird)", url: "https://www.gutenberg.org/" },
    { title: "Keretapi Tanah Melayu Berhad: Official ETS Schedule & Route Network", url: "https://www.ktmb.com.my/" },
    { title: "Department of Wildlife and National Parks Peninsular Malaysia (PERHILITAN)", url: "https://www.wildlife.gov.my/" }
  ]
};

const malaysiaBuilt = writeCanonicalArticleModule("travel", "malaysia-west-coast-and-peninsula.js", malaysiaConfig);
console.log(`[Malaysia: West Coast and Peninsula] Word count: ${malaysiaBuilt.wordCount}`);
