...
preloadExistingArticles(["life", "reflections", "lessons", "experiences", "travel"], "sri-lanka-the-southern-coast-and-hill-country");

console.log("Authoring Travel International 7/15: Sri Lanka: The Southern Coast and Hill Country...");

const sriLankaSections = [
  {
    heading: "Island Topography & Central Highland Massif: The Teardrop of Serendib",
    callout: {
      type: "note",
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ["Chennai (MAA) to Colombo (CMB)", "SriLankan Airlines, IndiGo", "1h 15m (Nonstop Flight)", "CMB (Bandaranaike Int'l)", "₹11,500 - ₹16,500"],
        ["Bengaluru (BLR) to Colombo (CMB)", "SriLankan Airlines, IndiGo", "1h 30m (Nonstop Flight)", "CMB (Bandaranaike Int'l)", "₹12,500 - ₹18,000"],
        ["Kochi (COK) to Colombo (CMB)", "SriLankan Airlines, IndiGo", "1h 20m (Nonstop Flight)", "CMB (Bandaranaike Int'l)", "₹12,000 - ₹17,500"],
        ["Mumbai (BOM) to Colombo (CMB)", "SriLankan Airlines, Air India, IndiGo", "2h 35m (Nonstop Flight)", "CMB (Bandaranaike Int'l)", "₹16,000 - ₹23,500"],
        ["New Delhi (DEL) to Colombo (CMB)", "SriLankan Airlines, Air India", "3h 30m (Nonstop Flight)", "CMB (Bandaranaike Int'l)", "₹18,500 - ₹27,000"]
      ]
    }
  },
  {
    heading: "Sri Lanka Visa Framework for Indian Passport Holders: ETA & Visa-Free Initiatives",
    callout: {
      type: "important",
    ...
    paragraphs: [
      "Entering Sri Lanka on an ordinary Indian passport requires utilizing the official Electronic Travel Authorization (ETA) system administered by the Department of Immigration and Emigration (DI&E). Under strategic tourism promotion initiatives, Indian passport holders have been included in official pilot programs granting free-of-charge tourist visas, waiving standard consular processing fees.",
      "Travelers must apply online prior to travel through the official government portal (eta.gov.lk). The tourist ETA is granted for an initial stay of up to thirty days with double-entry privileges, valid for entry within three months from the date of approval. The online application is straightforward, requiring basic biographical data, passport details, travel itinerary, and email address, with electronic approvals typically delivered within twenty-four to forty-eight hours.",
      "Mandatory entry documentation includes an original Indian passport with at least six months of remaining validity from the date of arrival and at least two blank visa endorsement pages, a confirmed round-trip or onward flight ticket departing Sri Lanka within thirty days, and confirmed hotel bookings or proof of sufficient financial funds (credit cards or physical currency) for the duration of the visit.",
      "All incoming passengers must complete the online Sri Lanka Electronic Arrival Card within three days prior to arrival via the official immigration website (eservices.immigration.gov.lk), generating a digital QR code that streamlines border clearance upon landing at Bandaranaike Airport. Travelers can also extend their 30-day tourist visa up to two hundred and seventy days online through the Department of Immigration e-services portal."
    ]
  },
  {
    heading: "Financial Mechanics: Sri Lankan Rupee, Cash Management & Zero-Forex Cards",
    paragraphs: [
      "The official legal tender of the country is the Sri Lankan Rupee (ISO currency code: LKR; symbol: Rs or රු), subdivided into 100 cents. For Indian travelers, the exchange rate typically fluctuates in the range of 100 LKR equal to approximately 27 to 29 Indian Rupees (INR) (meaning 1,000 LKR is roughly ₹270 to ₹290 INR). Banknotes circulate in denominations of 20, 50, 100, 500, 1,000, and 5,000 rupees, featuring portraits of national heritage monuments, native birds, and traditional dancers on the reverse.",
      "Physical cash is widely required when traveling outside Colombo and luxury resorts. Local tuk-tuks, village roadside fruit stalls selling king coconuts (thambili), local tea shops, rural guesthouses, and national park safari jeep drivers operate strictly on physical cash. Automated Teller Machines (ATMs) operated by reputable commercial banks—such as Commercial Bank of Ceylon, Hatton National Bank (HNB), and Sampath Bank—are widespread across all regional towns, dispensing cash with standard international network transaction fees.",
      "For hotel bookings, boutique villa stays, fine dining, and tea factory purchases, international credit and debit cards (Visa and Mastercard) are universally accepted. Indian travelers utilizing zero-forex debit or credit cards (such as Niyo Global, Scapia, or Fi Money) avoid standard 3.5% foreign exchange markups, deducting transactions directly at live interbank exchange rates.",
      "For local urban mobility in Colombo, Kandy, and Galle, download the PickMe mobile application (Sri Lanka's premier homegrown ride-hailing app) and Grab. PickMe allows transparent on-demand booking of three-wheelers (metered tuk-tuks), economy sedans, and vans with upfront fare calculation and digital card payment, eliminating contentious fare haggling with street drivers.",
      "Tipping is customary and deeply appreciated across the Sri Lankan hospitality industry. In restaurants where a 10% service charge is already included on the bill, leaving an additional five to ten percent tip in cash for service staff is standard practice; for safari trackers and private chauffeurs, a daily tip of 1,500 to 3,000 LKR (₹400 to ₹850 INR) reflects respectful recognition of excellent service."
    ],
    table: {
      headers: ["Expenditure Category", "Budget Backpacker (INR / Day)", "Mid-Tier Explorer (INR / Day)", "Luxury Colonial (INR / Day)", "Key Operational Context"],
      rows: [
        ["Guesthouse / Villa Stay", "₹1,800 - ₹3,200 (Clean guesthouse)", "₹5,500 - ₹11,000 (Colonial boutique)", "₹22,000 - ₹55,000+ (5-star tea bungalow)", "Comfortable homestay vs Galle fort boutique vs luxury tea estate"],
        ["Daily Meals & Fresh Seafood", "₹700 - ₹1,400 (Rice & curry warung)", "₹1,800 - ₹3,800 (Heritage cafes/bistros)", "₹6,500 - ₹16,000 (Fine dining seafood)", "Local hoppers & dhal vs beachfront seafood vs colonial dining"],
        ["Scenic Rail & Chauffeur", "₹450 - ₹900 (Main Line train / bus)", "₹2,500 - ₹4,500 (Dedicated private driver)", "₹6,500 - ₹14,000 (Luxury SUV private hire)", "2nd class train vs private chauffeured AC car throughout"],
        ["Safaris & Park Admissions", "₹1,500 - ₹3,000 (Temple tickets)", "₹4,500 - ₹9,500 (Yala safari & jeep)", "₹15,000 - ₹32,000 (Private wildlife specialist)", "Standard entry tickets vs shared jeep vs private expert naturalist"],
        ["Estimated Daily Total", "₹4,450 - ₹8,500 per person", "₹14,300 - ₹28,800 per person", "₹50,000 - ₹117,000 per person", "Excludes international flights from India and personal shopping"]
      ]
    }
  },
  {
    heading: "The Legendary Mountain Railway: The Blue Train Through the Central Highlands",
    callout: {
      type: "tip",
  ...
  },
  {
    ...
    paragraphs: [
      "The southern coastline of Sri Lanka, stretching between Galle and Matara, is a tropical paradise of golden sand bays, fringing coral reefs, and ancient maritime traditions. Along the beaches of Ahangama, Koggala, and Kathaluwa, travelers can observe one of the most distinctive artisanal fishing methods on earth: Stilt Fishing (Ritipanna).",
      "Invented during severe food shortages in World War II when crowded coastal rocks were inaccessible, fishermen erect a single wooden pole (riti) embedded deep into the coastal coral seabed, equipped with a crossbar (peta) on which the fisherman balances perched several feet above the crashing surf. With infinite patience, using a slender bamboo rod and thread with zero bait, the fishermen mimic the movement of tiny marine crustaceans, catching spotted herrings and small mackerels in the churning whitewash.",
      "Further east lies the sweeping crescent of Weligama Bay ('Sandy Village'), a world-renowned haven for beginner and intermediate surfers. Sheltered from rough ocean currents, the shallow sandy-bottom bay offers gentle, peeling waves perfect for learning to surf, lined with surf camps and beachfront cafes.",
      "Adjacent lies the coastal promontory of Mirissa, famous for its vibrant beachfront seafood restaurants and deep-water marine biodiversity. Just six to ten nautical miles off the coast of Mirissa, the continental shelf drops precipitously into a deep underwater oceanic canyon where nutrient-rich upwelling currents draw the largest creature ever to exist on earth: the Blue Whale (Balaenoptera musculus). Between November and April, travelers aboard licensed eco-cruises can observe these magnificent leviathans—reaching up to thirty meters in length—surfacing to breathe in colossal plumes of spray before raising their massive tail flukes into the sky in a deep dive, accompanied by pods of playful spinner dolphins and sperm whales.",
      "Along the coast in Kosgoda, non-profit community sea turtle conservation projects patrol beaches to rescue vulnerable turtle eggs from poachers, releasing thousands of hatched baby Green, Olive Ridley, and Hawksbill turtles safely into the open ocean under cover of night."
    ]
  },
  {
    heading: "The Hill Country: Nuwara Eliya, Colonial Tea Estates & Highland Cool",
    paragraphs: [
      "Ascending into the central highlands to an elevation of 1,868 meters brings travelers to Nuwara Eliya—historically christened 'Little England' by British colonial settlers. Founded in 1846 by explorer Sir Samuel Baker, the town was developed as an exclusive hill station where British planters and civil servants could hunt, play golf, and fish for introduced brown trout in a climate reminiscent of an English spring.",
      "The town retains an extraordinary collection of Victorian and Edwardian architecture: the red-brick Nuwara Eliya Post Office, built in 1894 with a Tudor-style timbered clock tower; the Hill Club, an exclusive gentlemen's club established in 1876 with mounted hunting trophies and a formal jacket-and-tie dinner dress code; and The Grand Hotel, a palatial Elizabethan manor surrounded by manicured rose gardens and century-old cypress trees, famous for its daily traditional afternoon high tea.",
      "Surrounding the town are world-renowned Ceylon tea estates contouring the misty hills. Foremost among them is the Pedro Tea Estate, situated at the base of Mount Pedro. Here, travelers walk among rows of dark green Camellia sinensis bushes, observing skilled female tea pluckers deftly harvesting only the 'two leaves and a bud' into woven wicker baskets on their backs.",
  ...
  {
    heading: "Ella Mountain Pass: Nine Arches Bridge, Peak Treks & The Ramayana Trail",
    callout: {
      type: "note",
    ...
    paragraphs: [
      "Perched on the southern edge of the central highlands at 1,041 meters elevation, the mountain village of Ella has evolved into Sri Lanka's capital of hiking, nature photography, and relaxed mountain living. Situated directly within Ella Gap—a dramatic natural cleft in the mountain wall—the village looks out over sweeping southern plains stretching hundreds of kilometers toward the sea.",
      "For trekking enthusiasts, the ascent of Little Adam's Peak (Mini Sri Pada) is an accessible, invigorating forty-five-minute walk along gentle stone pathways winding through lush tea plantations to reach a panoramic mountain ridge. At the summit, hikers are rewarded with jaw-dropping vistas across the deep canyon to the sheer vertical rock cliff of Ella Rock.",
      "For a more strenuous adventure, hiking to the summit of Ella Rock leads through eucalyptus groves, across railway tracks, and up steep jungle switchbacks to stand atop a sheer stone precipice overlooking the entire southern expanse of the island.",
      "Ella is deeply interwoven with the epic narrative of the Ramayana. According to regional legend, it was in these rugged forested valleys that King Ravana of Lanka held Queen Sita captive following her abduction from India. Six kilometers outside town lies the Ravana Falls, an impressive 25-meter cascade tumbling over jagged limestone ledges. High on the cliff above sits Ravana's Cave and the subterranean tunnel network believed in local lore to have connected Ravana's mountain fortress with coastal outposts.",
      "Nearby in Sita Eliya, on the mountain road between Nuwara Eliya and Ella, stands the Seetha Amman Temple. Built beside a rushing mountain stream where Queen Sita is said to have bathed and prayed for rescue by Lord Rama, this colorful Hindu temple features prominent footprints embedded in the rock face, attributed in local faith to the monkey god Hanuman, drawing spiritual pilgrims from across India."
    ]
  },
  {
    heading: "Sinharaja Forest Reserve: Primary Rainforests & Endemic Avian Flocks",
    callout: {
      type: "note",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Bawa's revolutionary architectural principles—characterized by sweeping overhanging terracotta tile roofs, open-air interior courtyards (meda midula), reflective water moats, and the use of local granite, terracotta, and reclaimed timber—are exemplified in his monumental public works: the Parliament of Sri Lanka at Sri Jayawardenepura Kotte, built upon an artificial lake; the dramatic Heritance Kandalama hotel, carved into a rock cliff face in the dry zone; and boutique coastal resorts along the southern shore.",
  ...
  {
    heading: "Gemstone Heritage: Ratnapura, Ceylon Blue Sapphires & Artisanal Mining",
    callout: {
      type: "note",
  ...
  },
  {
    ...
    paragraphs: [
      "Sri Lanka is one of the world's premier biodiversity hotspots, boasting an astonishing density of large megafauna within compact national parks situated just hours from coastal beaches.",
  ...
  },
  {
    ...
    table: {
      headers: ["Dish / Culinary Experience", "Key Ingredients & Flavor Profile", "Ideal Region / Spot", "Dietary Profile", "Typical Price (LKR / INR)"],
      rows: [
        ["Egg Hopper & Pol Sambol", "Rice flour bowl, steamed egg, fiery coconut chili relish", "Street stalls & cafes nationwide", "Vegetarian (Contains egg)", "80 - 150 LKR (₹22 - ₹42)"],
        ["Traditional Rice & 5 Curries", "Red rice, jackfruit, dhal, pumpkin curry, pol sambol", "Local roadside curry warungs", "Pure Vegetarian / Vegan", "350 - 650 LKR (₹95 - ₹180)"],
        ["Vegetable Kottu Roti", "Chopped roti, cabbage, leeks, onions, spiced curry gravy", "Evening street stalls / Hotel de Pilawoos", "Vegetarian upon request", "450 - 800 LKR (₹125 - ₹225)"],
        ["Ceylon Black Tea & Fresh Scone", "Single-estate high-grown BOP tea, clotted cream, jam", "The Grand Hotel (Nuwara Eliya)", "Vegetarian", "1,800 - 3,500 LKR (₹490 - ₹960)"],
        ["Mirissa Beach Grilled Fish", "Catch of the day grilled with garlic, lime, and chips", "Mirissa beachfront restaurants", "Pescatarian / Seafood", "2,500 - 4,500 LKR (₹690 - ₹1,240)"]
      ]
    }
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Day 5: The Iconic Blue Train to Nuwara Eliya. Board the famous Sri Lanka Railways Main Line train from Ella to Nanu Oya station (3 hours). Travel through rolling carpets of emerald tea plantations and mountain tunnels. Transfer to Nuwara Eliya ('Little England'). Tour the historic Pedro Tea Estate to learn about orthodox Ceylon tea manufacturing. Enjoy traditional high tea at The Grand Hotel and stroll around Gregory Lake.",
      "Day 6: Misty Horton Plains to Sacred Kandy. Early morning excursion to Horton Plains National Park, walking the 9-kilometer loop to peer over the 870-meter precipice of World's End. In the afternoon, descend the scenic mountain road past Ramboda Falls to the royal capital of Kandy. In the evening, attend the sacred evening drum offering ceremony (Theva) at the Temple of the Sacred Tooth Relic (Sri Dalada Maligawa).",
      "Day 7: Kandy Royal Gardens & Cultural Heritage. Morning exploration of the Royal Botanic Gardens at Peradeniya, strolling among giant Javan fig trees, royal palm avenues, and the orchid pavilion. Visit an artisanal Kandyan gemstone workshop. In the afternoon, enjoy a scenic drive around Kandy Lake and visit the Bahirawakanda Vihara Buddha statue overlooking the valley. Evening traditional Kandyan cultural dance performance.",
      "Day 8: Transfer to Colombo, Souvenirs & Departure to India. Travel down from Kandy to Colombo. Explore the historic colonial Fort and Pettah spice markets, or purchase high-grade Ceylon single-estate tea and handmade souvenirs at Barefoot or Odel. Transfer to Bandaranaike International Airport (CMB) for your evening flight home to India."
    ],
    table: {
      headers: ["Day & Geographic Zone", "Morning Exploration (08:00 - 12:30)", "Afternoon Phase (13:30 - 17:30)", "Evening Program (18:30 - 22:00)", "Transit Logistics"],
      rows: [
        ["Day 1: Galle Colonial Fort", "Airport arrival via e-Visa & Southern Expressway", "Galle Fort walking tour & Dutch Church", "Sunset on Flag Rock Bastion & Fort dinner", "Private AC Chauffeur Car (E01 Highway)"],
        ["Day 2: Southern Coast Marine", "Dawn Mirissa Blue Whale watching cruise", "Ahangama stilt fishermen & Weligama bay", "Beachfront seafood dinner on Mirissa sand", "Private AC Car / Coastal tuk-tuk"],
        ["Day 3: Yala Wilderness", "Drive east past Tangalle to Yala eco-lodge", "Afternoon Yala Block 1 leopard & elephant safari", "Campfire dinner under tropical stars", "4x4 Safari Jeep & Chauffeur"],
        ["Day 4: Highland Ella Pass", "Ascend mountain road & visit Ravana Falls", "Nine Arches Demodara stone bridge walk", "Little Adam's Peak summit hike & sunset", "Private Mountain Car Transfer"],
        ["Day 5: The Blue Train", "Board scenic Main Line Blue Train to Nanu Oya", "Pedro Tea Estate factory tour & tasting", "Grand Hotel Victorian high tea & garden stroll", "Sri Lanka Railways Main Line Train"],
        ["Day 6: World's End & Kandy", "Horton Plains National Park World's End hike", "Mountain drive past Ramboda Falls to Kandy", "Temple of the Sacred Tooth drum ceremony", "Private AC Car / Walking"],
        ["Day 7: Royal Kandy", "Royal Botanic Gardens of Peradeniya orchids", "Kandy Lake walk & gemstone lapidary", "Kandyan cultural dance show & dinner", "Private Car & On-Foot"],
        ["Day 8: Colombo to India", "Drive to Colombo & Pettah market spice shopping", "Barefoot artisanal handicrafts & tea purchase", "Bandaranaike Airport return flight to India", "Private Car & International Flight"]
      ]
    }
  },
  {
    heading: "Buddhist Decorum, Cultural Etiquette & Ramayana Trails",
    callout: {
      type: "important",
    ...
    paragraphs: [
      "Sri Lanka is a deeply spiritual nation where over seventy percent of the population practices Theravada Buddhism, alongside vibrant Hindu, Muslim, and Christian communities. Respecting religious codes and cultural sensitivities ensures travelers are received with boundless warmth and hospitality.",
      "Temple Etiquette: When visiting any Buddhist temple (vihara) or Hindu kovil, strict dress codes are enforced: clothing must cover shoulders and knees completely; white attire is traditional and highly appreciated when visiting Buddhist sanctuaries; footwear, hats, and sunglasses must be removed before entering the temple compound.",
      "Never pose for photographs with your back turned directly toward a Buddha image—this is considered a grave sign of disrespect, as you are turning your back on the enlightened one. Always face the statue respectfully or step aside. Furthermore, never touch, sit on, or point your feet toward any sacred Buddha statue or monastic altar.",
      ...
      "In daily interactions: avoid public displays of intense anger or loud arguments, as emotional self-control is cherished; greet locals with pressed palms and the traditional greeting 'Ayubowan' (Sinhalese: 'May you live long') or 'Vanakkam' (Tamil); and use your right hand when giving or receiving money and food."
    ]
  },
  {
    heading: "Environmental Stewardship & Post-Crisis Community Regeneration",
    paragraphs: [
      "Following severe economic challenges and external shocks in recent years, Sri Lanka's tourism industry has emerged as a vital lifeline for millions of working families, artisans, and conservation initiatives across the island. Conscientious travelers can directly support equitable, sustainable community regeneration throughout their journey.",
      "Choose locally owned, community-based enterprises: patronize family-run guesthouses and homestays; dine at neighborhood rice-and-curry warungs; purchase single-origin tea directly from certified smallholder tea cooperatives; and hire licensed local village guides and tuk-tuk drivers rather than booking through multi-tiered international aggregators.",
      "In fragile marine and highland ecosystems, practice uncompromising environmental ethics: never purchase souvenirs made from sea turtle shells, coral, elephant ivory, or protected wild woods; support plastic-free travel by utilizing filtered water refill stations provided at eco-lodges; and maintain strict Leave No Trace standards when hiking in Horton Plains, Sinharaja, and Knuckles Mountain Range.",
      "By traveling through Sri Lanka with cultural empathy, ecological mindfulness, and generous human connection, you will discover an island of boundless resilience, magnificent landscapes, and an enduring warmth that lingers in the memory long after your return."
    ]
  }
];

const sriLankaInlineImages = [
  {
...
const sriLankaBlocks = assembleStructuredBlocks(sriLankaSections, sriLankaInlineImages);

const sriLankaConfig = {
  ...
  structuredBlocks: sriLankaBlocks,
  tags: ["sri-lanka", "galle", "ella", "kandy", "nuwara-eliya", "yala", "international-travel", "scenic-train", "ceylon-tea"],
  travelVerification: {
    ...
    officialSources: [
      { title: "Sri Lanka Tourism Development Authority (SLTDA)", url: "https://www.srilanka.travel/" },
      { title: "Department of Immigration and Emigration Sri Lanka (ETA Portal)", url: "https://www.eta.gov.lk/" },
      { title: "Sri Lanka Railways (Official Passenger Ticketing)", url: "https://railway.gov.lk/" }
    ],
  ...
  references: [
    { title: "A History of Sri Lanka (K.M. de Silva)", url: "https://www.penguin.co.in/" },
    { title: "An Account of the Island of Ceylon (Robert Percival)", url: "https://www.gutenberg.org/" },
    { title: "Sri Lanka Railways Official Schedule and Main Line Route Network", url: "https://railway.gov.lk/" },
    { title: "Department of Wildlife Conservation Sri Lanka: National Parks & Wildlife Guidelines", url: "https://www.dwc.gov.lk/" }
  ]
};

const sriLankaBuilt = writeCanonicalArticleModule("travel", "sri-lanka-the-southern-coast-and-hill-country.js", sriLankaConfig);
console.log(`[Sri Lanka: The Southern Coast and Hill Country] Word count: ${sriLankaBuilt.wordCount}`);
