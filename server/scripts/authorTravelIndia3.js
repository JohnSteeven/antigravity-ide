...
console.log("Authoring Travel India 3/20: Ooty and the Nilgiri Hills...");

const ootySections = [
  {
    heading: "Montane Topography, Shola-Grassland Ecology & Seasonal Timing",
    callout: {
      type: "note",
    ...
    paragraphs: [
      "Rising dramatically above the hot plains of Tamil Nadu, Karnataka, and Kerala, the Nilgiri plateau forms one of the most ecologically spectacular montane massifs on the Indian subcontinent. Meaning the 'Blue Mountains' in Sanskrit and classical Tamil—derived either from the blue haze of eucalyptus and moisture vapors that blanket the valleys or the synchronized twelve-year mass blooming of the wild Kurinji flower (Strobilanthes kunthiana)—the Nilgiris culminate in Doddabetta Peak at 2,637 meters, the highest point in South India outside the Anamudi range.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "The Tamil Nadu State Transport Corporation (TNSTC) operates frequent ultra-deluxe and point-to-point hill buses linking Coimbatore, Mettupalayam, Mysuru, and Kozhikode to Ooty and Coonoor bus stands, providing safe, experienced mountain driving for fares between ₹90 and ₹180."
    ],
    table: {
      headers: ["Transit Route / Service", "Frequency & Timings", "Station / Route Code", "Travel Duration", "Typical INR Tariff"],
      rows: [
        ["Nilgiri Mountain Railway (Steam Ascent)", "Daily 07:10 departure from MTP", "MTP -> UAM (Train 56136)", "4h 50m (46 km)", "₹205 (FC) / ₹30 (2S)"],
        ["Coimbatore Airport to Ooty Private Taxi", "24/7 on-demand pre-booked cab", "CJB -> Ooty (via Kallar)", "3h 15m (88 km)", "₹2,600 - ₹3,400"],
        ["Coimbatore Junction - Shatabdi Express (12243)", "6 days/week ex-Chennai Central", "MAS -> CBE", "7h 10m", "₹1,180 (CC) / ₹2,150 (EC)"],
        ["KSR Bengaluru to Ooty KSRTC Airavat AC Bus", "Nightly departure 22:30 via Mysore", "Bengaluru -> Ooty Bus Stand", "8h 00m (280 km)", "₹850 - ₹1,150"],
        ["Coonoor to Ooty Diesel Mountain Rail Shuttle", "4 departures daily in both directions", "ONR -> UAM (NMR Shuttle)", "1h 10m (19 km)", "₹140 (FC) / ₹15 (2S)"]
      ]
    }
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Day 5: Doddabetta Summit, Pykara Falls & Pine Forests. Ascend early to Doddabetta Peak (2,637 meters) before morning clouds roll in, taking in panoramic 360-degree vistas stretching across the Nilgiri plateau to the plains of Coimbatore and Mysuru. Descend toward the northwest along the Pykara road, stopping to walk among the towering hundred-foot trunks of the Cairn Hill and Old Pykara pine and cedar plantations. Visit the sacred Toda temple at Muthanad Mund respectfully, followed by a peaceful boat ride across Pykara Lake and a hike down to the roaring Pykara Falls. Enjoy an afternoon heritage cream tea with scones and homemade strawberry jam at a colonial tea room before commencing your mountain descent."
    ],
    table: {
      headers: ["Day & Time Slot", "Highland Sector", "Core Activities & Heritage Sites", "Mobility Mode", "Gastronomic Recommendations"],
      rows: [
        ["Day 1: 07:10 - 14:00", "Mettupalayam to Ooty", "UNESCO Steam train ascent (NMR); St. Stephen's Church", "Mountain Steam Train (NMR)", "Warm Ooty varkey & hot cardamom tea on train"],
        ["Day 1: 15:30 - 18:30", "Ooty Town Ridge", "Government Botanical Gardens; Toda tribal store", "Local auto-rickshaw", "Colonial roasted mutton stew & dinner rolls, Fernhill"],
        ["Day 2: 08:30 - 16:30", "Coonoor Escarpment", "Sim's Park; Dolphin's Nose; Highfield Tea tasting", "NMR Shuttle & hired taxi", "Handmade wood-fired pizza & fresh passion fruit juice"],
        ["Day 3: 07:30 - 16:00", "Kotagiri Highlands", "Catherine Falls hike; Kodanad Moyar canyon view", "Private taxi / car", "Traditional Badaga lunch (Sandhige & Koli Kari)"],
        ["Day 4: 06:30 - 15:00", "Avalanche / Emerald", "Emerald Lake; Avalanche Shola eco-safari; trout waters", "Forest Dept Safari bus", "Packed organic picnic with local artisanal Nilgiri cheese"],
        ["Day 5: 08:00 - 16:00", "Doddabetta & Pykara", "Doddabetta summit; Toda Muthanad Mund; Pykara Falls", "Private car via NH-181", "Highland afternoon tea with fresh scones & strawberry jam"]
      ]
    }
  },
  {
    ...
    table: {
      ...
      rows: [
        ["Budget (Solo)", "₹1,200 - ₹1,800 (Hill homestay / lodge)", "₹500 - ₹800 (Vegetarian messes, bakeries)", "₹250 - ₹450 (TNSTC buses, shared jeeps)", "₹300 - ₹500 (Botanical gardens, NMR rail)", "₹2,250 - ₹3,550 per day"],
        ["Mid-Range (Couple)", "₹4,500 - ₹8,500 (Heritage colonial cottage)", "₹1,800 - ₹3,200 (Tea estate cafes, bistros)", "₹1,200 - ₹2,000 (Rented scooter / auto hire)", "₹1,000 - ₹2,000 (Tea cupping, Avalanche safari)", "₹8,500 - ₹15,700 per day"],
        ["Luxury (Couple)", "₹20,000 - ₹42,000 (Maharaja palace suite)", "₹4,500 - ₹8,500 (Fine dining colonial feasts)", "₹3,500 - ₹5,500 (Private chauffeured Innova)", "₹2,500 - ₹5,000 (Private naturalist, tea tasting)", "₹30,500 - ₹61,000 per day"]
      ]
    }
  },
  {
    heading: "Monsoon Patterns, Landslide Dynamics & Highland Cold Hazards",
    callout: {
      type: "warning",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Nilgiri Tea is world-renowned among connoisseurs as the 'fragrant one.' Grown at elevations ranging from 1,200 to over 2,400 meters, Nilgiri teas combine the briskness of Ceylon teas with the floral, fragrant aromatics of high-grown Darjeelings. The premier flush is the 'Winter Frost Tea,' harvested between December and February when freezing night temperatures stress the tea bushes, causing them to concentrate their natural essential oils into an exquisitely bright, golden cup with distinct citrus and passion-fruit notes.",
      "Colonial baking heritage is preserved in Ooty's legendary bakeries, such as King Star (operating since 1942) and West Coast Bakery. The iconic Ooty Varkey is a crisp, flaky, layered pastry made with flour, ghee or vegetable shortening, sugar, and yeast, baked inside wood-fired brick ovens until deeply golden. Dipped into a steaming glass of spiced Nilgiri milk tea on a cold mountain morning, the crisp varkey melts into a buttery, comforting confection.",
      "The hills are also celebrated for their artisanal homemade chocolates (milk, dark, roasted almond, and rum-raisin fudge) sold throughout Ooty and Coonoor, as well as high-altitude artisan cheeses produced by boutique creameries using milk from pasture-fed Jersey and Holstein cows grazing on mountain grasses."
    ],
    table: {
      headers: ["Iconic Highland Dish", "Cultural Origin", "Key Ingredients & Preparation", "Flavor Character", "Where to Sample"],
      rows: [
        ["Badaga Koli Kari & Mudde", "Indigenous Badaga agrarian", "Country fowl, roasted spices, garlic, finger-millet", "Robust, peppery, deeply savory, rustic warmth", "Traditional Badaga homestays, Kotagiri"],
        ["Nilgiri Winter Frost Tea", "High-Altitude Orthodox Tea", "Hand-plucked clonal tea leaves, high-elevation frost", "Bright, golden liquor, fragrant floral-citrus finish", "Tea estate tasting rooms, Glendale & Highfield"],
        ["Authentic Ooty Varkey", "19th-Century Hill Bakery", "Wheat flour, semolina, shortening, cane sugar, yeast", "Flaky, crisp, buttery layered texture, mildly sweet", "King Star Bakery (Commercial Road, Ooty)"],
        ["Colonial Afternoon High Tea", "British Hill Station Tradition", "Warm butter scones, clotted cream, strawberry jam", "Rich, elegant, buttery sweetness with hot tea", "Savoy Hotel / Fernhills Palace colonial tea rooms"],
        ["Artisanal Nilgiri Gouda & Cheddar", "Pasture Dairy Creamery", "Whole mountain cow milk, natural microbial aging", "Sharp, nutty, creamy, distinct terroir", "Acres Wild Organic Creamery, Coonoor"]
      ]
    }
  },
  {
    heading: "Cultural Protocols, Indigenous Toda Heritage & Sacred Sanctuaries",
    callout: {
      type: "note",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Local taxis are organized under regulated taxi owners' associations with standard fixed-rate cards displayed at Ooty, Coonoor, and Kotagiri taxi stands. Standard four-hour local sightseeing circuits cost ₹1,500 to ₹2,000 for a hatchback, while full-day excursions to Avalanche or Pykara range between ₹2,800 and ₹3,800.",
      "Auto-rickshaws are abundant in Ooty and Coonoor, equipped to climb steep hillside gradients. However, due to hilly terrain and fuel consumption, auto drivers charge slightly above standard plains rates. Agree on the fare before departure or insist on meter-based fares plus hill surcharge.",
      "Renting automatic scooters (Honda Activa) or geared motorcycles is popular among young travelers in Ooty (₹400 to ₹700 per day). However, riders must exercise extreme caution: mountain roads are frequently slick with pine needles, wet moss, and diesel spills from climbing trucks, and night riding is dangerous due to unlit curves, stray cattle, and sudden wildlife crossings."
    ]
  },
  {
    heading: "High-Altitude Hydration, Hypothermia Defense & Mountain Health",
    paragraphs: [
      "While the Nilgiris do not present acute high-altitude sickness hazards (as elevations remain below 2,700 meters), the combination of brisk mountain temperatures, intense high-altitude ultraviolet radiation, and rapid microclimatic shifts requires thoughtful health management.",
      "Hydration is frequently neglected by travelers in cool climates because the sensation of thirst is diminished. However, cool dry mountain air increases respiratory water loss. Dehydration manifests as dull tension headaches and fatigue. Drink at least two to three liters of purified, filtered water daily. In colonial homestays, request warm boiled water or fresh herbal ginger-lemon infusions throughout the day.",
      "Hypothermia is a genuine risk during winter months (December to February) and wet monsoon storms, particularly for travelers caught outdoors without proper rain and wind protection. Wet clothing combined with wind chill at 2,200 meters can rapidly deplete body temperature. Always carry a windproof, waterproof outer shell and change out of damp garments immediately upon returning indoors.",
      "Leeches are prevalent in wet grass and damp Shola undergrowth during the monsoon months (June to November). When walking along forest trails or tea estate paths, wear protective canvas gaiters, tuck trouser cuffs into thick woolen socks, and avoid brushing against wet trailside vegetation.",
  ...
  {
    heading: "Digital Connectivity, UPI Penetration & Highland Remote Work",
    callout: {
      type: "note",
    ...
    paragraphs: [
      "Telecommunications infrastructure across the primary urban corridors of the Nilgiris is modern and reliable. Major telecom providers—Bharti Airtel, Reliance Jio, and BSNL—provide comprehensive 4G LTE and expanding 5G coverage throughout Ooty, Coonoor, Wellington, and Kotagiri.",
      ...
      "For remote professionals and digital nomads, the Nilgiris have become a premier mountain workation haven. High-speed fiber-optic broadband (BSNL Bharat Fibre, Airtel Xstream, and private local fiber operators) delivers dependable 100 Mbps to 300 Mbps symmetric speeds to hundreds of heritage cottages, estate homestays, and boutique hotels in Coonoor and Kotagiri.",
      "When planning an extended workation, verify that your accommodation possesses both high-speed fiber internet and an uninterruptible power supply (UPS) or dedicated diesel generator backup, as mountain storms can occasionally disrupt the main electrical grid for several hours."
    ]
  },
  {
    heading: "Ecological Fragility, Shola Restoration & Plastic Ban Enforcement",
    paragraphs: [
      "The Nilgiris represent one of the most ecologically fragile and bio-diverse landscapes in South Asia, facing severe challenges from historical commercial timber plantations, uncontrolled urban expansion, and heavy tourist vehicular pressure.",
      ...
      "The Nilgiris District Administration enforces one of the strictest plastic bans in the country. The possession, sale, and use of single-use plastic items—including plastic water bottles under five liters, disposable cups, carry bags, and plastic food wrappers—is strictly banned across the entire district. Checkpoints at the foot of all ghat roads (Kallar, Burliar, and Thoraipally) inspect incoming vehicles and confiscate banned plastics.",
      "Travelers must carry reusable stainless-steel or copper water bottles. The district administration has established hundreds of purified drinking water dispensing kiosks (known as 'Amma Kudineer' or municipal water ATMs) at bus stands, tourist viewpoints, and public squares where visitors can refill water bottles for a nominal fee of ₹5 to ₹10.",
      "Practice strict 'Leave No Trace' principles: never discard food packaging or plastic wrappers along mountain trails, stay on designated walking paths to prevent fragile hillside soil erosion, and support organic smallholder tea and vegetable farmers who avoid synthetic chemical pesticides."
    ]
  },
  {
    ...
    paragraphs: [
      "The visual grandeur of the Nilgiris—mist swirling through ancient cedar canopies, sunlight illuminating emerald tea slopes, and dramatic waterfalls plunging into deep canyons—provides magnificent photographic opportunities. However, photographers must operate within strict legal and ethical parameters.",
      "Recreational and commercial drone flying is prohibited across the vast majority of the Nilgiris. The presence of Wellington Military Cantonment (a sensitive defense training zone), the Madras Regimental Centre, and extensive protected wildlife reserves under Project Tiger and Project Elephant makes the airspace a strictly regulated security zone. Flying drones without prior written permissions from the District Collector and Superintendent of Police is illegal.",
      "When photographing wildlife—such as the Nilgiri tahr at Mukurthi, gaur along tea estate fringes, or lion-tailed macaques in the canopy—maintain a respectful distance of at least fifty meters. Never use camera flashes, make loud vocalizations to attract animals, or block wildlife movement corridors along tea roads.",
      "Respect the privacy and cultural dignity of indigenous communities. When visiting Toda munds or Badaga villages, never photograph community members without their warm, explicit consent. Pay a fair fee when purchasing authentic handicrafts rather than treating indigenous elders as decorative photographic subjects."
    ]
  },
  {
    heading: "Packing Matrix: Cold Defense, Mountain Footwear & Field Gear",
    paragraphs: [
      "Packing for the Nilgiris requires preparing for high-altitude chill, sudden mountain showers, rocky walking trails, and pleasant daytime warmth. The following matrix details essential gear for all seasons.",
      "Footwear should include broken-in, water-resistant hiking shoes with deep lugs (Vibram or equivalent) for navigating slippery forest trails, damp grass, and steep tea terraces. For casual strolling through towns and heritage hotels, comfortable walking sneakers or slip-on shoes are ideal.",
      "Layering is the key to thermal comfort in the hills. Pack a multi-tier clothing system: lightweight thermal base-layers (merino wool or polypropylene tops and bottoms), breathable cotton and flannel shirts for daytime wear, a fleece mid-layer jacket for evenings, and an insulated down or synthetic jacket for winter mornings when temperatures approach freezing.",
      "Wet-weather gear is mandatory between June and November: pack a high-quality waterproof, breathable rain jacket (Gore-Tex or equivalent), a packable rain poncho, and a sturdy windproof umbrella capable of withstanding gusty mountain squalls.",
      "Essential accessories include a warm woolen beanie, polarized sunglasses to cut intense high-altitude glare, high-SPF sunscreen, an insulated stainless-steel flask for hot tea or water, and a lightweight daypack (20 to 30 liters) for day hikes."
    ],
    table: {
      headers: ["Gear Classification", "Recommended Field Item", "Operational Role", "Seasonal Relevance"],
      rows: [
        ["Footwear", "Trail hiking shoes (lugged soles) + casual sneakers", "Trekking Shola paths & tea estate walks", "Essential year-round"],
        ["Thermal Layering", "Down jacket + fleece sweater + thermal innerwear", "Insulating against 0°C to 4°C winter morning chill", "Crucial: November - February"],
        ["Rain Defense", "Breathable waterproof rain jacket + windproof umbrella", "Shielding against heavy monsoon cloudbursts", "Essential: June - November"],
        ["Sun & Eye Shield", "Polarized sunglasses + broad-brimmed hat + SPF 50", "Deflecting high-altitude UV radiation (2,200m+)", "Essential: February - May"],
        ["Hydration & Pack", "Insulated hot/cold flask (1L) + 25L daypack", "Carrying warm tea & gear on full-day hikes", "Recommended year-round"]
      ]
    }
  },
  {
    heading: "Emergency Infrastructure, Hospitals & Mountain Medical Facilities",
    callout: {
      type: "note",
    ...
    paragraphs: [
      "While the Nilgiris offer a peaceful and healthy mountain environment, being prepared for unexpected medical emergencies, accidental slips on mountain trails, or travel-related illnesses is essential.",
      ...
      "In the private sector, well-regarded healthcare providers include the Parvathy Hospital in Ooty and S.M. Hospital in Coonoor, both staffed by experienced physicians and providing diagnostic pathology, pharmacy services, and ambulance transport.",
      "For complex trauma or specialized tertiary interventions (such as advanced neurosurgery or interventional cardiology), patients are stabilized locally and transferred via ambulance down the Kallar Ghat to tertiary multi-specialty hospitals in Coimbatore (such as Ganga Hospital or Kovai Medical Center and Hospital - KMCH), reachable in under two hours.",
      "Emergency ambulance dispatch is integrated through the 108 emergency service, which operates mountain-adapted 4x4 ambulance vehicles across all talukas of the district."
    ],
    table: {
      headers: ["Emergency Department", "Designated Medical Facility", "Physical Address", "Contact Telephone"],
      rows: [
        ["Statewide Emergency Dispatch", "Central Integrated Emergency Service", "Statewide Fleet", "112"],
        ["Apex Public District Hospital", "Government Headquarters Hospital", "Hospital Road, Ooty", "+91 423 244 2212"],
        ["Coonoor Public Hospital", "Government Lawley Hospital", "Mount Road, Coonoor", "+91 423 223 1030"],
        ["Military Cantonment Medical", "Military Hospital Wellington", "Wellington Cantonment", "+91 423 228 2235"],
        ["Highway Mountain Ambulance", "108 Emergency Medical Services", "District-wide 4x4 Fleet", "108"]
      ]
    }
  },
  {
    heading: "Extended Highland Living, Tea Retreats & Mountain Cadence",
    paragraphs: [
      "The Nilgiris have long provided a restorative sanctuary for authors, retired academics, botanical researchers, and remote workers drawn to the soothing climate and majestic mountain solitude. A long-term stay in Coonoor or Kotagiri offers a lifestyle structured by natural mountain rhythms.",
      "Daily life unfolds at an unhurried, contemplative pace. Morning begins with a walk through misty tea gardens as the sunrise illuminates Doddabetta, accompanied by the whistling song of the Malabar whistling thrush. Days are spent reading by a bay window, writing in quiet stone verandas, or cultivating mountain flowers, while evenings conclude around a crackling wood fire with a pot of fresh winter-flush tea.",
      "Long-term rental properties (three to twelve months) include self-contained cottages in private tea estates (₹25,000 to ₹45,000 per month) and expansive heritage colonial bungalows (₹60,000 to ₹140,000 per month). Many tea companies and private estates offer extended residency programs for writers and researchers seeking extended seasonal seclusion.",
      "Active social and cultural life revolves around historic colonial institutions like the Ooty Club (founded in 1841 and celebrated as the birthplace of modern snooker), the Coonoor Club, and local environmental collectives (such as the Keystone Foundation in Kotagiri), which lead inspiring research initiatives in indigenous honey harvesting, water conservation, and tribal enterprise."
    ]
  },
  {
    heading: "Synthesis: The Eternal Sanctuary of the Blue Mountains",
    paragraphs: [
      "To ascend the Nilgiris is to experience an elemental transformation of perspective. As the toy train climbs through the mountain mist and the humid heat of the plains gives way to the crisp scent of pine and eucalyptus, the mind naturally clears, shedding the superficial anxieties of urban life.",
      "The true soul of the Blue Mountains is not found in the commercial souvenir shops of Ooty town, but in the timeless silence of the ancient Sholas—where moss-draped trees have stood since the dawn of memory, absorbing the rains and feeding the great rivers of the South. It is found in the dignified gaze of a Toda elder watching over his herd, and in the quiet mist rolling across thousands of emerald tea slopes at dusk.",
      "The Nilgiris invite us to live more gently, to walk with reverence upon the earth, and to recognize that some landscapes are sacred not because humans declared them so, but because nature built them as towering cathedrals of peace.",
      "Leaving the plateau, as your train slowly winds back down the mountain toward the plains, you carry away a deep, enduring serenity: a memory of blue horizons, the warmth of a wood fire against the mountain cold, and the eternal whisper of the shola winds."
    ]
  }
];

const ootyInlineImages = [
  {
...
const ootyBlocks = assembleStructuredBlocks(ootySections, ootyInlineImages);
...
const ootyConfig = {
  ...
  structuredBlocks: ootyBlocks,
  tags: ["ooty", "nilgiris", "tamil-nadu", "heritage-railway", "unesco-world-heritage", "tea-plantations", "shola-forests", "toda-tribe"],
  travelVerification: {
  ...
  references: [
    { title: "The Toda of the Nilgiris: A Study of an Endangered People (Anthony R. Walker)", url: "https://www.jstor.org/" },
    { title: "Southern Railway Official Portal: Nilgiri Mountain Railway Schedule & Booking", url: "https://sr.indianrailways.gov.in/" },
    { title: "Keystone Foundation: Nilgiri Biosphere Reserve Ecological Audits", url: "https://keystone-foundation.org/" },
    { title: "Tamil Nadu Forest Department: Mukurthi National Park Management Plan", url: "https://forests.tn.gov.in/" }
  ]
};

const ootyBuilt = writeCanonicalArticleModule("travel", "ooty-and-the-nilgiri-hills.js", ootyConfig);
console.log(`[Ooty and the Nilgiri Hills] Word count: ${ootyBuilt.wordCount}`);
