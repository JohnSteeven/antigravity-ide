...
console.log("Authoring Travel India 20/20: Andaman Islands...");

const andamanSections = [
  {
    heading: "Archipelago Geography, Tectonic Origins & Marine Ecosystems",
    callout: {
      type: "note",
    ...
    paragraphs: [
      ...
      "Visiting the Andamans requires understanding its layered identity: an ancient sanctuary for indigenous hunter-gatherer tribes who have inhabited these rainforests for 60,000 years, a poignant colonial penal memorial, and an oceanic wilderness of dazzling natural beauty."
    ],
    quote: {
  ...
  {
    heading: "Transit Corridors, Port Blair Aviation & Maritime Ferry Logistics",
    paragraphs: [
      "Reaching the Andaman archipelago involves flying into Port Blair or undertaking a multi-day sea voyage across the Bay of Bengal. The commercial aviation gateway is Veer Savarkar International Airport (IATA: IXZ) in Port Blair, the administrative capital situated on South Andaman Island. In July 2023, a state-of-the-art new integrated passenger terminal was inaugurated, designed with shell-shaped architectural roofs and world-class passenger handling capacity.",
      "Nonstop commercial jet flights connect Port Blair daily to Chennai, Kolkata, Bengaluru, Hyderabad, Mumbai, and New Delhi, operated by IndiGo, Air India, and SpiceJet. Flight times from Chennai and Kolkata are just over two hours across the open waters of the Bay of Bengal. Authorized prepaid taxi counters inside the arrival hall provide fixed-fare cab transfers to city hotels, the Phoenix Bay Jetty, and Haddo Wharf.",
      "While passenger ships operated by the Directorate of Shipping Services (DSS) sail from Chennai, Kolkata, and Visakhapatnam to Port Blair, the voyage requires three to four days across rough open seas and is primarily utilized by local residents and budget travelers seeking nostalgic maritime passage rather than short-duration tourists.",
      "Inter-island transit between Port Blair and the tourism hubs of Havelock Island (Swaraj Dweep) and Neil Island (Shaheed Dweep) is operated by high-speed private luxury catamarans (Makruzz, Green Ocean, Nautika, and ITT Majestic). These modern, air-conditioned catamarans complete the 38-nautical-mile crossing between Port Blair and Havelock in ninety minutes, featuring business and premium class passenger seating.",
      "Supplemental government ferries operated by DSS run scheduled, budget-friendly services between the islands, providing essential cargo and passenger lifelines connecting Port Blair, Neil, Havelock, Rangat, Mayabunder, and Diglipur."
    ],
    table: {
      headers: ["Transit Route / Service", "Schedule & Frequency", "Hub / Terminal Code", "Transit Duration", "Typical INR Tariff"],
      rows: [
        ["Commercial Flight (Chennai to Port Blair)", "Multiple daily nonstop flights", "MAA -> IXZ (Port Blair)", "2h 05m (Flight)", "₹4,800 - ₹9,500"],
        ["Commercial Flight (Kolkata to Port Blair)", "Multiple daily nonstop flights", "CCU -> IXZ (Port Blair)", "2h 15m (Flight)", "₹5,200 - ₹10,500"],
        ["Makruzz Luxury Catamaran (Port Blair to Havelock)", "3 to 4 scheduled daily runs", "Phoenix Bay -> Swaraj Dweep", "1h 30m (38 nm)", "₹1,450 (Premium) / ₹2,100 (Royal)"],
        ["Green Ocean Catamaran (Havelock to Neil)", "Daily morning scheduled run", "Swaraj Dweep -> Shaheed Dweep", "1h 00m (18 nm)", "₹1,200 - ₹1,800"],
        ["Port Blair Airport to Phoenix Bay Jetty Cab", "Available upon flight arrival", "IXZ -> Phoenix Bay Wharf", "20m (7 km)", "₹450 - ₹650"]
      ]
    }
  },
  {
    heading: "Port Blair: Cellular Jail National Memorial & Colonial Penal History",
    callout: {
      type: "note",
  ...
  },
  {
    ...
    paragraphs: [
      "Thirty-eight nautical miles northeast of Port Blair lies Havelock Island, officially renamed Swaraj Dweep in 2018. Covering 113 square kilometers, Havelock is the premier leisure and adventure tourism island of the Andaman archipelago, renowned for pristine coral sands, dense virgin rainforests, and world-class scuba diving operations.",
      "The undisputed crown jewel of Havelock is Radhanagar Beach (Beach No. 7), situated on the secluded western shore of the island. Consistently ranked by TIME magazine and international travelers as one of the finest beaches in Asia and holding an official international Blue Flag eco-certification, Radhanagar features an expansive two-kilometer curve of powdery, brilliant white coral sand that slopes gently into crystal-clear turquoise waters.",
      "Unlike overdeveloped resort beaches elsewhere in Asia, Radhanagar has been preserved with strict environmental regulations: concrete structures are banned from the immediate shoreline, which is fringed instead by towering, old-growth Andaman Padauk (Pterocarpus dalbergioides) and Mahua trees that cast deep emerald shade right up to the high-tide line.",
      "On the eastern shore of Havelock lie Vijaynagar Beach (Beach No. 5) and Govindnagar Beach (Beach No. 3), tranquil lagoons sheltered by offshore coral reefs where luxury beach resorts and scuba dive centers are nestled amidst coconut groves.",
      "Further north lies Elephant Beach, celebrated for shallow fringing reefs ideal for snorkeling, accessible via a scenic two-kilometer nature trek through dense tropical rainforests and mangrove mudflats or by fifteen-minute speed boat from Havelock Jetty.",
      "On the southeastern tip of the island lies Kalapathar Beach, taking its evocative name from the massive black volcanic boulders that line the brilliant white shoreline. Here, a narrow coastal road hugs the jungle edge where giant padauk trunks lean dramatically over the water. The sea at Kalapathar boasts a distinct luminescent aqua-turquoise hue, offering a quieter, contemplative alternative to Radhanagar where travelers can read under overhanging branches and watch local fishermen launch wooden outrigger canoes. The beach remains wonderfully uncrowded throughout the midday hours, providing travelers with secluded stretches of pristine white coral sand where the gentle whisper of the breeze through the padauk leaves harmonizes with the rhythmic swell of the incoming tide."
    ]
  },
  {
    heading: "Scuba Diving & Coral Conservation: South Button, Dixon's Pinnacle & Marine Parks",
    callout: {
      type: "important",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Neil Island is compact enough to explore entirely by bicycle or rental scooter, winding through shaded village roads bordered by betel nut palms and organic papaya groves."
    ]
  },
  {
    heading: "Baratang Island: Limestone Caves, Mud Volcanoes & The Mangrove Creeks",
    callout: {
      type: "important",
    ...
    paragraphs: [
      "One hundred kilometers north of Port Blair in the Middle Andaman district lies Baratang Island, renowned for its extraordinary geological phenomena, dense mangrove labyrinths, and tropical rainforest reserves.",
      ...
      "Upon reaching the Nilambur Jetty on Baratang, travelers board motorized speedboats for a thrilling ride through dense mangrove creeks. The speedboats navigate narrow, dark water channels where the thick canopy of red and black mangrove roots (Rhizophora mucronata) arches overhead like a cathedral.",
      "Disembarking at a wooden jetty, a scenic 1.2-kilometer trek through tropical forest and paddy fields leads to the Baratang Limestone Caves. These ancient geological caverns feature massive, surreal stalactite and stalagmite formations hanging like stone drapes and pillars, formed drop by drop over millions of years by calcium carbonate dissolved in subterranean rainwater.",
      "A short drive from the jetty brings visitors to the Baratang Mud Volcano, one of the few active mud volcanoes in South Asia. Subterranean natural methane gases force slurry of mud and saline water to bubble gently to the surface, creating mini-craters of grey drying clay amidst the forest."
    ]
  },
  {
    heading: "North & Middle Andaman: Diglipur, Saddle Peak & Ross and Smith Twin Islands",
    paragraphs: [
      "For travelers seeking wilderness solitude far beyond standard tourist circuits, North Andaman Island—centered around the town of Diglipur, three hundred kilometers north of Port Blair—offers dramatic mountain landscapes and secluded beaches.",
      "North Andaman is dominated by Saddle Peak (elevation 732 meters / 2,402 feet), the highest mountain peak in the entire Andaman and Nicobar archipelago. Enclosed within Saddle Peak National Park, the mountain rises steeply from the ocean, blanketed in unique stunted evergreen rainforests harboring rare indigenous flora and fauna, including the endemic Andaman wild pig, imperial pigeon, and hill myna.",
      "Just off the coast of Diglipur lie the legendary Ross and Smith Islands. These two pristine tropical islands are connected by a natural, five-hundred-meter-long sandbar of brilliant white coral sand that emerges completely at low tide. Walking across the narrow sandbar with turquoise ocean waters lapping gently on both sides is one of the most surreal beach experiences in India.",
      "Near Diglipur lies the pristine Kalipur Beach, famous as an important nesting ground for four species of endangered marine sea turtles (olive ridley, leatherback, hawksbill, and green sea turtles). During the nesting season between December and March, the forest department operates a turtle hatchery where visitors can witness hatchlings making their nocturnal march to the ocean.",
      "Nearby, the mysterious Alfred Caves near Ramnagar feature a network of thirty-two unexplored karst limestone caves that shelter thousands of swiftlets and fruit bats."
    ]
  },
  {
    heading: "Indigenous Tribal Heritage & Strict Anthropological Protections",
    callout: {
      type: "important",
    ...
    paragraphs: [
      "The Andaman and Nicobar Islands are the ancestral homelands of some of the world's most ancient and vulnerable indigenous tribal populations, categorized anthropologically into Negrito peoples in the Andamans and Mongoloid peoples in the Nicobars.",
      "The indigenous Andamanese tribes—comprising the Great Andamanese, the Onge of Little Andaman, the Jarawa of South and Middle Andaman, and the Sentinelese of North Sentinel Island—migrated out of Africa during the early coastal human dispersals approximately 60,000 years ago, living in complete hunter-gatherer equilibrium with their rainforest and coral reef environments.",
      "The Sentinelese people, inhabiting the isolated 60-square-kilometer North Sentinel Island, represent the last truly uncontacted human society on earth. They have fiercely resisted all outside contact for centuries, choosing to remain in total voluntary isolation. The Government of India enforces a strict five-nautical-mile exclusion zone around North Sentinel Island, maintained through regular naval and coast guard sea and aerial patrols.",
      "Similarly, the Jarawa, who numbered fewer than 400 individuals, were nomadic forest dwellers until recent decades. The Andaman administration enforces the Andaman and Nicobar Islands (Protection of Aboriginal Tribes) Regulation (PAT), prohibiting any tourism, filming, or unauthorized entry into tribal reserve lands.",
      "Travelers must understand that the tribal reserves are not tourist spectacles; respecting the sovereignty, privacy, and immunological safety of these ancient first peoples is an absolute ethical obligation."
    ]
  },
  {
    heading: "Island Gastronomy: Fresh Oceanic Seafood & Multi-Cultural Flavors",
    paragraphs: [
      "The culinary landscape of the Andaman Islands reflects its unique history of maritime migration, combining coastal Bengali traditions, Tamil and Telugu fish preparations, and indigenous tropical produce.",
      "The centerpiece of Andaman dining is exceptionally Fresh Ocean Seafood, caught daily by local artisanal fishermen from the unpolluted waters of the Bay of Bengal. Menus across Port Blair and Havelock beach shacks feature grilled whole red snapper, king mackerel (surmai), tiger prawns, blue crabs, and lobster, marinated simply in coastal spices, lime juice, turmeric, and garlic, then grilled over open wood charcoal.",
      "Due to the significant population of Bengali settlers who arrived following the 1947 Partition, traditional Bengali fish curries are ubiquitous: Macher Jhol (fresh fish simmered in a light, fragrant broth of mustard oil, cumin seeds, turmeric, and green chilies) served with steaming white rice.",
      "South Indian flavors are equally prominent: crispy breakfast dosas, idlis, and fiery Tamil-style fish curries cooked with tamarind, curry leaves, and freshly grated coconut milk.",
      "In Havelock and Neil, contemporary bohemian beach shacks serve wood-fired thin-crust seafood pizzas, Thai coconut prawn curries, Israeli shakshuka, and fresh coconut water plucked straight from tall King Coconut palms along the shoreline.",
      "A quintessential island ritual is dining barefoot at candlelit tables set directly in the soft sand of Vijaynagar Beach under the palms. As the gentle surf laps against the shore, diners savor whole mud crabs wok-tossed in black pepper, garlic, and scallions, served with hot rotis and chilled tropical lime sodas, surrounded by the warm ocean breeze and the phosphorescent glow of breaking waves."
    ]
  },
  {
    heading: "Marine Crafts & Sustainable Souvenirs: Coconut & Woodcraft",
    callout: {
      type: "important",
    ...
    paragraphs: [
      "Shopping in the Andaman Islands is centered around natural materials and sustainable forest handicrafts, available at the government-run Sagarika Government Emporium in Port Blair.",
      "The premier craft tradition utilizes seasoned local hardwoods: Andaman Padauk (a magnificent red hardwood with rich golden grains), satinwood, and marblewood. Local artisans carve elegant furniture, bowls, walking sticks, and miniature models of traditional outrigger canoes.",
      "Coconut shell craft is another distinctive art form: polished coconut shells are transformed into tea cups, bowls, table lamps, and jewelry boxes adorned with brass inlays.",
      "Regarding sea shells: only purchase shell handicrafts from certified government-authorized emporiums that provide an official sales receipt and export permit certificate. Collecting wild shells or dead coral fragments from beaches is a serious environmental offense punishable by fines and confiscation at airport security."
    ]
  },
  {
    heading: "Comprehensive 6-Day Andaman Highlights Itinerary",
    callout: {
      type: "tip",
    ...
    paragraphs: [
      ...
      "Day 5: Bharatpur Coral Lagoon & Return to Port Blair. Morning: Visit Bharatpur Beach for a glass-bottom boat tour across vibrant coral gardens. In the early afternoon, board the return catamaran back to Port Blair. In the evening, take a short sunset stroll along the coastal promenade of Marina Park, and shop for certified padauk woodcraft at the Sagarika Emporium.",
      "Day 6: Ross Island Ghost Ruins & Airport Departure. Morning: Take a short 15-minute passenger boat to Ross Island (Netaji Subhash Chandra Bose Dweep): explore the ruins of colonial ballrooms and churches reclaimed by banyan roots, and spot spotted deer grazing under the palms. Return to Port Blair and transfer to the airport for your return flight to the mainland."
    ],
    table: {
      headers: ["Day", "Primary Focus & Core Activities", "Key Locations Explored", "Travel Mode", "Featured Gastronomic Experience"],
      rows: [
        ["Day 1", "Penal History & Freedom Memorial", "Cellular Jail, Sound & Light Show, Marina Park", "Airport cab / Walking", "Grilled Andaman red snapper with garlic butter"],
        ["Day 2", "Catamaran to Havelock & Sunset Sands", "Phoenix Bay, Swaraj Dweep, Radhanagar Beach", "Luxury Catamaran (90m)", "Fresh coconut water & coastal prawn curry"],
        ["Day 3", "Coral Reef Diving & Rain Forest Beach", "Elephant Beach, Nemo Reef, Kalapathar Beach", "Speedboat / Scooter", "Wood-fired pizza & fresh tropical fruit smoothies"],
        ["Day 4", "Geological Rock Bridge & Sunset Beach", "Neil Island, Natural Rock Bridge, Laxmanpur", "Catamaran (60m) / Cab", "Traditional Bengali Macher Jhol with rice"],
        ["Day 5", "Shallow Coral Lagoon & Return to Capital", "Bharatpur Beach, Port Blair, Sagarika Market", "Catamaran / City cab", "South Indian thali with fresh coconut chutney"],
        ["Day 6", "Banyan Ruins & Island Departure", "Ross Island Ghost Ruins, IXZ Airport", "Harbor boat / Transfer", "Warm filter coffee & local bakery snacks"]
      ]
    }
  },
  {
    heading: "Accommodations: Luxury Island Resorts, Eco-Villas & Beach Huts",
    paragraphs: [
      "Accommodations across the Andaman Islands have matured significantly, offering diverse choices from ultra-luxury eco-resorts to rustic backpacker beach huts.",
      "On Havelock Island (Swaraj Dweep), the pinnacle of luxury is the Taj Exotica Resort & Spa on Radhanagar Beach, set across forty-six acres of tropical rainforest and coconut groves, featuring luxurious Andaman-padauk villas inspired by indigenous Jarawa stilt dwellings (tariffs range from ₹28,000 to ₹65,000+ per night). Other premier luxury beachfront resorts along Vijaynagar Beach include Barefoot at Havelock (a pioneer of sustainable jungle eco-lodges constructed from thatch, cane, and local timber) and Silver Sand Beach Resort (₹8,500 to ₹18,000 per night).",
      "For mid-range travelers, Havelock and Neil Island offer dozens of charming wooden cottages and eco-resorts nestled amidst coconut plantations, featuring air-conditioned suites and private verandas just footsteps from the beach at ₹3,500 to ₹6,500 per night.",
      "In Port Blair, historic hill-perched hotels such as Fortune Resort Bay Island (designed by renowned architect Charles Correa with native timber and open sea views) and Sinclairs Bayview offer panoramic ocean vistas overlooking the harbor at ₹6,500 to ₹14,000 per night.",
      "Budget travelers can find clean, welcoming family guesthouses and backpacker hostels in Port Blair and Neil Island starting at ₹1,500 to ₹2,800 per night."
    ]
  },
  {
    heading: "Seasonal Packing, Tropical Health & Marine Sun Protection",
    callout: {
      type: "note",
    ...
    paragraphs: [
      "Packing for the Andaman Islands requires clothing and gear adapted to tropical heat, marine environments, and inter-island boat travel.",
      "Beachwear & Snorkeling Attire: Quick-drying rash guards (long-sleeve UV-blocking swim shirts) are essential for snorkeling and scuba diving, providing protection against both sunburn and harmless sea lice. Bring comfortable board shorts, swimming costumes, and a waterproof dry bag (15 to 20 liters) to safeguard phones and cameras during boat rides.",
      "Coral Protection & Footwear: Wear slip-resistant water shoes or reef booties when walking along rocky beaches or exploring the Natural Rock Bridge at Neil Island to protect your feet against sharp coral and sea urchins. Use only certified reef-safe mineral sunscreens.",
      "Motion Sickness & Tropical Health: High-speed catamarans can experience rolling swells when crossing open channels in the Bay of Bengal. Travelers prone to seasickness should carry motion sickness medication (dimenhydrinate) and take it thirty minutes before boarding. Bring broad-spectrum tropical insect repellent for evening beach strolls and jungle treks."
    ]
  },
  {
    heading: "Eco-Sensitivity, Coral Reef Protection & Ocean Ethics",
    paragraphs: [
      "The fragile marine and rainforest ecosystems of the Andaman Islands are vulnerable to plastic pollution, coral bleaching events caused by rising ocean temperatures, and irresponsible tourism.",
      "The Andaman and Nicobar Administration strictly enforces a complete ban on single-use plastic carry bags throughout the islands. Travelers should carry reusable stainless steel water flasks, refilling them at hotel water dispensers to eliminate disposable plastic waste.",
      "When snorkeling or diving, practice strict ocean ethics: never touch, stand on, or kick living coral polyps. A single touch can strip the protective mucus layer from coral, exposing it to lethal bacterial infections. Never chase sea turtles, dugongs, or manta rays, and never collect sea shells from beaches or reefs.",
      "Support sustainable community development by patronizing local island-owned restaurants, hiring licensed local boatmen, and respecting the cultural integrity of island communities."
    ]
  },
  {
    heading: "Detailed Budget Framework & Travel Logistics in INR",
    paragraphs: [
      "A six-day island expedition across Port Blair, Havelock, and Neil can be planned across three distinct budget categories, each providing transparent, verified cost parameters.",
      "Budget Explorer (₹2,500 - ₹3,800 per person per day): Stay in welcoming family guesthouses or traveler hostels in Port Blair and Neil (₹1,200 - ₹2,000/night). Travel via government DSS ferries or economy class on private catamarans, and rent scooters on the islands (₹450 - ₹600/day). Dine at local Bengali fish dhabas and South Indian cafes (₹500 - ₹800/day). Self-guided beach walks and public snorkeling.",
      "Mid-Range Cultural & Beach Traveler (₹7,500 - ₹12,000 per person per day): Stay in charming beachside wooden cottages on Havelock and Neil (₹4,500 - ₹8,000/night). Travel via premium class on private catamarans (Makruzz/Nautika) and private island cabs (₹2,000 - ₹3,200/day). PADI Discover Scuba Diving experience, Cellular Jail light show, and curated seafood dining (₹1,500 - ₹2,500/day).",
      "Luxury Island Connoisseur (₹25,000 - ₹55,000+ per person per day): Stay at Taj Exotica Resort & Spa on Radhanagar Beach or Barefoot at Havelock (₹25,000 - ₹50,000/night). Private royal class catamaran suites and dedicated private luxury SUVs on each island (₹4,500 - ₹7,000/day). Private chartered dive boats, bespoke candlelit beachfront dining, and private yacht sunset excursions.",
      "Every tier unlocks the breathtaking oceanic majesty, tranquil beaches, and lush rainforests of India's island paradise."
    ],
    table: {
      headers: ["Expense Category", "Budget Tier (Daily / Unit)", "Mid-Range Tier (Daily / Unit)", "Luxury Tier (Daily / Unit)"],
      rows: [
        ["Double Accommodation", "₹1,200 - ₹2,200", "₹4,500 - ₹8,500", "₹25,000 - ₹55,000+"],
        ["Daily Dining (Per Person)", "₹500 - ₹800", "₹1,500 - ₹2,500", "₹4,000 - ₹8,500"],
        ["Inter-Island Catamarans & Cabs", "₹800 - ₹1,400 (Govt/Scooter)", "₹2,500 - ₹4,000 (Makruzz/Cab)", "₹6,000 - ₹12,000 (Royal/Dedicated)"],
        ["Scuba Diving & Snorkeling", "₹600 - ₹1,200 (Snorkel)", "₹3,500 - ₹5,500 (DSD Dive)", "₹8,000 - ₹18,000 (Private Dive/Boat)"],
        ["Padauk Woodcraft & Souvenirs", "₹350 - ₹800 (Coconut bowl)", "₹2,000 - ₹5,500 (Wood carving)", "₹12,000 - ₹35,000 (Padauk Furniture)"]
      ]
    }
  },
  {
    heading: "Practical Information, Regulatory Protocols & Emergency Contacts",
    callout: {
      type: "important",
    ...
    paragraphs: [
      ...
      "Mobile Connectivity: Mobile cellular connectivity across the islands has been transformed by the 2,300-kilometer Chennai-Andaman and Nicobar Islands (CANI) submarine optical fiber cable. High-speed 4G coverage (Airtel, BSNL, and Jio) is robust in Port Blair, Havelock, and Neil.",
      "Banking & Cash Realities: Modern 24/7 bank ATMs (SBI, HDFC, Axis, ICICI) operate in Port Blair, Havelock market (near Jetty), and Neil Island. UPI digital payments are accepted across hotels and major shops; however, carrying sufficient physical cash is strongly recommended for smaller beach shacks, auto-rickshaws, and boat rentals.",
      "Emergency Contacts: Andaman & Nicobar Police Control Room: 112 / +91 3192 232100; Tourist Police Booth (Aberdeen Jetty): +91 3192 232338; Medical Emergency Ambulance: 108; G.B. Pant Hospital (Port Blair Premier Government Hospital): +91 3192 232102; Coast Guard Maritime Search and Rescue: 1554."
    ]
  },
  {
    heading: "The Oceanic Horizon: Solitude, Coral Shadows & Island Wonder",
    paragraphs: [
      "To stand on the powdery white coral sands of Radhanagar Beach at twilight, watching the sun dip into the vast expanse of the Andaman Sea while ancient padauk trees rustle in the warm ocean breeze, is to understand the healing power of oceanic isolation. Here, where the frantic rush of the modern world cannot cross the water, time expands to the measured rhythm of the tides.",
      "The true magic of the Andamans is discovered not in commercial viewpoints, but in quiet, elemental encounters: drifting silently over coral pinnacles where tropical fish dart among sea fans, walking among the silent, banyan-strangled ruins of Ross Island, and listening to the rhythmic breathing of the ocean beneath a canopy of brilliant tropical stars. It is an encounter with a deeper, unhurried time that restores perspective to the wandering mind.",
      "The Andaman Islands remind us of the primordial beauty of our planet—a place where ancient rainforests and coral reefs still thrive in wild harmony, teaching the traveler to listen, to respect, and to dwell in quiet awe.",
...
const andamanBlocks = assembleStructuredBlocks(andamanSections, andamanInlineImages);
...
const andamanConfig = {
  ...
  structuredBlocks: andamanBlocks,
  tags: ["andaman-islands", "port-blair", "havelock", "swaraj-dweep", "radhanagar-beach", "neil-island", "scuba-diving", "cellular-jail", "india-travel"],
  travelVerification: {
  ...
  references: [
    { title: "The Andaman Islanders (A.R. Radcliffe-Brown)", url: "https://www.gutenberg.org/" },
    { title: "Archaeological Survey of India: Cellular Jail National Memorial Monograph", url: "https://asi.nic.in/" },
    { title: "Directorate of Tourism, Andaman and Nicobar Administration: Official Guide", url: "https://www.andamantourism.gov.in/" },
    { title: "Zoological Survey of India: Coral Reef Ecosystems of Andaman and Nicobar Islands", url: "https://zsi.gov.in/" }
  ]
};

const andamanBuilt = writeCanonicalArticleModule("travel", "andaman-islands.js", andamanConfig);
console.log(`[Andaman Islands] Word count: ${andamanBuilt.wordCount}`);
