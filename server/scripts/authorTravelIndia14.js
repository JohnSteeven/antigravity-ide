...
console.log("Authoring Travel India 14/20: Manali and the Upper Beas...");

const manaliSections = [
  {
    heading: "Upper Kullu Valley Topography, Pir Panjal & Himalayan Microclimates",
    callout: {
      type: "note",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "North of Manali, the monumental 9.02-kilometer-long Atal Tunnel beneath the Rohtang Pass (at an altitude of 3,100 meters) provides all-weather connectivity into the trans-Himalayan Lahaul Valley and Keylong, cutting travel time by four to five hours and opening year-round access to Chandra Valley landscapes."
    ],
    table: {
      headers: ["Transit Route / Service", "Schedule & Frequency", "Hub / Station Code", "Transit Duration", "Typical INR Tariff"],
      rows: [
        ["HRTC Himsuta Volvo Bus (Delhi to Manali)", "Nightly departures 17:00 to 21:30", "Kashmere Gate ISBT -> Manali", "13h 30m (530 km)", "₹1,450 - ₹1,750"],
        ["Chandigarh Airport to Manali Private Cab", "24/7 on-demand pre-booked cab", "IXC Airport -> Manali (NH-3)", "8h 00m (310 km)", "₹5,500 - ₹7,000"],
        ["Alliance Air Flight (Delhi to Bhuntar)", "Daily morning scheduled ATR-72", "DEL -> KUU (Bhuntar)", "1h 20m (Flight)", "₹6,500 - ₹12,000"],
        ["Bhuntar Airport to Manali Union Taxi", "Available upon flight arrivals", "KUU -> Manali Mall / Old Manali", "1h 30m (50 km)", "₹2,200 - ₹2,800"],
        ["Atal Tunnel Excursion Cab (Manali to Sissu)", "Daily private union taxi roundtrip", "Manali -> Atal Tunnel -> Sissu", "5h 00m (Roundtrip)", "₹3,200 - ₹4,500"]
      ]
    }
  },
  {
    heading: "Micro-Districts: Old Manali, Vashisht, Solang & Naggar Heritage",
    callout: {
      type: "tip",
    ...
    paragraphs: [
      ...
      "Together, these varied micro-districts allow travelers to construct an itinerary that balances outdoor adventure, rich Pahari village heritage, and contemplative mountain quietude."
    ]
  },
  {
    heading: "Architectural Heritage: Kathkuni Timber-and-Stone Construction",
    paragraphs: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Unlike conventional temples with stone murtis, the inner sanctum contains a natural subterranean rock cave where Hadimba is said to have meditated. The sacred rock inside bears the carved footprint of the goddess, which pilgrims venerate with incense, fresh mountain wildflowers, and vermilion powder.",
      "Surrounding the shrine is the pristine Dhungri Van Vihar, a protected old-growth deodar forest sanctuary where thousand-year-old cedars rise sixty meters into the mountain sky, filtering the sunlight into emerald beams. Walking along the quiet pine-needle pathways around Dhungri at sunrise provides an unforgettable spiritual experience far removed from town traffic."
    ]
  },
  {
    heading: "The Atal Tunnel Engineering Feat & The Trans-Himalayan Lahaul Frontier",
    callout: {
      type: "note",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Jogini Falls plunges in a spectacular multi-tiered cascade from a height of approximately 150 feet into a crystal-clear pool below. Considered sacred by local villagers, the lower pool is flanked by small prayer flags and stone shrines dedicated to the local Joginis (nature spirits). The upper tier of the falls can be reached via a steep twenty-minute scramble, offering breathtaking views of the entire Manali basin."
    ]
  },
  {
    heading: "Solang Valley Outdoor Sports, Paragliding & Skiing Terrain",
    callout: {
      type: "tip",
    ...
    paragraphs: [
      ...
      "Other popular seasonal activities in Solang include zorbing (rolling down grassy slopes inside transparent inflatable double spheres), quad biking along river tracks, and river crossing across mountain torrents using harness pulleys.",
      "To ensure a safe adventure experience, visitors should avoid unaccredited roadside touts on the highway and register only at the authorized HP Tourism adventure counter, verifying pilot credentials, flight insurance, and weather condition advisories before taking to the skies."
    ]
  },
  {
    heading: "Naggar: Royal Castle, Nicholas Roerich Estate & Himalayan Art",
    paragraphs: [
      ...
      "A short walk up the hill from the castle brings visitors to the Nicholas Roerich Art Gallery and Estate. Russian painter, philosopher, and mystic Nicholas Roerich lived in this two-story timber mansion with his wife Helena and family from 1928 until his death in 1947. The gallery preserves Roerich's original studio and displays over thirty of his masterwork oil paintings, capturing the ethereal spiritual luminousness of the Himalayan peaks in vibrant shades of cobalt, lapis, turquoise, and violet.",
      "Beside the estate sits the Urusvati Himalayan Research Institute, founded by the Roerichs to study ethnography, local folk medicine, and botanical biodiversity across the Western Himalayas, surrounded by tranquil gardens of weeping willows and deodar pines."
    ]
  },
  {
    heading: "High-Altitude Trekking Routes: Beas Kund, Hampta Pass & Bhrigu Lake",
    paragraphs: [
      "Manali serves as the premier trailhead for some of the most celebrated high-altitude trekking expeditions in the Indian Himalayas, ranging from accessible weekend alpine hikes to challenging trans-Himalayan pass crossings.",
      "The classic short trek is Beas Kund (altitude 3,890 m), a three-day roundtrip hike originating from Dhundi in the Solang Valley. The trail climbs alongside the raging Upper Beas torrent, traversing meadows of alpine wildflowers and moraine ridges to reach the emerald, sacred glacial lake of Beas Kund, nestled at the foot of Mount Hanuman Tibba and the Ladakhi peak. According to legend, Sage Vyasa meditated at this tranquil tarn while composing the Mahabharata epic.",
  ...
  {
    heading: "Pahari Gastronomy: Siddu, Trout, Babru & Himachali Dham",
    callout: {
      type: "note",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Another iconic cultural emblem of the region is the Kullu Cap (Kullu Topi). Worn with immense pride by local Himachali men during festivals and ceremonies, this round, flat-topped woolen cap is decorated with a brightly colored, patterned handwoven velvet border across the front fold.",
      "Visitors can purchase certified handloom shawls, mufflers, blankets, and caps directly from the Bhuttico Weavers Cooperative Society showrooms, established in 1944, which guarantees fair trade wages for local village artisans and authentic handloom certification."
    ]
  },
  {
    heading: "Comprehensive 5-Day Upper Beas & Lahaul Itinerary",
    callout: {
      type: "tip",
    ...
    paragraphs: [
      ...
      "Day 5: Solang Valley Mountain Panoramas & Departure. Spend your final morning in Solang Valley. Ride the Solang Ropeway cable car up to Mount Phatru (3,200 m) for panoramic vistas of snow-dusted Himalayan peaks. Stop at the Bhuttico Weavers Cooperative showroom on the return drive to purchase certified Kullu shawls and handwoven woolens. Depart Manali via evening Volvo bus to Delhi or private transfer to Bhuntar / Chandigarh Airport."
    ],
    table: {
      headers: ["Day", "Focus & Core Activity", "Key Locations Visited", "Altitude Profile", "Recommended Dining Highlight"],
      rows: [
        ["Day 1", "Acclimatization & Cedar Heritage", "Hadimba Temple, Dhungri Forest, Manu Temple", "2,050 m (Manali)", "Riverside trout & fresh apple crumble"],
        ["Day 2", "Hot Springs & Waterfall Hike", "Vashisht Sulfur Baths, Jogini Falls Trail", "2,100 m - 2,250 m", "Steaming Siddu with desi ghee & walnut paste"],
        ["Day 3", "Atal Tunnel & Trans-Himalaya", "Atal Tunnel, Sissu Waterfall, Gondhla Fort", "3,100 m - 3,200 m", "Hot Tibetan thukpa & momos in Sissu"],
        ["Day 4", "Royal Architecture & Roerich Art", "Naggar Castle, Roerich Gallery, Tripura Sundari", "1,760 m (Naggar)", "Traditional Pahari lunch at Naggar heritage café"],
        ["Day 5", "Solang Panoramas & Textile Craft", "Solang Ropeway, Mount Phatru, Bhuttico Loom", "2,560 m - 3,200 m", "Fresh Himalayan bakery treats in Old Manali"]
      ]
    }
  },
  {
    heading: "Accommodations: Heritage Stays, Riverside Cottages & Homestays",
    paragraphs: [
      "Accommodations across the Upper Kullu Valley cater to diverse travel styles, ranging from restored royal fortresses to cozy orchard cottages and rustic village homestays.",
      ...
      "For independent travelers and nature lovers, Old Manali and Vashisht boast dozens of charming timber cottages, artistic guesthouses, and apple orchard homestays with panoramic mountain rooftop views, warm wooden rooms, and fast Wi-Fi suitable for extended remote work (₹1,500 to ₹3,800 per night).",
      "In Lahaul, Sissu and Keylong offer eco-camps and welcoming family homestays that allow travelers to experience traditional Buddhist mountain hospitality beneath starry Himalayan skies (₹1,800 to ₹3,200 per night)."
    ]
  },
  {
    heading: "Seasonal Packing, High-Altitude Safety & Mountain Health",
    callout: {
      type: "note",
    ...
    paragraphs: [
      "Packing for the Upper Kullu Valley requires versatile layering to accommodate rapid mountain weather fluctuations. In spring and summer, lightweight breathable cottons are suitable for sunny daytime hikes, but a mid-weight fleece, windproof jacket, and warm wool hat are essential for chilly evenings and excursions to Solang or Atal Tunnel.",
      "In autumn and winter, heavy thermal base layers, a down parka rated for sub-zero temperatures, insulated waterproof gloves, woolen socks, and sturdy waterproof hiking boots with lugged soles are mandatory.",
      "At altitudes exceeding 2,500 meters (Solang, Rohtang, and Lahaul), travelers may encounter mild symptoms of Acute Mountain Sickness (AMS), including headaches, mild dizziness, and shortness of breath. To minimize altitude stress, drink three to four liters of water daily, avoid alcohol during the first forty-eight hours, and allow at least one full day of gentle acclimatization in Manali before ascending to higher passes.",
      "Always carry a well-stocked travel first-aid kit containing rehydration salts, paracetamol, antacids, motion sickness medication (essential for winding mountain hairpin bends), and blister plasters."
    ]
  },
  {
    heading: "Eco-Sensitivity, Waste Management & Leave-No-Trace Mountain Travel",
    paragraphs: [
      "The fragile alpine ecology of the Upper Beas basin faces severe environmental pressures from mass tourism, vehicular emissions, and plastic waste. The Himachal Pradesh government strictly enforces a ban on single-use plastic bags, plastic cups, and disposable cutlery across the state.",
      "Travelers should practice strict Leave-No-Trace principles: carry reusable stainless steel water bottles and refill them at filtered water stations available across Old Manali and Vashisht cafes, avoiding single-use disposable plastic bottles.",
      "When trekking to pristine alpine lakes such as Beas Kund, Bhrigu Lake, or Chandratal, pack out all personal trash, including food wrappers and fruit peels. Never leave wet wipes or plastic along trails, and avoid disturbing fragile high-altitude alpine moss and wild rhododendron shrubs.",
      "Support local Pahari communities by purchasing certified handloom products directly from weavers, dining at locally owned dhabas, and hiring registered local mountain guides from the Kullu-Manali Valley Association."
    ]
  },
  {
    heading: "Detailed Budget Framework & Travel Logistics in INR",
    paragraphs: [
      "A five-day Himalayan expedition to Manali and the Upper Beas can be tailored across three distinct budget categories, each providing transparent, verified cost parameters.",
      "Budget Explorer (₹2,000 - ₹3,000 per person per day): Stay in welcoming wooden guesthouses or hostels in Old Manali or Vashisht (₹800 - ₹1,400/night shared). Travel via HRTC semi-deluxe or ordinary buses and share union cabs for Solang. Dine at local dhabas on Siddu, thukpa, and thalis (₹450 - ₹700/day). Self-guided day hikes to Jogini Falls and Manu Temple.",
      ...
      "Luxury Alpine Connoisseur (₹15,000 - ₹25,000+ per person per day): Stay at premier luxury resorts like The Himalayan or Span Resort & Spa (₹14,000 - ₹22,000/night). Private dedicated chauffeur-driven SUV throughout the trip (₹4,500 - ₹6,000/day). High-altitude tandem paragliding, personalized guided treks, and fine mountain dining.",
      "Every tier offers deep immersion into the mountain splendor, pine-scented air, and ancient cultural heritage of Himachal Pradesh's crown jewel valley."
    ],
    table: {
      headers: ["Expense Category", "Budget Tier (Daily / Unit)", "Mid-Range Tier (Daily / Unit)", "Luxury Tier (Daily / Unit)"],
      rows: [
        ["Double Accommodation", "₹900 - ₹1,500", "₹3,500 - ₹5,500", "₹14,000 - ₹25,000+"],
        ["Daily Dining (Per Person)", "₹450 - ₹700", "₹1,200 - ₹1,800", "₹3,000 - ₹5,500"],
        ["Local Transit & Day Excursions", "₹400 - ₹700 (Shared)", "₹2,500 - ₹3,800 (Private Cab)", "₹5,000 - ₹7,000 (Dedicated SUV)"],
        ["Activities & Experiences", "₹200 - ₹500 (Self-guided)", "₹1,000 - ₹2,500 (Cable Car / Sight)", "₹3,500 - ₹6,500 (Paragliding / Trek)"],
        ["Handloom Souvenirs & Crafts", "₹350 - ₹800 (Kullu Cap)", "₹2,200 - ₹4,500 (Kullu Shawl)", "₹8,000 - ₹20,000 (Pashmina / Carpet)"]
      ]
    }
  },
  {
    heading: "Practical Information, Permits & Emergency Contacts",
    callout: {
      type: "important",
...
const manaliBlocks = assembleStructuredBlocks(manaliSections, manaliInlineImages);
...
const manaliConfig = {
  ...
  structuredBlocks: manaliBlocks,
  tags: ["manali", "himachal-pradesh", "upper-beas", "atal-tunnel", "himalayas", "lahaul", "kathkuni", "vashisht", "naggar"],
  travelVerification: {
  ...
  references: [
    { title: "Himalayan Art and Architecture of the Kullu Valley", url: "https://asi.nic.in/" },
    { title: "Border Roads Organisation: The Atal Tunnel Engineering Monograph", url: "https://bro.gov.in/" },
    { title: "Flora and Alpine Ecology of Western Himalayas (Botanical Survey of India)", url: "https://bsi.gov.in/" },
    { title: "Pahari Culture and Devta Institutions of Himachal Pradesh", url: "https://himachaltourism.gov.in/" }
  ]
};

const manaliBuilt = writeCanonicalArticleModule("travel", "manali-and-the-upper-beas.js", manaliConfig);
console.log(`[Manali] Word count: ${manaliBuilt.wordCount}`);
