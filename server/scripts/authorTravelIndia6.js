...
console.log("Authoring Travel India 6/20: Coorg...");

const coorgSections = [
  {
    heading: "Kodagu Topography, Western Ghats Agroforestry & Seasonal Timing",
    callout: {
      type: "note",
    ...
    paragraphs: [
      ...
      "At the spiritual center of the plateau lies Talakaveri on the Brahmagiri hill range, the venerated source of the Kaveri River. Revered as 'Kaveri Amma' (Mother Kaveri), this river is the lifeline of millions of farmers across Karnataka and Tamil Nadu, originating from a modest stone spring tank perched amidst mist-shrouded montane grasslands at 1,276 meters.",
      "Strategic travel timing is dictated by two distinct meteorological personalities. The dry post-monsoon and winter months between November and March offer crystal-clear blue skies, fragrant coffee blossoms beginning in late February, daytime temperatures averaging 20°C to 24°C, and nighttime lows dipping to 10°C to 12°C. This is the optimal window for plantation walking, wildlife safaris in Nagarhole, and ascending Tadiandamol.",
      "The South-West Monsoon between June and September transforms Kodagu into a torrential water kingdom, receiving between 2,500 mm and 4,000 mm of rainfall. Roaring cataracts like Abbey Falls, Chelavara Falls, and Iruppu Falls plunge at peak volume, paddy fields in deep valleys shimmer with standing water, and the scent of damp earth and moss permeates the hills, offering a solitary and sensory paradise for monsoon enthusiasts."
    ],
    quote: {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Highway driving via the Sampaje Ghat (connecting coastal Mangalore to Madikeri) or the Anechowkur Checkpost (crossing from Mysore through protected wildlife corridors) is smooth and scenic, with strict speed limits enforced in forest buffer zones to safeguard migrating elephant herds."
    ],
    table: {
      headers: ["Transit Route / Service", "Schedule & Frequency", "Hub / Station Code", "Transit Duration", "Typical INR Tariff"],
      rows: [
        ["Kannur Airport to Virajpet / South Coorg Taxi", "24/7 on-demand pre-booked cab", "CNN -> Virajpet", "2h 30m (85 km)", "₹2,600 - ₹3,400"],
        ["Mysore Railway Station Prepaid Taxi to Madikeri", "24/7 prepaid taxi outside station", "MYS -> Madikeri", "2h 45m (120 km)", "₹2,800 - ₹3,600"],
        ["KSR Bengaluru - Mysuru Vande Bharat (20607)", "6 days/week ex-Chennai & SBC", "SBC -> MYS", "1h 45m", "₹750 (CC) / ₹1,450 (EC)"],
        ["KSRTC Airavat Club Class Volvo Bus", "Hourly departures ex-Bengaluru", "Bengaluru -> Madikeri Bus Stand", "5h 30m (250 km)", "₹650 - ₹850"],
        ["Mangalore Airport to Madikeri Taxi (NH-275)", "On-demand private airport transfer", "IXE -> Madikeri (via Mani)", "3h 30m (140 km)", "₹3,400 - ₹4,400"]
      ]
    }
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "Access to wilderness areas and protected wildlife reserves in Kodagu is regulated by the Karnataka Forest Department to protect critical elephant corridors and fragile mountain ecosystems.",
      "At Nagarhole National Park (Rajiv Gandhi National Park), vehicular wildlife safaris operate from designated forest counters at Kutta (South Coorg gate) and Veerahosahalli (North gate). Safaris are conducted in official Forest Department 4x4 open safari jeeps and twenty-seater mini-buses twice daily: morning slots (06:00 to 09:00 AM) and evening slots (15:00 to 18:00 PM). Booking can be secured online at the official Karnataka Eco-Tourism portal or obtained at the physical gate on a first-come, first-served basis.",
      "Highway transit through Nagarhole forest corridors (such as the Anechowkur and Kutta-Mananthavady roads) is governed by strict night curfews. The forest gates are closed to all private vehicular traffic between 18:00 PM in the evening and 06:00 AM the following morning to protect nocturnal wildlife and prevent road collisions. Speed limits within the reserve are strictly capped at 30 km/h, and stopping vehicles or disembarking is strictly illegal.",
      "Trekking to the summit of Tadiandamol Peak requires mandatory online registration and an eco-trekking permit through the Karnataka Eco-Tourism Development Board (myecotrip.com). The trekking trail commences from the base at Nalknad Palace (built in 1792 by King Chikka Virarajendra). Trekkers must register at the Forest Checkpoint; overnight camping on the summit ridge is strictly prohibited to prevent plastic pollution and forest fire hazards.",
      "When visiting the Namdroling Monastery at Bylakuppe, foreign nationals holding valid Indian visas can visit the temple halls and public grounds freely during daytime hours (09:00 to 18:00). However, overnight stays within the Tibetan settlement area require a Protected Area Permit (PAP) issued by the Ministry of Home Affairs, Government of India."
    ]
  },
  {
    heading: "Curated 5-Day Kodagu Highland Master Itinerary",
    paragraphs: [
      ...
      "Day 5: Nagarhole Wildlife Safari & Iruppu Falls. Set out at 05:30 AM for the Kutta gate of Nagarhole National Park. Embark on a three-hour morning safari in a Forest Department 4x4 jeep through teak and bamboo forests, watching for spotted deer herds, gaurs, wild boars, and Asiatic elephants drinking at forest waterholes. Following the safari, drive fifteen kilometers to the sacred Iruppu Falls in the Brahmagiri range, where the Lakshmana Tirtha river plunges over jagged granite rocks. Take a refreshing walk through the moist deciduous canopy, listening to the calls of emerald doves, before beginning your journey back toward Mysore or Bangalore."
    ],
    table: {
      headers: ["Day & Time Slot", "Highland Sector", "Core Sights & Heritage", "Mobility Mode", "Gastronomic Recommendations"],
      rows: [
        ["Day 1: 11:00 - 17:30", "Madikeri Town & Falls", "Madikeri Fort; Omkareshwara Temple; Abbey Falls", "Local cab / foot", "Spicy Coorg pork fry & hot Akki Rotti, Madikeri"],
        ["Day 2: 07:00 - 15:30", "Talakaveri & Bhagamandala", "Kaveri birth tank; Brahmagiri ridge; Nalknad Palace", "Private car (SH-89)", "Traditional vegetarian meal on banana leaf, Bhagamandala"],
        ["Day 3: 09:00 - 16:00", "Bylakuppe & Dubare", "Namdroling Golden Temple; Dubare Kaveri river", "Private car / cab", "Steamed Tibetan momos, tingmo & spicy dipping sauce"],
        ["Day 4: 08:30 - 17:00", "South Coorg Estates", "Multi-canopy coffee walk; Ainmane heritage; pepper vines", "Estate walk & car", "Authentic Kodava Pandi Curry with Kadambuttu dumplings"],
        ["Day 5: 05:30 - 14:00", "Nagarhole & Iruppu", "Morning 4x4 wildlife safari; Iruppu Falls cascade", "Forest Jeep & car", "Country chicken curry with paputtu & dark Coorg filter coffee"]
      ]
    }
  },
  {
    ...
    paragraphs: [
      "Budget planning for Kodagu reflects the distinction between family-operated plantation homestays and commercial luxury resorts. Homestays are the heart of Coorg's hospitality culture: staying with a local Kodava family allows travelers to experience authentic home cooking, estate tours, and warm hospitality at accessible rates.",
      "A solo budget traveler staying in a certified rural homestay or guest lodge in Virajpet or Kushalnagar, dining at local messes, and using KSRTC buses and shared jeeps can comfortably explore for ₹2,200 to ₹3,200 per day. Mid-range travelers residing in private stone cottages inside working coffee estates, renting two-wheelers or hiring private taxis for day trips, and taking guided plantation walks should budget ₹6,000 to ₹11,000 per day for a couple.",
      "Luxury travelers seeking world-renowned wilderness resorts—such as Evolve Back Chikkana Halli Estate (with private pool villas inside a 300-acre coffee plantation), Taj Madikeri Resort & Spa (perched on a 1,200-meter rainforest ridge), or The Tamara Coorg—will find room tariffs between ₹22,000 and ₹48,000 per night during the peak winter season. Chauffeur-driven private sedans or SUVs cost ₹3,000 to ₹4,200 per full day.",
      "Activity costs are very reasonable: entry to Madikeri Fort museum is ₹25; Abbey Falls entry is ₹20; Nagarhole National Park jeep safaris cost ₹1,500 to ₹2,200 per person; and guided coffee estate tours with professional cupping cost ₹300 to ₹600 per person."
    ],
    table: {
      ...
      rows: [
        ["Budget (Solo)", "₹1,100 - ₹1,700 (Certified estate homestay)", "₹500 - ₹750 (Kodava messes, local cafes)", "₹300 - ₹500 (KSRTC buses, shared jeeps)", "₹300 - ₹500 (Abbey Falls, Talakaveri)", "₹2,200 - ₹3,450 per day"],
        ["Mid-Range (Couple)", "₹4,500 - ₹8,000 (Private plantation cottage)", "₹1,600 - ₹2,800 (Estate dining, home feasts)", "₹1,000 - ₹1,800 (Rented scooter / local cab)", "₹1,000 - ₹2,000 (Coffee cupping, Dubare entry)", "₹8,100 - ₹14,600 per day"],
        ["Luxury (Couple)", "₹22,000 - ₹45,000 (Private pool estate villa)", "₹4,500 - ₹8,500 (Fine dining plantation cuisine)", "₹3,200 - ₹4,800 (Private chauffeured SUV)", "₹2,500 - ₹5,000 (Nagarhole private jeep safari)", "₹32,200 - ₹63,300 per day"]
      ]
    }
  },
  {
    heading: "Monsoon Dynamics, Torrential Flooding & Ghat Precautions",
    callout: {
      type: "warning",
    ...
    paragraphs: [
      "The South-West Monsoon is the defining ecological phenomenon of Kodagu. Striking the high western ramparts of the Western Ghats between June and September, the monsoon winds deposit immense precipitation across the district, with annual averages ranging from 2,500 mm in Kushalnagar to over 4,500 mm in Bhagamandala and the Brahmagiri ranges.",
      "Historically, severe monsoon downpours have triggered destructive landslides and slope failures along steep coffee slopes, notably during the extreme precipitation events of 2018 and 2019. The Bhagamandala Triveni Sangam regularly overflows its banks, temporarily cutting off road connectivity to Talakaveri. The Karnataka State Disaster Management Authority (KSDMA) issues color-coded weather alerts, and travelers should avoid travel to remote river valleys during red alert warnings.",
      "Leech activity increases dramatically in damp coffee estates, grass meadows, and forest trails during the wet season. When walking through estates or trekking toward Tadiandamol, wear protective canvas gaiters, tuck trousers securely into thick socks, and carry a small container of rock salt or eucalyptus oil to detach leeches easily without skin irritation.",
      "Road driving during heavy rains requires cautious speeds. Dense mountain mists frequently blanket the highway between Madikeri and Kushalnagar, reducing visibility to under fifteen meters. Drivers must use fog lights, avoid sudden braking on wet leaf-covered asphalt, and never park vehicles beneath steep, unstable earthen embankments."
    ]
  },
  {
    heading: "Gastronomic Topography: Kodava Culinary Culture, Pandi Curry & Kaapi",
    paragraphs: [
      "The culinary traditions of Kodagu are among the most distinct and celebrated in South India. Shaped by an indigenous warrior-agrarian culture, the food of the Kodavas reflects their deep connection to the forest, seasonal foraging, and the art of meat and wild game preparation.",
      "The undisputed crown jewel of Kodava cuisine is Pandi Curry (spicy pork curry). The secret to authentic Pandi Curry lies in the use of Kachampuli—a dark, thick, highly acidic vinegar extracted from the fermented, sun-boiled juice of the Kodambuli fruit (Garcinia gummi-gutta). Diced country pork is marinated in dry-roasted and stone-ground spices: black peppercorns, cumin, coriander seeds, mustard, and fenugreek, roasted until almost black. Simmered in earthen pots until tender, a splash of sour kachampuli is added at the end, creating a dark, intensely savory, smoky, and tangy gravy unlike any other curry in India.",
      "Pandi Curry is traditionally paired with Akki Rotti (thin, soft flatbreads made from cooked rice dough and rice flour) or Kadambuttu (round, bite-sized steamed dumplings made of broken rice and roasted cardamom). Another staple is Paputtu—a delicate steamed rice cake prepared by layering broken rice with fresh coconut milk, grated coconut, and sugar, steamed in shallow round pans and cut into diamond slices.",
      "Kodava cuisine also features remarkable seasonal vegetarian preparations: Bimbale Curry (tender bamboo shoots harvested during the monsoon, soaked for three days to remove bitterness, and cooked with coconut and mustard paste), Kumm Curry (wild forest mushrooms foraged from coffee estates after the first rains), and Kaad Mange Curry (tiny wild ripe mangoes simmered in a sweet, sour, and spicy jaggery-chili gravy).",
      "No day in Kodagu is complete without a cup of freshly roasted and brewed Coorg Kaapi. Brewed from freshly ground estate-grown peaberry coffee beans through a stainless-steel South Indian drip percolator, the resulting dark decoction is blended with hot whole milk and a touch of raw cane sugar, delivering a rich, chocolatey aroma with gentle cardamom undertones."
    ],
    table: {
      headers: ["Iconic Kodava Dish", "Cultural Significance", "Key Ingredients & Seasoning", "Flavor Profile", "Where to Experience"],
      rows: [
        ["Authentic Kodava Pandi Curry", "Traditional Martial Feast", "Country pork, dark-roasted spices, kachampuli vinegar", "Deeply smoky, savory, tangy, peppery depth", "Ancestral estate homestays across Virajpet"],
        ["Kadambuttu with Koli Curry", "Festive Kodava Celebration", "Broken rice dumplings, country chicken, coconut gravy", "Soft textured dumplings with rich spiced gravy", "Local Kodava dining rooms, Madikeri"],
        ["Akki Rotti with Kaad Mange", "Agrarian Farm Breakfast", "Rice dough flatbread, wild forest mangoes, jaggery", "Crisp savory bread with sweet-tangy fruity curry", "Plantation homestays during mango season"],
        ["Bimbale Bamboo Shoot Curry", "Monsoon Foraged Delicacy", "Tender wild bamboo shoots, coconut, mustard, chili", "Earthy, crunchy, tangy, mildly spicy comfort", "Traditional family messes during rainy season"],
        ["Single-Estate Coorg Peaberry Coffee", "High-Shade Coffee Harvest", "100% shade-grown Arabica peaberry, dark roasted", "Rich chocolate notes, low acidity, full body", "Estate tasting rooms & roasters in Madikeri"]
      ]
    }
  },
  {
    heading: "Cultural Protocols, Kodava Martial Lineage & Sacred Ainmanes",
    callout: {
      type: "note",
    ...
    paragraphs: [
      ...
      "Reverence for water and ancestors supersedes formal temple orthodoxy in Kodava culture. At Talakaveri, the annual festival of Tula Sankramana (mid-October) celebrates the sacred teerthodbhava—the exact auspicious moment when water miraculously surges in the holy spring tank. Devotees gather in thousands to take holy water, and visitors must dress conservatively (avoiding shorts, tank tops, and revealing clothes) and respect the solemnity of the ritual."
    ]
  },
  {
    heading: "Architectural Lineage: From Traditional Ainmanes to British Bungalows",
    paragraphs: [
      "The built heritage of Kodagu reflects the interplay between indigenous vernacular clan architecture, royal dynasty fortresses, and colonial British plantation bungalows constructed across two centuries.",
  ...
  },
  {
    ...
    paragraphs: [
      "Navigating Kodagu requires adapting to winding hill roads, unpaved plantation tracks, and steep gradients. While primary state highways (like NH-275 and SH-88) are well-surfaced, interior roads leading to private homestays, waterfalls, and trek bases can be narrow, single-lane, and riddled with potholes after heavy monsoon rains.",
      "Local taxis operate under regulated taxi associations with fixed rate cards displayed at Madikeri, Virajpet, and Kushalnagar taxi stands. Standard half-day sightseeing circuits (Madikeri Fort, Raja's Seat, Abbey Falls, and Omkareshwara Temple) cost ₹1,500 to ₹2,000 for a hatchback or sedan. Full-day excursions to Talakaveri and Bhagamandala or Bylakuppe and Dubare range between ₹2,800 and ₹3,800.",
      "Renting automatic scooters (Honda Activa) or geared motorcycles is popular among independent travelers in Madikeri (₹450 to ₹750 per day). However, riders must exercise extreme care: estate roads are frequently slippery from damp moss and wet fallen coffee leaves, and sharp blind turns on narrow village roads require constant horn alerts. Helmets are mandatory under Karnataka law, and night riding along forest edges should be avoided due to the danger of sudden wild elephant encounters.",
      "State-run KSRTC red rural buses connect Madikeri and Virajpet to rural villages like Bhagamandala, Somwarpet, Napoklu, and Gonikoppal every thirty to sixty minutes for nominal fares between ₹25 and ₹60, providing an authentic and safe mode of travel through the countryside."
    ]
  },
  {
    heading: "Highland Hydration, Vector Defense & Mountain Health Protocols",
    paragraphs: [
      "Kodagu's upland climate is generally temperate and healthy, but travelers should take sensible health precautions to manage tropical humidity, mountain water sources, and insect vectors.",
  ...
  },
  {
    ...
    paragraphs: [
      "Kodagu possesses good telecommunications infrastructure in its primary towns and along major highway arteries. Reliance Jio, Bharti Airtel, and BSNL provide reliable 4G LTE and expanding 5G coverage throughout Madikeri, Kushalnagar, Gonikoppal, and Virajpet.",
  ...
  {
    heading: "Ecological Stewardship, Agroforestry Conservation & Plastic Ban",
    paragraphs: [
      "The delicate ecology of Kodagu is under significant pressure from fragmentation of coffee estates, conversion of native shade trees to fast-growing exotic timber, and heavy weekend tourist vehicular influx.",
      "Traditional Coorg coffee agroforestry is one of the most biodiversity-friendly agricultural systems on the planet, preserving hundreds of native tree species that support over three hundred species of resident and migratory birds, civet cats, Malabar giant squirrels, and flying foxes. However, recent economic pressures have led some planters to replace native shade trees with exotic silver oak (Grevillea robusta) to increase coffee yields and cultivate pepper vines more easily. Environmental groups like the Kodagu Model Forest Trust are actively educating planters on the hydrological and soil-health benefits of preserving native rainforest hardwood shade canopies.",
      "The Kodagu District Administration strictly enforces a ban on single-use plastics across the district. Plastic bags, disposable water bottles under five liters, and plastic food containers are prohibited. Checkpoints along ghat roads inspect tourist vehicles and confiscate banned plastics.",
  ...
  {
    heading: "Photography Protocols, Drone Regulations & Estate Discretion",
    callout: {
      type: "warning",
    ...
    paragraphs: [
      "The visual appeal of Kodagu—mist-veiled coffee slopes, roaring waterfalls framed by deep jungle foliage, colorful Tibetan prayer flags fluttering against green hills, and historic stone palaces—provides exceptional photographic subjects. However, photographers must follow strict legal regulations and ethical guidelines.",
      "Flying recreational or commercial drones in Kodagu requires prior written authorization from the District Collector and local police authorities. Drones are strictly banned across Nagarhole National Park and all reserve forest areas under the Wildlife Protection Act. Flying unauthorized drones over wildlife habitats disrupts animal behavior and will result in equipment confiscation and prosecution under Indian law.",
      "When visiting the Namdroling Monastery at Bylakuppe, photography is permitted in public courtyards and inside the main temple hall; however, avoid using flash photography during active prayer services, and never photograph meditating monks or high lamas without respectful permission.",
      "Private coffee estates are private residential properties. Always obtain permission before photographing inside private estate grounds, traditional Ainmanes, or estate workers during coffee harvesting shifts. Treat local families with warmth and dignity."
    ]
  },
  {
    heading: "Packing Matrix: Plantation Footwear, Thermal Layers & Field Gear",
    paragraphs: [
      "Packing for Kodagu requires preparing for cool mountain temperatures, damp plantation walks, sudden monsoon rains, and relaxed estate living. The following checklist details essential field gear.",
      "Footwear should prioritize comfort and wet-weather grip. Bring sturdy trail hiking shoes with deep lugs for climbing Tadiandamol and walking through coffee estates. For casual walking through towns and visiting temples, comfortable slip-on shoes or sandals that can be removed quickly outside sacred shrines are ideal.",
      "Layering is essential for comfort throughout the day. Pack a versatile clothing system: lightweight cotton and linen shirts for daytime wear, a warm fleece pullover for evenings, and a light insulated jacket for winter mornings between November and February when temperatures dip to 10°C.",
    ...
    table: {
      ...
      rows: [
        ["Footwear", "Trail hiking shoes (deep lugs) + slip-on casuals", "Trekking Tadiandamol & coffee estate trails", "Essential year-round"],
        ["Thermal Layering", "Fleece pullover + light insulated jacket", "Comfort against 10°C to 14°C winter night cold", "Crucial: November - February"],
        ["Rain & Leech Defense", "Waterproof rain jacket + umbrella + leech socks", "Protection against heavy monsoon downpours & leeches", "Essential: June - September"],
        ...
        ["Hydration & Pack", "Insulated stainless steel flask (1L) + 25L daypack", "Carrying warm coffee & essentials on estate walks", "Recommended year-round"]
      ]
    }
  },
  {
    ...
    paragraphs: [
      "While Kodagu is a peaceful and secure highland destination, knowing where to access medical care, police support, and emergency services is essential for peace of mind.",
      ...
      "The Government Taluk Hospital at Virajpet and the Community Health Centre at Kushalnagar provide reliable secondary public medical care and emergency ambulance transport. For minor ailments, several well-stocked pharmacies and private clinics operate along the main bazaar roads in Madikeri and Kushalnagar.",
    ...
    table: {
      ...
      rows: [
        ...
        ["Apex District Public Hospital", "Kodagu Institute of Medical Sciences (KIMS)", "College Road, Madikeri", "+91 8272 225 210"],
        ["Virajpet Public Hospital", "Government Taluk Hospital Virajpet", "Hospital Road, Virajpet", "+91 8274 256 320"],
        ["Madikeri Town Police Station", "Town Police Station", "Fort Area, Madikeri", "+91 8272 228 321"],
        ["Emergency Ambulance Service", "108 Emergency Medical Services", "District-wide Fleet", "108"]
      ]
    }
  },
  {
    heading: "Extended Highland Living, Coffee Retreats & Mountain Cadence",
    paragraphs: [
      "Kodagu has long offered a tranquil and restorative haven for writers, researchers, and remote knowledge workers seeking a healthy climate, rich natural beauty, and peaceful solitude. An extended stay in a working coffee estate provides an inspiring lifestyle structured by the natural rhythms of agriculture.",
      "Daily life unfolds with quiet dignity. Morning begins with a walk through misty coffee groves as the sun illuminates the canopy, accompanied by the calls of crested serpent eagles and grey hornbills. Days are dedicated to focused intellectual or creative work on a shaded stone veranda, while late afternoons are spent walking along estate streams, reading by a crackling wood fire, or sharing stories over a pot of fresh peaberry coffee.",
      ...
      "The community is warm, hospitable, and culturally vibrant, centered around sports clubs like the Madikeri Golf Club (founded in 1898), local environmental conservation groups, and the legendary Kodava family hockey tournament held each spring, offering an enriching social environment for extended residents."
    ]
  },
  {
    heading: "Synthesis: The Living Soul of the Coffee Hills",
    paragraphs: [
      ...
      "The true essence of Coorg is found not in crowded tourist spots, but in quiet, unhurried moments: standing at Talakaveri as morning mist sweeps over the sacred spring, walking along a silent forest path in Nagarhole as wild elephants graze in the golden dawn light, and sharing the warmth of a Kodava hearth over a plate of steaming kadambuttu and fragrant coffee.",
      "Kodagu reminds us that true wealth lies in healthy soil, clean mountain streams, and the enduring strength of ancestral community bonds. It is a landscape where every valley has a name, every river is a goddess, and every tree tells a story.",
      "As you descend the winding ghat road back toward the plains, watching the mist-draped blue ridges of the Brahmagiri hills recede into the sunset, you carry with you a deep and lasting peace: a memory of green canopies, generous hospitality, and the timeless, aromatic soul of the coffee hills."
    ]
  }
];

const coorgInlineImages = [
  {
...
const coorgBlocks = assembleStructuredBlocks(coorgSections, coorgInlineImages);
...
const coorgConfig = {
  ...
  structuredBlocks: coorgBlocks,
  tags: ["coorg", "kodagu", "karnataka", "coffee-plantations", "talakaveri", "bylakuppe", "tibetan-monastery", "kodava-culture"],
  travelVerification: {
  ...
  references: [
    { title: "The Coorgs and Their Country (Rev. G. Richter)", url: "https://www.jstor.org/" },
    { title: "Kodava Customary Law and Society (P.T. Bopanna)", url: "https://coorgtourisminfo.com/" },
    { title: "Karnataka Forest Department: Nagarhole National Park Management Plan", url: "https://aranya.gov.in/" },
    { title: "Coffee Board of India: Agroforestry & Shade-Grown Coffee Protocols", url: "https://indiacoffee.org/" }
  ]
};

const coorgBuilt = writeCanonicalArticleModule("travel", "coorg.js", coorgConfig);
console.log(`[Coorg] Word count: ${coorgBuilt.wordCount}`);
