...
console.log("Authoring Experience 3: Rebuilding Life After a Natural Disaster...");

const exp3Sections = [
  {
    heading: "The Cataclysmic Dawn: Category 5 Landfall and the Instant of Loss",
    callout: {
      type: "note",
  ...
  {
    heading: "The Immediate Aftermath: The Anatomy of Survival Triage (Days 1–14)",
    paragraphs: [
      ...
      "In this survival phase, executive planning gives way to immediate physiological necessities: procuring potable drinking water, securing non-perishable caloric sustenance, preventing wound infections in a tropical climate, and safeguarding remaining personal possessions from secondary rain exposure and opportunistic scavenging. Elena and Roberto established a tactical survival outpost in their driveway using a damaged blue polyethylene tarp and an emergency camping stove.",
      ...
      "Medical vulnerability during the immediate aftermath is severely underestimated. Without refrigeration for pharmaceuticals, running water for sanitary hygiene, or operational emergency departments, minor injuries rapidly escalate into serious clinical threats. Roberto sustained a puncture wound from a rusty roofing nail on day four, requiring an emergency tetanus vaccination sourced from an improvised disaster medical tent operating out of a church parking lot.",
      "Survival triage teaches an unvarnished lesson in human priority. In normal civil society, we spend our lives obsessing over complex career ambitions, status markers, and digital trivialities. In the wake of a Category 5 hurricane, all of that vanity burns away. Life narrows down to pure fundamentals: shelter from the rain, clean water to drink, dry socks, and the physical safety of your family."
    ],
    table: {
      headers: ["Post-Disaster Phase", "Operational Focus", "Primary Hazards", "Average Duration"],
      rows: [
        ["Phase 1: Survival Triage", "Securing water, food, first aid, generator fuel", "Heat exhaustion, infection, downed lines", "Days 1–14"],
        ["Phase 2: Preservation & Tarping", "Mucking out drywall, blue tarping roof, salvage", "Black toxic mold, structural collapse", "Weeks 2–8"],
        ["Phase 3: Insurance & Permitting", "Adjuster claims, debris hauling, code permits", "Bad-faith denials, bureaucratic delays", "Months 2–12"],
        ["Phase 4: Structural Rebuilding", "Framing, mechanicals, drywall, interior finish", "Contractor fraud, supply shortages", "Months 12–42"]
      ]
    }
  },
  {
    heading: "The Mucking Out Phase: The Grief of Physical Evacuation",
    callout: {
      type: "warning",
    ...
    paragraphs: [
      "Once survival was stabilized, the Cruz family confronted the most heartbreaking physical labor of disaster recovery: the 'mucking out' phase. When a roof fails in a tropical storm, thousands of gallons of rainwater saturate ceiling insulation, drywall, hardwood flooring, and furniture. In ninety-degree heat, toxic black mold begins to colonize organic substrates within forty-eight hours, transforming treasured possessions into hazardous bio-waste.",
      "Elena and Roberto, assisted by three volunteer church members, spent three weeks wearing N95 respirators, heavy rubber boots, and eye protection, systematically gutting their home down to the bare wooden studs and concrete foundation slab. Everything they had gathered across twenty years of adult life had to be tossed into massive debris piles along the street curb.",
      "The emotional toll of this physical evacuation is agonizing. Elena stood in the master bedroom, throwing waterlogged wedding photograph albums, her daughter's early childhood art projects, heirloom furniture inherited from her grandmother, and Mateo's first stuffed animals into contractor garbage bags. The tactile sensory experience of lifting mold-encrusted keepsakes and carrying them to the trash pile produces acute, visceral grief.",
      "The curb in front of their home became an open-air graveyard of their life history: a fifteen-foot-high mountain of soggy mattresses, shattered cabinetry, ruined kitchen appliances, and water-damaged books. Up and down the street, every house displayed an identical mountain of debris, creating an apocalyptic landscape of domestic ruin.",
      "Elena reflects on this reckoning: 'You realize that things you treated as priceless treasures for decades can be turned into toxic garbage in an afternoon. It was agonizing to throw away my mother's handwritten recipe books. But in that grief, Roberto said something that kept me standing: 'The memories aren't in the paper, Elena. The memories are in our heads, and our heads are still here.''",
      "By the end of week four, the Cruz home was a hollow, echoing shell: bare concrete floors, exposed framing timbers, and blue tarp flapping furiously on the roof rafters. The physical house was dead; the long journey of resurrecting it had officially begun."
    ]
  },
  {
    heading: "The Bureaucratic Labyrinth: Navigating Insurance Adjusters and Relief Claims",
    paragraphs: [
      "In the naive mythology of disaster insurance, homeowners believe that having paid substantial insurance premiums for decades guarantees rapid, compassionate reimbursement in the event of catastrophe. The empirical reality of post-disaster claims is a grueling, adversarial bureaucratic war of attrition.",
      "Within two weeks of Hurricane Michael, major property insurance carriers dispatched thousands of independent, contracted adjusters to the disaster zone. These adjusters—often inexperienced, overworked, and operating on algorithmic quotas—spent an average of forty-five minutes inspecting catastrophic home damage before generating lowball estimates designed to minimize carrier payout liabilities.",
      "The Cruz family held a standard Florida homeowner's policy with an additional windstorm rider, paying an annual premium of three thousand two hundred dollars. An independent contractor estimated the structural rebuilding cost at two hundred and eighty-five thousand dollars. Six weeks after the storm, the insurance company's initial settlement offer arrived in the mail: forty-two thousand dollars.",
      "The carrier argued that the majority of the structural water damage resulted from 'pre-existing maintenance deficiencies' and 'surface flood seepage'—which was excluded under the standard wind policy—rather than the catastrophic Category 5 wind shear that blew off the roof. Elena spent five months trapped in a bureaucratic nightmare of endless telephone hold queues, lost paperwork, conflicting adjuster reports, and stonewalling corporate representatives.",
  ...
  {
    heading: "The Encampment: Two Years Inside a 32-Foot FEMA Travel Trailer",
    callout: {
      type: "tip",
  ...
  {
    heading: "The Contractor Scramble: Fraud, Gouging, and the Search for Integrity",
    paragraphs: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Rebuilding taught them that modern globalized supply chains are fragile, just-in-time abstractions that shatter instantly under regional disaster stress. True resilience requires the willingness to expand your logistical perimeter, build cooperative purchasing cartels, and source foundational materials far outside the impacted disaster perimeter."
    ]
  },
  {
    heading: "The Invisible Wound: Somatic Trauma and the Neurobiology of Weather",
    callout: {
      type: "warning",
    ...
    paragraphs: [
      ...
      "Treating this trauma required deliberate, professional intervention. Elena enrolled both children in specialized trauma-informed expressive arts therapy offered through a mobile community health clinic. The therapist explained that their brains' amygdalae had been hardwired with an intense survival alarm that was misfiring during ordinary rainfall.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Mutual aid revealed a profound sociological truth: catastrophe strips away the superficial political, racial, and socio-economic divisions that plague civil society. In the mud and wreckage, people do not care how you voted, what church you attend, or what car you drove. They care only that you are bleeding, that your roof is open to the sky, and that you need a hand lifting a heavy timber. Community is not an abstract concept; it is the physical act of showing up with a hammer."
    ]
  },
  {
    heading: "The Financial Drain: Unbudgeted Costs of Sustained Disaster Recovery",
    paragraphs: [
      "Beyond the direct capital required to rebuild structural walls and purchase lumber, long-term disaster recovery inflicts a catastrophic, hidden financial drain that pushes working-class and middle-class families to the brink of personal bankruptcy.",
      "The Cruz family maintained meticulous financial records throughout their four-year recovery journey. Their unbudgeted out-of-pocket disaster expenses—costs never reimbursed by insurance settlements or FEMA grants—totaled sixty-eight thousand four hundred dollars.",
      "These hidden financial drains fell into several insidious categories: First, 'Generator Fuel Burn.' For seventy days before grid power was restored, running an 8,000-watt gasoline generator to power the trailer's air conditioner, refrigerator, and power tools required fifteen gallons of gasoline daily at four dollars a gallon, burning through over four thousand dollars in cash. Second, 'Storage Unit Premiums.' Renting two climate-controlled storage units fifty miles away to safeguard their surviving heirloom possessions cost four hundred and fifty dollars a month for thirty months.",
      "Third, 'Permitting and Municipal Surcharges.' To meet revised post-storm building codes, the city required updated architectural blueprints, engineered wind-load calculations, soil percolation tests, and multiple inspection permit fees totaling eight thousand two hundred dollars. Fourth, 'Dual Utility and Property Tax Payments.' Even while living in a trailer on the front lawn, the family had to continue paying full municipal property taxes and baseline electrical connection fees on a home that was uninhabitable.",
      "To survive this financial hemorrhage without liquidating their modest retirement accounts, Elena took on an evening online curriculum-tutoring contract, while Roberto worked sixty-hour weeks doing commercial emergency repair jobs for local businesses. They eliminated every non-essential domestic expense, adopting a Spartan household economy that preserved every available dollar for building materials."
    ]
  },
  {
    heading: "Permitting Gridlock and Code Upgrades: The Friction of Municipal Bureaucracy",
    paragraphs: [
      "One of the most agonizing bottlenecks in post-disaster rebuilding is the collision between desperate homeowners and overwhelmed municipal building departments. In the aftermath of Hurricane Michael, Bay County updated its municipal building codes to require higher wind-load standards: all new and renovated structures were mandated to withstand 140 mph wind gusts, requiring hurricane tie-down straps, impact-rated windows, and reinforced roof deck nailing patterns.",
      "While these building code upgrades are essential for long-term climate resilience, their sudden implementation created catastrophic administrative gridlock. The local county building department, designed to process forty residential building permits a month with a staff of six inspectors, was suddenly inundated with twelve thousand reconstruction permit applications.",
      "Roberto submitted his residential framing and electrical permit applications in March 2019. The paperwork sat in an administrative queue for nine months before a municipal plans examiner even reviewed the structural engineering stamps. During those nine months, the Cruz home sat open to the elements, protected only by rapidly deteriorating blue tarps that had to be replaced three times after subsequent rainstorms.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Roberto resolved that their rebuilt home would not merely meet baseline Florida building codes; it would be engineered as a hardened residential fortress capable of surviving a Category 5 storm with zero structural compromise. Working with an experienced structural engineer, they redesigned the home with five primary resilience upgrades.",
      "First: Continuous Load Path Tie-Downs. Heavy-gauge galvanized steel hurricane straps were anchored directly into the solid poured concrete foundation footing, extending continuously through the 2x6 exterior wall framing timbers, and bolted securely to every roof truss rafter. This created a unified structural cage that prevents high wind suction forces from lifting the roof off the walls.",
      "Second: Standing-Seam 24-Gauge Steel Roofing. They eliminated asphalt shingles entirely, replacing them with commercial-grade standing-seam metal panels attached with concealed clips directly over high-temperature synthetic underlayment and a secondary peel-and-stick bitumen waterproofing membrane. Even if metal panels were torn off in a freak tornado, the roof deck remained completely watertight.",
      "Third: Category 5 Impact-Rated Glass. Every exterior window and sliding glass door was replaced with laminated impact glass designed to withstand a nine-pound 2x4 lumber missile fired at fifty feet per second, eliminating the need for cumbersome hurricane plywood shutters.",
      "Fourth: Elevated Critical Mechanicals. The main electrical distribution panel, hot water heater, and exterior HVAC heat pump condensers were elevated thirty-six inches above the hundred-year flood base elevation on reinforced concrete pedestals.",
      "Fifth: Integrated Dual-Fuel Backup Generation. Roberto wired a dedicated 50-amp manual transfer switch directly into the main breaker panel, connected to an underground 500-gallon propane tank capable of powering refrigeration, water pumping, and essential lighting for twenty-one days off-grid."
    ]
  },
  {
    heading: "The Return of Sovereignty: Reclaiming the Hearth (Month 38)",
    callout: {
      type: "tip",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Disaster strips away the illusion that we can live as isolated, atomized economic units. It teaches a community that when the wind blows and the waters rise, our only true wealth is the trust, generosity, and cooperative strength of our neighbors."
    ]
  },
  {
    heading: "Operational Preparedness Heuristics for the Modern Household",
    paragraphs: [
      "Having navigated forty-two months of disaster recovery, Elena and Roberto transformed their hard-won experiential lessons into a concrete, field-tested operational preparedness framework for modern households facing severe climate threats.",
      "First: The Digital Fortress. Never store essential family records exclusively in paper format in a filing cabinet. Scan all property deeds, vehicle titles, insurance policy declarations, passport records, birth certificates, and tax filings into high-resolution encrypted cloud storage and mirrored onto an offline, waterproof encrypted flash drive kept in an emergency go-bag. Furthermore, record a comprehensive, room-by-room high-definition video walkthrough of your entire home and contents every six months, opening drawers and closets, which provides irrefutable photographic evidence for insurance adjusters.",
...
const exp3Blocks = assembleStructuredBlocks(exp3Sections, exp3InlineImages);
...
const exp3Config = {
  ...
  structuredBlocks: exp3Blocks,
  tags: ["disaster-recovery", "resilience", "family-crisis", "rebuilding", "community-mutual-aid", "trauma-recovery"],
  editorialProvenance: {
  ...
  references: [
    { title: "A Paradise Built in Hell: The Extraordinary Communities That Arise in Disaster (Rebecca Solnit)", url: "https://www.penguinrandomhouse.com/books/301070/a-paradise-built-in-hell-by-rebecca-solnit/" },
    { title: "The Unthinkable: Who Survives When Disaster Strikes - and Why (Amanda Ripley)", url: "https://www.amandaripley.com/the-unthinkable" },
    { title: "FEMA Hazard Mitigation Field Guidelines: Residential Coastal Construction", url: "https://www.fema.gov/emergency-managers/risk-management/building-science/coastal-construction-manual" },
    { title: "National Center for PTSD: Disaster Mental Health Intervention Guidelines", url: "https://www.ptsd.va.gov/professional/treat/type/disaster_guide.asp" }
  ]
};

const built = writeCanonicalArticleModule("experiences", "rebuilding-life-after-a-natural-disaster.js", exp3Config);
