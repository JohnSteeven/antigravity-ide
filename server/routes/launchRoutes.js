...
router.get('/audit', authenticate, launchController.getAuditReport);
router.get('/deployments', authenticate, launchController.getDeployments);
router.get('/tests', authenticate, launchController.getTests);
