  ...
  return (
    <div className="cms-grid-two article-editor-layout">
      ...
      <div className="cms-panel wide">
        ...
        {/* Conditionally display Life-specific experience metadata */}
        {articleDraft.category?.toLowerCase() === "life" && (
        ...
        {/* Conditionally display Coding-specific experience metadata */}
        {["coding", "development", "technology", "tech"].includes(articleDraft.category?.toLowerCase()) && (
          <div className="span-two experience-meta-section" style={{
            background: "#0d1117",
            color: "#c9d1d9",
        ...
        {/* Conditionally display Travel-specific experience metadata */}
        {["travel", "adventures", "journeys", "destinations", "trips"].includes(articleDraft.category?.toLowerCase()) && (
          <div className="span-two experience-meta-section" style={{
            background: "#fffdfa",
            color: "#1c1917",
        ...
        {/* Conditionally display Incidents-specific experience metadata */}
        {["incidents", "postmortems", "outages", "post-mortems", "systemfailures"].includes(articleDraft.category?.toLowerCase()) && (
          <div className="span-two experience-meta-section" style={{
            background: "#0f172a",
            color: "#f8fafc",
        ...
        {/* Conditionally display Lessons/Reflections-specific experience metadata */}
        {["lessons", "reflections", "growth", "philosophy", "mindset", "wisdom"].includes(articleDraft.category?.toLowerCase()) && (
          <div className="span-two experience-meta-section" style={{
            background: "#fcfbf9",
            color: "#1e1b4b",
