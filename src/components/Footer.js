        ...
        <div className="footer-grid">
          ...
          <div className="footer-social">
            ...
            <div className="social-icons">
              <a href={socials.instagram || "https://www.instagram.com/j.steeven_?utm_source=qr&igsh=MWh6aHFyNmIxZTV6Mg%3D%3D"} target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                <FiInstagram />
              </a>
