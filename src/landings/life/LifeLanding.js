...
const LifeLanding = ({
  ...
  const categoryModel = {
    name: category?.name || blueprint.name || "Life",
    ...
    <main className={`category-detail-page ${isDarkMode ? "dark-mode" : ""}`}>
      ...
      >
        ...
        <div className="category-detail-hero-content">
          ...
          <span className="section-kicker">🌱 Premium Editorial Journal</span>
          ...
          <div className="category-hero-meta">
            <span>
              <FiFeather /> {categoryArticles.length} journal entries
            </span>
            <span>
              <FiTag /> {categoryModel.subcategories.length} life topics
            </span>
            <span>
              <FiCompass /> Mindful Living
            </span>
          </div>
        </div>
      </section>
      ...
      <div className="life-editorial-quote-strip">
        ...
        <p>In the middle of difficulty lies opportunity. Ordinary moments held with care become extraordinary memories.</p>
      </div>
      ...
      <section className="category-toolbar" aria-label={`${categoryModel.name} filters`}>
        <label className="search-control">
          <input
            ...
            placeholder={`Search ${categoryModel.name.toLowerCase()} entries`}
          />
        </label>
      ...
      {featuredArticle && (
        <section className="featured-category-article">
          ...
          />
          <div>
            <span className="section-kicker">Featured cover story</span>
