...
| Premium checkout/billing sync | Test-mode foundation implemented | Fixed INR/USD server prices, Money, Payment/Invoice/Refund/BillingEvent, Razorpay test Orders, callback/provider verification, raw signed webhooks, replay defense, full/partial refunds, and read-only reconciliation exist. Live mode and Phase 13 entitlement lifecycle/UI remain deferred. |
